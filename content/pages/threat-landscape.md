...
This report is auto-generated from the latest RBAC Atlas scan (**2026-07-04**). It analyzes the RBAC permissions of **257** Kubernetes open-source projects across **26683** manifest versions to provide a snapshot of the current cloud-native threat landscape.
...
| Total manifest versions | 26683 |
| Avg service accounts per project | 2.11 |
| Avg permission bindings per project | 30.77 |
...
| Avg low risks per project | 21.64 |
...
|------------|-------|------------|
| {{< risk "Critical" >}} | 900 | 11.38% |
| {{< risk "High" >}} | 871 | 11.01% |
| {{< risk "Medium" >}} | 576 | 7.28% |
| {{< risk "Low" >}} | 5562 | 70.32% |
| **Total** | **7909** | |
...
| [kuadrant-operator](/charts/kuadrant/kuadrant-operator/) | 1.5.0-rc3 | 21 | 9 | 4 | 103 | **366** |
| [gitlab-operator](/charts/gitlab/gitlab-operator/) | 3.1.1 | 20 | 5 | 7 | 124 | **363** |
