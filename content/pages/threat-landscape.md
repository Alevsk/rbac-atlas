...
This report is auto-generated from the latest RBAC Atlas scan (**2026-09-01**). It analyzes the RBAC permissions of **257** Kubernetes open-source projects across **27344** manifest versions to provide a snapshot of the current cloud-native threat landscape.
...
| Avg low risks per project | 21.62 |
...
|------------|-------|------------|
| {{< risk "Critical" >}} | 898 | 11.22% |
| {{< risk "High" >}} | 1026 | 12.82% |
| {{< risk "Medium" >}} | 523 | 6.53% |
| {{< risk "Low" >}} | 5557 | 69.43% |
| **Total** | **8004** | |
