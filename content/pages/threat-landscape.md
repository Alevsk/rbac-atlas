...
This report is auto-generated from the latest RBAC Atlas scan (**2026-06-29**). It analyzes the RBAC permissions of **257** Kubernetes open-source projects across **26608** manifest versions to provide a snapshot of the current cloud-native threat landscape.
...
| Total manifest versions | 26608 |
| Avg service accounts per project | 2.11 |
| Avg permission bindings per project | 30.76 |
...
| Avg low risks per project | 21.63 |
...
|------------|-------|------------|
| {{< risk "Critical" >}} | 900 | 11.39% |
| {{< risk "High" >}} | 871 | 11.02% |
| {{< risk "Medium" >}} | 576 | 7.29% |
| {{< risk "Low" >}} | 5558 | 70.31% |
| **Total** | **7905** | |
