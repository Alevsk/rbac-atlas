...
This report is auto-generated from the latest RBAC Atlas scan (**2026-09-13**). It analyzes the RBAC permissions of **257** Kubernetes open-source projects across **27488** manifest versions to provide a snapshot of the current cloud-native threat landscape.
...
| Total manifest versions | 27488 |
| Avg service accounts per project | 2.11 |
| Avg permission bindings per project | 31.24 |
...
|------------|-------|------------|
| {{< risk "Critical" >}} | 897 | 11.17% |
| {{< risk "High" >}} | 1029 | 12.82% |
...
| {{< tag "Tampering" >}} | 843 |
| {{< tag "PotentialPrivilegeEscalation" >}} | 578 |
...
| [victoria-metrics-k8s-stack](/charts/victoriametrics/victoria-metrics-k8s-stack/) | 0.92.1 | 14 | 173 | 5 | 38 | **1053** |
...
| [gitlab-operator](/charts/gitlab/gitlab-operator/) | 3.3.2 | 20 | 5 | 7 | 126 | **365** |
