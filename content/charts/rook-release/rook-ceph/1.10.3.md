...
| ---------- | ------------------ | ------------------ | ----------------- |
| Deployment | rook-ceph-operator | rook-ceph-operator | rook/ceph:v1.10.3 |
...
| ClusterRole `rbd-external-provisioner-runner` | core/nodes                                                         | get · list · watch · watch"                   | {{< risk Low >}}      |                                                                                                                                                                 |
