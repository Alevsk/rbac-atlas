...
| [`rook-ceph-system`](#sa-rook-ceph-system)                             | default   | ❌        | —       | 101         | 1         | {{< risk "Critical" >}} |
...
| ---------- | ------------------ | ------------------ | ----------------- |
| Deployment | rook-ceph-operator | rook-ceph-operator | rook/ceph:v1.11.7 |
...
| Role `rook-ceph-mgr`                | apps/deployments/scale                     | delete · get · patch · update                         | {{< risk High >}}     | {{< tag "DenialOfService" >}} {{< tag "ResourceModification" >}} {{< tag "Tampering" >}} {{< tag "WorkloadLifecycle" >}}                                                  |
...
| Role `rook-ceph-mgr`                | apps/deployments                           | delete · get · patch · update                         | {{< risk Low >}}      |                                                                                                                                                                           |
...
| Role `rook-ceph-mgr`                | apps/pods                                  | delete · get · patch · update                         | {{< risk Low >}}      |                                                                                                                                                                           |
