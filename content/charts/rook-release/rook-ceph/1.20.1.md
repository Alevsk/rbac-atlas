...
|---|---|---|---|---|---|---|
|[`ceph-csi`](#sa-ceph-csi)|default|✅|—|22|1|{{< risk "Critical" >}}|
...
|---|---|---|---|
|Deployment|rook-ceph-operator|rook-ceph-operator|docker.io/rook/ceph:v1.20.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|ceph-csi-controller-manager|manager|quay.io/cephcsi/ceph-csi-operator:v1.0.1|
