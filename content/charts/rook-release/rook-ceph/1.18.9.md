...
| [`rook-ceph-mgr`](#sa-rook-ceph-mgr)                                   | default   | ❌        | —       | 31          | 0         | {{< risk "Critical" >}} |
...
| ---------- | ------------------ | ------------------ | --------------------------- |
| Deployment | rook-ceph-operator | rook-ceph-operator | docker.io/rook/ceph:v1.18.9 |
