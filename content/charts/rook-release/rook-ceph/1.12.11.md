...
| [`rook-ceph-system`](#sa-rook-ceph-system)                             | default   | ❌        | —       | 104         | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `rook-ceph-system`        | csiaddons.openshift.io/networkfences                         | create · delete · get · list · update · watch                    | {{< risk Low >}}      |                                                                                                                                                                           |
...
| ---------- | ------------------ | ------------------ | ------------------ |
| Deployment | rook-ceph-operator | rook-ceph-operator | rook/ceph:v1.12.11 |
