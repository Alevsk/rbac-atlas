...
| [`rook-ceph-system`](#sa-rook-ceph-system)                             | default   | ❌        | —       | 94          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ------------------ | ------------------ | ---------------- |
| Deployment | rook-ceph-operator | rook-ceph-operator | rook/ceph:v1.8.5 |
...
| Role `rbd-external-provisioner-cfg`           | csiaddons.openshift.io/csiaddonsnodes                              | create                                                | {{< risk Low >}}      |                                                                                                                                                                 |
...
| Role `rbd-csi-nodeplugin`        | csiaddons.openshift.io/csiaddonsnodes                              | create                      | {{< risk Low >}} |                                                                                                                                                                 |
