...
| ---------- | ------------------ | ------------------ | --------------------------- |
| Deployment | rook-ceph-operator | rook-ceph-operator | docker.io/rook/ceph:v1.15.2 |
...
| ClusterRole `rbd-external-provisioner-runner` | snapshot.storage.k8s.io/volumesnapshotcontents                  | create · get · list · patch · update · watch          | {{< risk Low >}}      |                                                                                                                                                                |
| ClusterRole `rbd-external-provisioner-runner` | snapshot.storage.k8s.io/volumesnapshotcontents/status           | patch · update                                        | {{< risk Low >}}      |                                                                                                                                                                |
| ClusterRole `rbd-external-provisioner-runner` | snapshot.storage.k8s.io/volumesnapshots                         | create · get · list · patch · update · watch          | {{< risk Low >}}      |                                                                                                                                                                |
...
| ClusterRole `cephfs-external-provisioner-runner` | snapshot.storage.k8s.io/volumesnapshotcontents                  | create · get · list · patch · update · watch          | {{< risk Low >}}    |                                                                                                                                  |
...
| ClusterRole `cephfs-external-provisioner-runner` | snapshot.storage.k8s.io/volumesnapshots                         | create · get · list · patch · update · watch          | {{< risk Low >}}    |                                                                                                                                  |
