...
|---|---|---|---|---|---|---|
|[`ceph-csi`](#sa-ceph-csi)|default|✅|—|23|1|{{< risk "Critical" >}}|
...
|ClusterRole `rook-ceph-global`|core/secrets|get · list · patch · watch|{{< risk Critical >}}|{{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}}|
...
|ClusterRole `rook-ceph-global`|core/configmaps|get · list · patch · watch|{{< risk High >}}|{{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}|
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephblockpoolradosnamespaces|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephblockpools|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephbucketnotifications|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephbuckettopics|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephclients|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephclusters|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephcosidrivers|get · list · patch · update · watch|{{< risk Low >}}||
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephfilesystemmirrors|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephfilesystems|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephfilesystemsubvolumegroups|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephnfses|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephnvmeofgateways|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephobjectrealms|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephobjectstoreaccounts|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephobjectstores|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephobjectstoreusers|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephobjectzonegroups|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephobjectzones|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|ceph.rook.io/cephrbdmirrors|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|core/nodes|get · list · patch · watch|{{< risk Low >}}||
...
|ClusterRole `rook-ceph-global`|core/pods|get · list · patch · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|rook-ceph-operator|rook-ceph-operator|docker.io/rook/ceph:v1.21.0-beta.0|

---

### 🤖 `ceph-csi` {#sa-ceph-csi}
 **Namespace:** `default`  |  **Automount:** ✅
...
|ClusterRole `ceph-csi-manager-role`|core/nodes|list · watch|{{< risk Low >}}||
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|ceph-csi-controller-manager|manager|quay.io/cephcsi/ceph-csi-operator:v1.0.4|
