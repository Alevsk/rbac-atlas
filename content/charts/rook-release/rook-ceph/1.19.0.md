...
| [`rook-ceph-mgr`](#sa-rook-ceph-mgr)                                   | default   | ❌        | —       | 32          | 0         | {{< risk "Critical" >}} |
...
| ---------- | ------------------ | ------------------ | --------------------------- |
| Deployment | rook-ceph-operator | rook-ceph-operator | docker.io/rook/ceph:v1.19.0 |
...
| Kind       | Name                        | Container | Image                                    |
| ---------- | --------------------------- | --------- | ---------------------------------------- |
| Deployment | ceph-csi-controller-manager | manager   | quay.io/cephcsi/ceph-csi-operator:v0.4.1 |
