...
| ---------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`controller-manager`](#sa-controller-manager) | default   | ❌        | —       | 85          | 2         | {{< risk "Critical" >}} |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | core/secrets                                                      | create · delete · get · list · watch                  | {{< risk Critical >}} | {{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}}                        |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | gateway-operator.konghq.com/aigateways/status                     | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                                       |
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | rbac.authorization.k8s.io/clusterrolebindings/status              | get                                                   | {{< risk Low >}}      |                                                                                                                                                                                       |
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | rbac.authorization.k8s.io/clusterroles/status                     | get                                                   | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | gateway-operator.konghq.com/controlplanes/status                  | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | gateway-operator.konghq.com/dataplanes/status                     | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                                       |
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | apps/deployments/status                                           | get                                                   | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | batch/jobs                                                        | create · delete · get                                 | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | configuration.konghq.com/kongconsumergroups                       | get · list · watch                                    | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | configuration.konghq.com/kongconsumers                            | get · list · watch                                    | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | configuration.konghq.com/kongvaults                               | get · list · watch                                    | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `gateway-operator-gateway-operator-manager-role`          | core/serviceaccounts/status                                       | get                                                   | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| Deployment | gateway-operator-gateway-operator-controller-manager | manager         | docker.io/kong/gateway-operator:1.2.0     |
