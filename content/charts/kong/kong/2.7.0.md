...
| ---------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`kong-kong`](#sa-kong-kong) | default   | ❌        | —       | 44          | 2         | {{< risk "Critical" >}} |
...
| ClusterRole `kong-kong` | gateway.networking.k8s.io/gateways/status                                     | get · update                                          | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `kong-kong` | networking.internal.knative.dev/ingresses/status                              | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ---------- | --------- | ------------------ | -------------------------------------- |
| Deployment | kong-kong | ingress-controller | kong/kubernetes-ingress-controller:2.2 |
| Deployment | kong-kong | proxy              | kong:2.7                               |
