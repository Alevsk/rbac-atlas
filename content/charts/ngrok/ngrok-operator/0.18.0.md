...
| ---------- | ---------------------- | -------------- | ------------------------------------- |
| Deployment | ngrok-operator-manager | ngrok-operator | docker.io/ngrok/ngrok-operator:0.16.0 |
...
| Kind       | Name                 | Container | Image                                 |
| ---------- | -------------------- | --------- | ------------------------------------- |
| Deployment | ngrok-operator-agent | agent     | docker.io/ngrok/ngrok-operator:0.16.0 |
