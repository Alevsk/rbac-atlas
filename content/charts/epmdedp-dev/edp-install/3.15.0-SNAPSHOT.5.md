...
tags: [ClusterStructure, ConfigMapAccess, ControlPlaneDisruption, CredentialAccess, CriticalNamespace, DataExposure, DenialOfService, InformationDisclosure, LogAccess, NamespaceAdmin, NamespaceLifecycle, NamespaceWideAccess, PotentialPrivilegeEscalation, Reconnaissance, ResourceDeletion, ResourceNameRestricted, SecretAccess, Tampering, WildcardPermission, letter-E]
---
## Description
...
|[`tekton-reporter`](#sa-tekton-reporter)|default|❌|—|13|1|{{< risk "Critical" >}}|
...
|---|---|---|---|
|Deployment|codebase-operator|codebase-operator|epamedp/codebase-operator:2.34.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|cd-pipeline-operator|cd-pipeline-operator|epamedp/cd-pipeline-operator:2.31.0|
...
|Role `tekton-reporter`|core/pods/log|get|{{< risk Medium >}}|{{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "LogAccess" >}}|
|Role `tekton-reporter`|v2.edp.epam.com/codebases|get · list · watch|{{< risk Low >}}||
|Role `tekton-reporter`|v2.edp.epam.com/codebases/finalizers|get · list · watch|{{< risk Low >}}||
|Role `tekton-reporter`|v2.edp.epam.com/codebases/status|get · list · watch|{{< risk Low >}}||
|Role `tekton-reporter`|core/events|create · patch|{{< risk Low >}}||
|Role `tekton-reporter`|v2.edp.epam.com/gitservers|get · list · watch|{{< risk Low >}}||
|Role `tekton-reporter`|v2.edp.epam.com/gitservers/finalizers|get · list · watch|{{< risk Low >}}||
|Role `tekton-reporter`|v2.edp.epam.com/gitservers/status|get · list · watch|{{< risk Low >}}||
|Role `tekton-reporter`|tekton.dev/pipelineruns|get · list · patch · watch|{{< risk Low >}}||
|Role `tekton-reporter`|core/pods|get · list|{{< risk Low >}}||
|Role `tekton-reporter`|core/secrets|get|{{< risk Low >}}||
|Role `tekton-reporter`|tekton.dev/taskruns|get · list · watch|{{< risk Low >}}||
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|tekton-reporter|tekton-reporter|epamedp/edp-tekton:0.26.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|gitfusion|gitfusion|epamedp/gitfusion:0.6.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|tekton-interceptor|tekton-triggers-edp-interceptor|epamedp/edp-tekton:0.26.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|krci-portal|krci-portal|epamedp/krci-portal:0.7.0|
