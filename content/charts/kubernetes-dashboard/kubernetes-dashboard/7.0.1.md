...
| Kind       | Name                     | Container                | Image                                      |
| ---------- | ------------------------ | ------------------------ | ------------------------------------------ |
| Deployment | kubernetes-dashboard-api | kubernetes-dashboard-api | docker.io/kubernetesui/dashboard-api:1.2.0 |
...
| Kind       | Name                     | Container                | Image                                      |
| ---------- | ------------------------ | ------------------------ | ------------------------------------------ |
| Deployment | kubernetes-dashboard-web | kubernetes-dashboard-web | docker.io/kubernetesui/dashboard-web:1.2.1 |
