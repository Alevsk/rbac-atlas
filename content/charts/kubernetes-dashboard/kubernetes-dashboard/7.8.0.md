...
| Kind       | Name                                 | Container                            | Image                                                  |
| ---------- | ------------------------------------ | ------------------------------------ | ------------------------------------------------------ |
| Deployment | kubernetes-dashboard-metrics-scraper | kubernetes-dashboard-metrics-scraper | docker.io/kubernetesui/dashboard-metrics-scraper:1.2.0 |
...
| Kind       | Name                     | Container                | Image                                      |
| ---------- | ------------------------ | ------------------------ | ------------------------------------------ |
| Deployment | kubernetes-dashboard-api | kubernetes-dashboard-api | docker.io/kubernetesui/dashboard-api:1.9.0 |
...
| Kind       | Name                     | Container                | Image                                      |
| ---------- | ------------------------ | ------------------------ | ------------------------------------------ |
| Deployment | kubernetes-dashboard-web | kubernetes-dashboard-web | docker.io/kubernetesui/dashboard-web:1.5.0 |
