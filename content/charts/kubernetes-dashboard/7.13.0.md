...
| ------------------------------------------------------------------------- | ----------------------------------------------- | ----------------------------------------------------- | --------------------- |
| ClusterRole `kubernetes-dashboard-cert-manager-controller-certificates`   | core/secrets                                    | create · delete · get · list · patch · update · watch | {{< risk Critical >}} |
| ClusterRole `kubernetes-dashboard-cert-manager-controller-challenges`     | core/secrets                                    | get · list · watch                                    | {{< risk Critical >}} |
| ClusterRole `kubernetes-dashboard-cert-manager-controller-challenges`     | core/pods                                       | create · delete · get · list · watch                  | {{< risk Critical >}} |
| ClusterRole `kubernetes-dashboard-cert-manager-controller-clusterissuers` | core/secrets                                    | create · delete · get · list · update · watch         | {{< risk Critical >}} |
| ClusterRole `kubernetes-dashboard-cert-manager-controller-issuers`        | core/secrets                                    | create · delete · get · list · update · watch         | {{< risk Critical >}} |
| ClusterRole `kubernetes-dashboard-cert-manager-controller-orders`         | core/secrets                                    | get · list · watch                                    | {{< risk Critical >}} |
...
| Role                                             | Resource                           | Verbs                 | Risk                  |
| ------------------------------------------------ | ---------------------------------- | --------------------- | --------------------- |
| Role `kubernetes-dashboard-ingress-nginx`        | core/secrets                       | get · list · watch    | {{< risk Critical >}} |
| Role `kubernetes-dashboard-ingress-nginx`        | core/configmaps                    | get · list · watch    | {{< risk Medium >}}   |
...
| ClusterRole `kubernetes-dashboard-ingress-nginx` | core/namespaces                    | list · watch          | {{< risk Low >}}      |
...
| Role                                                               | Resource                                                     | Verbs                               | Risk                  |
| ------------------------------------------------------------------ | ------------------------------------------------------------ | ----------------------------------- | --------------------- |
| ClusterRole `kubernetes-dashboard-cert-manager-cainjector`         | core/secrets                                                 | get · list · watch                  | {{< risk Critical >}} |
...
| Role                                                                         | Resource                                  | Verbs                                | Risk                  |
| ---------------------------------------------------------------------------- | ----------------------------------------- | ------------------------------------ | --------------------- |
| Role `kubernetes-dashboard-cert-manager-webhook:dynamic-serving`             | core/secrets                              | create · get · list · update · watch | {{< risk Critical >}} |
| ClusterRole `kubernetes-dashboard-cert-manager-webhook:subjectaccessreviews` | authorization.k8s.io/subjectaccessreviews | create                               | {{< risk Medium >}}   |
...
| Role                                                     | Resource           | Verbs              | Risk              |
| -------------------------------------------------------- | ------------------ | ------------------ | ----------------- |
| ClusterRole `system:kubernetes-dashboard-metrics-server` | core/configmaps    | get · list · watch | {{< risk High >}} |
...
| ClusterRole `system:kubernetes-dashboard-metrics-server` | core/namespaces    | get · list · watch | {{< risk Low >}}  |
