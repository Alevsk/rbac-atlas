...
| Kind       | Name          | Container              | Image                                    |
| ---------- | ------------- | ---------------------- | ---------------------------------------- |
| Deployment | cost-analyzer | cost-analyzer-frontend | gcr.io/kubecost1/frontend:prod-1.107.1   |
| Deployment | cost-analyzer | cost-model             | gcr.io/kubecost1/cost-model:prod-1.107.1 |
