...
| [`cost-analyzer`](#sa-cost-analyzer)                                                   | default   | ❌        | —       | 23          | 2         | {{< risk "High" >}}     |
...
| ---------- | ------------------------------- | ---------------------------------- | -------------------------------------------------------------- |
| Deployment | cost-analyzer-prometheus-server | prometheus-server                  | quay.io/prometheus/prometheus:v2.47.2                          |
| Deployment | cost-analyzer-prometheus-server | prometheus-server-configmap-reload | quay.io/prometheus-operator/prometheus-config-reloader:v0.69.1 |
...
| Kind       | Name          | Container              | Image                                    |
| ---------- | ------------- | ---------------------- | ---------------------------------------- |
| Deployment | cost-analyzer | cost-analyzer-frontend | gcr.io/kubecost1/frontend:prod-1.108.0   |
| Deployment | cost-analyzer | cost-model             | gcr.io/kubecost1/cost-model:prod-1.108.0 |
...
| Deployment | cost-analyzer-grafana | grafana-sc-dashboard | kiwigrid/k8s-sidecar:1.25.2 |
...
| Kind      | Name                                   | Container                | Image                     |
| --------- | -------------------------------------- | ------------------------ | ------------------------- |
| DaemonSet | cost-analyzer-prometheus-node-exporter | prometheus-node-exporter | prom/node-exporter:v1.7.0 |
