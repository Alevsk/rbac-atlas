...
| ---------- | ------------------------------- | ----------------- | ------------------------------------- |
| Deployment | cost-analyzer-prometheus-server | prometheus-server | quay.io/prometheus/prometheus:v2.49.1 |
...
| Kind       | Name          | Container              | Image                                  |
| ---------- | ------------- | ---------------------- | -------------------------------------- |
| Deployment | cost-analyzer | aggregator             | gcr.io/kubecost1/cost-model:prod-2.0.0 |
| Deployment | cost-analyzer | cloud-cost             | gcr.io/kubecost1/cost-model:prod-2.0.0 |
| Deployment | cost-analyzer | cost-analyzer-frontend | gcr.io/kubecost1/frontend:prod-2.0.0   |
| Deployment | cost-analyzer | cost-model             | gcr.io/kubecost1/cost-model:prod-2.0.0 |
...
| Kind       | Name                  | Container            | Image                       |
| ---------- | --------------------- | -------------------- | --------------------------- |
| Deployment | cost-analyzer-grafana | grafana              | grafana/grafana:10.3.1      |
| Deployment | cost-analyzer-grafana | grafana-sc-dashboard | kiwigrid/k8s-sidecar:1.25.3 |
