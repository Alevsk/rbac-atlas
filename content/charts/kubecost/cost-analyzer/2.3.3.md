...
| ---------- | ------------------------------- | ----------------- | ------------------------------------- |
| Deployment | cost-analyzer-prometheus-server | prometheus-server | quay.io/prometheus/prometheus:v2.52.0 |
...
| Kind       | Name          | Container              | Image                                  |
| ---------- | ------------- | ---------------------- | -------------------------------------- |
| Deployment | cost-analyzer | aggregator             | gcr.io/kubecost1/cost-model:prod-2.3.3 |
| Deployment | cost-analyzer | cloud-cost             | gcr.io/kubecost1/cost-model:prod-2.3.3 |
| Deployment | cost-analyzer | cost-analyzer-frontend | gcr.io/kubecost1/frontend:prod-2.3.3   |
| Deployment | cost-analyzer | cost-model             | gcr.io/kubecost1/cost-model:prod-2.3.3 |
...
| Kind       | Name                  | Container            | Image                       |
| ---------- | --------------------- | -------------------- | --------------------------- |
| Deployment | cost-analyzer-grafana | grafana              | grafana/grafana:10.4.3      |
| Deployment | cost-analyzer-grafana | grafana-sc-dashboard | kiwigrid/k8s-sidecar:1.27.2 |
