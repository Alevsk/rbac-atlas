...
| ---------- | ------------------------------- | ---------------------------------- | -------------------------------------------------------------- |
| Deployment | cost-analyzer-prometheus-server | prometheus-server                  | quay.io/prometheus/prometheus:v2.48.1                          |
...
| Kind       | Name          | Container              | Image                                    |
| ---------- | ------------- | ---------------------- | ---------------------------------------- |
| Deployment | cost-analyzer | cost-analyzer-frontend | gcr.io/kubecost1/frontend:prod-1.108.1   |
| Deployment | cost-analyzer | cost-model             | gcr.io/kubecost1/cost-model:prod-1.108.1 |
