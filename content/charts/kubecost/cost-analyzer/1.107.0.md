...
| [`cost-analyzer`](#sa-cost-analyzer)                                                   | default   | ❌        | —       | 23          | 3         | {{< risk "High" >}}     |
...
| Deployment | cost-analyzer-prometheus-server | prometheus-server-configmap-reload | quay.io/prometheus-operator/prometheus-config-reloader:v0.68.0 |
...
| Kind       | Name          | Container              | Image                                    |
| ---------- | ------------- | ---------------------- | ---------------------------------------- |
| Deployment | cost-analyzer | cost-analyzer-frontend | gcr.io/kubecost1/frontend:prod-1.107.0   |
| Deployment | cost-analyzer | cost-model             | gcr.io/kubecost1/cost-model:prod-1.107.0 |
| Pod        | basic-health  | test-kubecost          | alpine/k8s:1.26.9                        |
...
| Deployment | cost-analyzer-grafana | grafana-sc-dashboard | kiwigrid/k8s-sidecar:1.25.1 |
