...
tags: [APIServerDoS, APIServiceManipulation, AuthorizationBypass, AvailabilityImpact, BackupAccess, BindingToPrivilegedRole, CRDManipulation, CSRApproval, CSRCreation, CertificateManagement, ClusterAdminAccess, ClusterStructure, ClusterWideAccess, ClusterWideLogAccess, ClusterWidePodAttach, ClusterWidePodExec, ClusterWidePodPortForward, ClusterWideSecretAccess, CodeExecution, ConfigMapAccess, ControlPlaneDisruption, ControllerRevisionTampering, CredentialAccess, CriticalNamespace, DataExposure, DataLoss, DenialOfService, DeprecatedFeature, ElevationOfPrivilege, IdentityManagement, Impersonation, InformationDisclosure, LateralMovement, LeaderElectionAbuse, LogAccess, ManInTheMiddle, NamespaceAdmin, NamespaceLifecycle, NetworkManipulation, NetworkPolicyManagement, NodeAccess, NodeManipulation, OperationalData, Persistence, PodAttach, PodExec, PodPortForward, PodSecurityPolicy, PotentialPrivilegeEscalation, PrivilegeEscalation, QuotaTampering, RBACManipulation, RBACQuery, Reconnaissance, ResourceConfiguration, ResourceDeletion, ResourceModification, ResourceNameRestricted, SchedulingAbuse, SecretAccess, SelfPermissionReviewQuery, ServiceExposure, Spoofing, StorageDetailsDisclosure, StorageManipulation, Tampering, TokenCreation, TrafficRedirection, WebhookManipulation, WebhookReconnaissance, WildcardPermission, WorkloadDeployment, WorkloadExecution, WorkloadLifecycle, letter-A]
---
## Description
...
|[`argocd-applicationset-controller`](#sa-argocd-applicationset-controller)|default|✅|—|12|1|{{< risk "Critical" >}}|
...
|[`argo-cd-argocd-redis-secret-init`](#sa-argo-cd-argocd-redis-secret-init)|default|✅|—|2|1|{{< risk "Low" >}}|
...
|---|---|---|---|
|Deployment|argo-cd-argocd-server|server|quay.io/argoproj/argocd:v3.4.5|
...
|Role `argo-cd-argocd-applicationset-controller`|coordination.k8s.io/leases|create|{{< risk Low >}}||
|Role `argo-cd-argocd-applicationset-controller`|coordination.k8s.io/leases **(restricted to: 58ac56fa.applicationsets.argoproj.io)**|create · get · update|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|argo-cd-argocd-applicationset-controller|applicationset-controller|quay.io/argoproj/argocd:v3.4.5|
...
|Role|Resource|Verbs|Risk|Tags|
|---|---|---|---|---|
|ClusterRole `argo-cd-argocd-notifications-controller`|core/secrets|list · watch|{{< risk Critical >}}|{{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}}|
|Role `argo-cd-argocd-notifications-controller`|core/secrets|list · watch|{{< risk Critical >}}|{{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}}|
|ClusterRole `argo-cd-argocd-notifications-controller`|core/configmaps|list · watch|{{< risk High >}}|{{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}|
|Role `argo-cd-argocd-notifications-controller`|core/configmaps|list · watch|{{< risk Medium >}}|{{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}|
...
|ClusterRole `argo-cd-argocd-notifications-controller`|core/configmaps **(restricted to: argocd-notifications-cm)**|get|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
|Role `argo-cd-argocd-notifications-controller`|core/configmaps **(restricted to: argocd-notifications-cm)**|get|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
|ClusterRole `argo-cd-argocd-notifications-controller`|core/secrets **(restricted to: argocd-notifications-secret)**|get|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
|Role `argo-cd-argocd-notifications-controller`|core/secrets **(restricted to: argocd-notifications-secret)**|get|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|argo-cd-argocd-notifications-controller|notifications-controller|quay.io/argoproj/argocd:v3.4.5|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|argo-cd-argocd-application-controller|application-controller|quay.io/argoproj/argocd:v3.4.5|
...
|Role|Resource|Verbs|Risk|Tags|
|---|---|---|---|---|
|Role `argo-cd-argocd-redis-secret-init`|core/secrets|create|{{< risk Low >}}||
|Role `argo-cd-argocd-redis-secret-init`|core/secrets **(restricted to: argocd-redis)**|get|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|argo-cd-argocd-redis-secret-init|secret-init|quay.io/argoproj/argocd:v3.4.5|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|argo-cd-argocd-repo-server|repo-server|quay.io/argoproj/argocd:v3.4.5|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|argo-cd-redis-ha-server|redis|ecr-public.aws.com/docker/library/redis:8.2.3-alpine|
|StatefulSet|argo-cd-redis-ha-server|sentinel|ecr-public.aws.com/docker/library/redis:8.2.3-alpine|
|StatefulSet|argo-cd-redis-ha-server|split-brain-fix|ecr-public.aws.com/docker/library/redis:8.2.3-alpine|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|argo-cd-redis-ha-haproxy|haproxy|ecr-public.aws.com/docker/library/haproxy:3.3.10-alpine|
