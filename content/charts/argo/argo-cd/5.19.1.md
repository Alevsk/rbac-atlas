...
| ------------------------------------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`argo-cd-argocd-applicationset-controller`](#sa-argo-cd-argocd-applicationset-controller) | default   | ❌        | —       | 11          | 1         | {{< risk "Critical" >}} |
...
| [`argocd-notifications-controller`](#sa-argocd-notifications-controller)                   | default   | ❌        | —       | 6           | 1         | {{< risk "Critical" >}} |
| [`argocd-server`](#sa-argocd-server)                                                       | default   | ✅        | —       | 11          | 1         | {{< risk "Critical" >}} |
| [`argo-cd-redis-ha`](#sa-argo-cd-redis-ha)                                                 | default   | ❌        | —       | 0           | 4         | —                       |
...
### 🤖 `argo-cd-argocd-applicationset-controller` {#sa-argo-cd-argocd-applicationset-controller}
...
| ---------- | ---------------------------------------- | ------------------------- | ------------------------------ |
| Deployment | argo-cd-argocd-applicationset-controller | applicationset-controller | quay.io/argoproj/argocd:v2.5.7 |
...
| Kind       | Name                  | Container | Image                          |
| ---------- | --------------------- | --------- | ------------------------------ |
| Deployment | argo-cd-argocd-server | server    | quay.io/argoproj/argocd:v2.5.7 |
...
| Kind        | Name                                  | Container              | Image                          |
| ----------- | ------------------------------------- | ---------------------- | ------------------------------ |
| StatefulSet | argo-cd-argocd-application-controller | application-controller | quay.io/argoproj/argocd:v2.5.7 |
...
| Kind       | Name                                    | Container                | Image                          |
| ---------- | --------------------------------------- | ------------------------ | ------------------------------ |
| Deployment | argo-cd-argocd-notifications-controller | notifications-controller | quay.io/argoproj/argocd:v2.5.7 |
...
| Kind       | Name                      | Container  | Image                      |
| ---------- | ------------------------- | ---------- | -------------------------- |
| Deployment | argo-cd-argocd-dex-server | dex-server | ghcr.io/dexidp/dex:v2.35.3 |
...
| Kind       | Name                       | Container   | Image                          |
| ---------- | -------------------------- | ----------- | ------------------------------ |
| Deployment | argo-cd-argocd-repo-server | repo-server | quay.io/argoproj/argocd:v2.5.7 |
...
| Kind        | Name                    | Container       | Image                            |
| ----------- | ----------------------- | --------------- | -------------------------------- |
| StatefulSet | argo-cd-redis-ha-server | redis           | redis:7.0.5-alpine               |
| StatefulSet | argo-cd-redis-ha-server | redis-exporter  | oliver006/redis_exporter:v1.43.0 |
| StatefulSet | argo-cd-redis-ha-server | sentinel        | redis:7.0.5-alpine               |
| StatefulSet | argo-cd-redis-ha-server | split-brain-fix | redis:7.0.5-alpine               |
...
| Kind       | Name                     | Container | Image         |
| ---------- | ------------------------ | --------- | ------------- |
| Deployment | argo-cd-redis-ha-haproxy | haproxy   | haproxy:2.6.4 |
