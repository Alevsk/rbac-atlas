...
| -------------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`argocd-application-controller`](#sa-argocd-application-controller) | default   | ❌        | —       | 1           | 1         | {{< risk "Critical" >}} |
| [`argocd-server`](#sa-argocd-server)                                 | default   | ❌        | —       | 4           | 1         | {{< risk "Critical" >}} |
| [`argocd-dex-server`](#sa-argocd-dex-server)                         | default   | ❌        | —       | 0           | 1         | —                       |
...
| --------------------------- | ------------- | -------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `argocd-server` | \*            | delete · get · patch | {{< risk Critical >}} | {{< tag "AuthorizationBypass" >}} {{< tag "ClusterAdminAccess" >}} {{< tag "ClusterWideAccess" >}} {{< tag "ClusterWideLogAccess" >}} {{< tag "CodeExecution" >}} (+10 more) |
| ClusterRole `argocd-server` | core/pods/log | get                  | {{< risk High >}}     | {{< tag "ClusterWideLogAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "LogAccess" >}}                                                    |
| ClusterRole `argocd-server` | core/events   | list                 | {{< risk Low >}}      |                                                                                                                                                                              |
| ClusterRole `argocd-server` | core/pods     | get                  | {{< risk Low >}}      |                                                                                                                                                                              |
...
| ---------- | ------------- | ------------- | ----------------------- |
| Deployment | argocd-server | argocd-server | argoproj/argocd:v0.12.3 |
...
| Role                                        | Resource | Verbs | Risk                  | Tags                                                                                                                                                                     |
| ------------------------------------------- | -------- | ----- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ClusterRole `argocd-application-controller` | \*       | \*    | {{< risk Critical >}} | {{< tag "APIServerDoS" >}} {{< tag "APIServiceManipulation" >}} {{< tag "AuthorizationBypass" >}} {{< tag "AvailabilityImpact" >}} {{< tag "BackupAccess" >}} (+68 more) |
...
| Kind       | Name                          | Container                     | Image                   |
| ---------- | ----------------------------- | ----------------------------- | ----------------------- |
| Deployment | argocd-application-controller | argocd-application-controller | argoproj/argocd:v0.12.3 |
...
| Kind       | Name              | Container | Image                      |
| ---------- | ----------------- | --------- | -------------------------- |
| Deployment | argocd-dex-server | dex       | quay.io/dexidp/dex:v2.12.0 |
