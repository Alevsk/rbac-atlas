...
| [`argocd-notifications-controller`](#sa-argocd-notifications-controller)   | default   | ✅        | —            | 12          | 1         | {{< risk "Low" >}}      |
...
| ClusterRole `argo-cd-argocd-notifications-controller` | core/configmaps                                               | list · watch                        | {{< risk Low >}} |                                      |
| Role `argo-cd-argocd-notifications-controller`        | core/configmaps                                               | list · watch                        | {{< risk Low >}} |                                      |
| ClusterRole `argo-cd-argocd-notifications-controller` | core/secrets                                                  | list · watch                        | {{< risk Low >}} |                                      |
| Role `argo-cd-argocd-notifications-controller`        | core/secrets                                                  | list · watch                        | {{< risk Low >}} |                                      |
