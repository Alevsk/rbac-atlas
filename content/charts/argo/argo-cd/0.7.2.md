...
| ---------- | ------------- | ------------- | ---------------------- |
| Deployment | argocd-server | argocd-server | argoproj/argocd:v1.2.4 |
...
| Kind       | Name                          | Container                     | Image                  |
| ---------- | ----------------------------- | ----------------------------- | ---------------------- |
| Deployment | argocd-application-controller | argocd-application-controller | argoproj/argocd:v1.2.4 |
