...
| ---------- | ----------------------------- | ----------------------------- | ----------------------- |
| Deployment | argocd-application-controller | argocd-application-controller | argoproj/argocd:v0.11.0 |
...
| Kind       | Name          | Container     | Image                   |
| ---------- | ------------- | ------------- | ----------------------- |
| Deployment | argocd-server | argocd-server | argoproj/argocd:v0.11.0 |
