...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|argo-cd-redis-ha-server|redis|ecr-public.aws.com/docker/library/redis:8.6.4-alpine|
|StatefulSet|argo-cd-redis-ha-server|sentinel|ecr-public.aws.com/docker/library/redis:8.6.4-alpine|
|StatefulSet|argo-cd-redis-ha-server|split-brain-fix|ecr-public.aws.com/docker/library/redis:8.6.4-alpine|
