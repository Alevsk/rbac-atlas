...
| ---------- | ------------- | ------------- | ---------------------- |
| Deployment | argocd-server | argocd-server | argoproj/argocd:v1.2.1 |
...
| Kind       | Name                          | Container                     | Image                  |
| ---------- | ----------------------------- | ----------------------------- | ---------------------- |
| Deployment | argocd-application-controller | argocd-application-controller | argoproj/argocd:v1.2.1 |
...
| Kind       | Name              | Container | Image                      |
| ---------- | ----------------- | --------- | -------------------------- |
| Deployment | argocd-dex-server | dex       | quay.io/dexidp/dex:v2.14.0 |
