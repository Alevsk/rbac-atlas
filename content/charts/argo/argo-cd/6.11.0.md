...
| ---------- | --------------------- | --------- | ------------------------------- |
| Deployment | argo-cd-argocd-server | server    | quay.io/argoproj/argocd:v2.11.1 |
...
| Kind       | Name                                    | Container                | Image                           |
| ---------- | --------------------------------------- | ------------------------ | ------------------------------- |
| Deployment | argo-cd-argocd-notifications-controller | notifications-controller | quay.io/argoproj/argocd:v2.11.1 |
...
| Kind       | Name                                     | Container                 | Image                           |
| ---------- | ---------------------------------------- | ------------------------- | ------------------------------- |
| Deployment | argo-cd-argocd-applicationset-controller | applicationset-controller | quay.io/argoproj/argocd:v2.11.1 |
...
| Kind        | Name                                  | Container              | Image                           |
| ----------- | ------------------------------------- | ---------------------- | ------------------------------- |
| StatefulSet | argo-cd-argocd-application-controller | application-controller | quay.io/argoproj/argocd:v2.11.1 |
...
| Kind | Name                             | Container   | Image                           |
| ---- | -------------------------------- | ----------- | ------------------------------- |
| Job  | argo-cd-argocd-redis-secret-init | secret-init | quay.io/argoproj/argocd:v2.11.1 |
...
| Kind       | Name                       | Container   | Image                           |
| ---------- | -------------------------- | ----------- | ------------------------------- |
| Deployment | argo-cd-argocd-repo-server | repo-server | quay.io/argoproj/argocd:v2.11.1 |
