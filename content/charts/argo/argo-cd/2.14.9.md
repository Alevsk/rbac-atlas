...
| ---------- | --------------------- | --------- | ---------------------- |
| Deployment | argo-cd-argocd-server | server    | argoproj/argocd:v1.8.4 |
...
| Kind       | Name                                  | Container              | Image                  |
| ---------- | ------------------------------------- | ---------------------- | ---------------------- |
| Deployment | argo-cd-argocd-application-controller | application-controller | argoproj/argocd:v1.8.4 |
