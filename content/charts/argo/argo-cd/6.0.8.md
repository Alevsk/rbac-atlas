...
| -------------------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`argo-cd-argocd-repo-server`](#sa-argo-cd-argocd-repo-server)             | default   | ✅        | —       | 1           | 1         | {{< risk "Critical" >}} |
| [`argocd-application-controller`](#sa-argocd-application-controller)       | default   | ✅        | —       | 7           | 1         | {{< risk "Critical" >}} |
...
| [`argo-cd-redis-ha`](#sa-argo-cd-redis-ha)                                 | default   | ❌        | —       | 0           | 3         | —                       |
...
| ---------- | --------------------- | --------- | ------------------------------- |
| Deployment | argo-cd-argocd-server | server    | quay.io/argoproj/argocd:v2.10.0 |
...
| Kind       | Name                                    | Container                | Image                           |
| ---------- | --------------------------------------- | ------------------------ | ------------------------------- |
| Deployment | argo-cd-argocd-notifications-controller | notifications-controller | quay.io/argoproj/argocd:v2.10.0 |
...
| Role `argo-cd-argocd-applicationset-controller` | argoproj.io/appprojects                | get                                                   | {{< risk Low >}}      |                                                                                                                                                                 |
...
| Kind       | Name                                     | Container                 | Image                           |
| ---------- | ---------------------------------------- | ------------------------- | ------------------------------- |
| Deployment | argo-cd-argocd-applicationset-controller | applicationset-controller | quay.io/argoproj/argocd:v2.10.0 |
...
| Kind        | Name                                  | Container              | Image                           |
| ----------- | ------------------------------------- | ---------------------- | ------------------------------- |
| StatefulSet | argo-cd-argocd-application-controller | application-controller | quay.io/argoproj/argocd:v2.10.0 |
...
| Kind       | Name                      | Container  | Image                      |
| ---------- | ------------------------- | ---------- | -------------------------- |
| Deployment | argo-cd-argocd-dex-server | dex-server | ghcr.io/dexidp/dex:v2.38.0 |
...
| Role                                     | Resource | Verbs | Risk                  | Tags                                                                                                                                                                     |
| ---------------------------------------- | -------- | ----- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ClusterRole `argo-cd-argocd-repo-server` | \*       | \*    | {{< risk Critical >}} | {{< tag "APIServerDoS" >}} {{< tag "APIServiceManipulation" >}} {{< tag "AuthorizationBypass" >}} {{< tag "AvailabilityImpact" >}} {{< tag "BackupAccess" >}} (+68 more) |
...
| Kind       | Name                       | Container   | Image                           |
| ---------- | -------------------------- | ----------- | ------------------------------- |
| Deployment | argo-cd-argocd-repo-server | repo-server | quay.io/argoproj/argocd:v2.10.0 |
...
| Kind        | Name                    | Container       | Image                                             |
| ----------- | ----------------------- | --------------- | ------------------------------------------------- |
| StatefulSet | argo-cd-redis-ha-server | redis           | public.ecr.aws/docker/library/redis:7.0.15-alpine |
| StatefulSet | argo-cd-redis-ha-server | sentinel        | public.ecr.aws/docker/library/redis:7.0.15-alpine |
| StatefulSet | argo-cd-redis-ha-server | split-brain-fix | public.ecr.aws/docker/library/redis:7.0.15-alpine |
...
| Kind       | Name                     | Container | Image         |
| ---------- | ------------------------ | --------- | ------------- |
| Deployment | argo-cd-redis-ha-haproxy | haproxy   | haproxy:2.6.9 |
