...
| [`argocd-notifications-bot`](#sa-argocd-notifications-bot)                                 | default   | ❌        | —       | 0           | 0         | —                       |
...
| Role `argo-cd-argocd-applicationset-controller` | argoproj.io/appprojects                | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
...
| Role `argo-cd-argocd-applicationset-controller` | core/events                            | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ---------- | ---------------------------------------- | ------------------------- | --------------------------------------------- |
| Deployment | argo-cd-argocd-applicationset-controller | applicationset-controller | quay.io/argoproj/argocd-applicationset:v0.4.1 |
...
| Kind       | Name                  | Container | Image                          |
| ---------- | --------------------- | --------- | ------------------------------ |
| Deployment | argo-cd-argocd-server | server    | quay.io/argoproj/argocd:v2.3.2 |
...
| Kind        | Name                                  | Container              | Image                          |
| ----------- | ------------------------------------- | ---------------------- | ------------------------------ |
| StatefulSet | argo-cd-argocd-application-controller | application-controller | quay.io/argoproj/argocd:v2.3.2 |
...
| Role `argo-cd-argocd-notifications-controller` | core/configmaps **(restricted to: argo-cd-argocd-notifications-controller-cm)**  | get                                 | {{< risk Low >}}      | {{< tag "ResourceNameRestricted" >}}                                                                                     |
| Role `argo-cd-argocd-notifications-controller` | core/secrets **(restricted to: argo-cd-argocd-notifications-controller-secret)** | get                                 | {{< risk Low >}}      | {{< tag "ResourceNameRestricted" >}}                                                                                     |
...
| Kind       | Name                                    | Container                | Image                          |
| ---------- | --------------------------------------- | ------------------------ | ------------------------------ |
| Deployment | argo-cd-argocd-notifications-controller | notifications-controller | quay.io/argoproj/argocd:v2.3.2 |
...
| Kind       | Name                      | Container  | Image                      |
| ---------- | ------------------------- | ---------- | -------------------------- |
| Deployment | argo-cd-argocd-dex-server | dex-server | ghcr.io/dexidp/dex:v2.30.0 |
...
| Kind       | Name                       | Container   | Image                          |
| ---------- | -------------------------- | ----------- | ------------------------------ |
| Deployment | argo-cd-argocd-repo-server | repo-server | quay.io/argoproj/argocd:v2.3.2 |
...
| Kind        | Name                    | Container      | Image                            |
| ----------- | ----------------------- | -------------- | -------------------------------- |
| StatefulSet | argo-cd-redis-ha-server | redis          | redis:6.2.6-alpine               |
| StatefulSet | argo-cd-redis-ha-server | redis-exporter | oliver006/redis_exporter:v1.15.1 |
| StatefulSet | argo-cd-redis-ha-server | sentinel       | redis:6.2.6-alpine               |
...
| Kind       | Name                     | Container | Image         |
| ---------- | ------------------------ | --------- | ------------- |
| Deployment | argo-cd-redis-ha-haproxy | haproxy   | haproxy:2.0.4 |

---

### 🤖 `argocd-notifications-bot` {#sa-argocd-notifications-bot}
