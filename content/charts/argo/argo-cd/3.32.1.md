...
| ---------- | --------------------- | --------- | ------------------------------ |
| Deployment | argo-cd-argocd-server | server    | quay.io/argoproj/argocd:v2.2.3 |
...
| Kind       | Name                                  | Container              | Image                          |
| ---------- | ------------------------------------- | ---------------------- | ------------------------------ |
| Deployment | argo-cd-argocd-application-controller | application-controller | quay.io/argoproj/argocd:v2.2.3 |
