...
| [`argocd-server`](#sa-argocd-server)                                 | default   | ❌        | —       | 0           | 1         | —                       |
...
| ---------- | ----------------------------- | ----------------------------- | ----------------------- |
| Deployment | argocd-application-controller | argocd-application-controller | argoproj/argocd:v0.12.1 |
...
| Kind       | Name          | Container     | Image                   |
| ---------- | ------------- | ------------- | ----------------------- |
| Deployment | argocd-server | argocd-server | argoproj/argocd:v0.12.1 |
