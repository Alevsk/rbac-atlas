...
| [`argo-cd-redis-ha-haproxy`](#sa-argo-cd-redis-ha-haproxy)                                 | default   | ❌        | —       | 0           | 0         | —                       |
...
| Kind        | Name                    | Container       | Image         |
| ----------- | ----------------------- | --------------- | ------------- |
| StatefulSet | argo-cd-redis-ha-server | redis           | :6.2.6-alpine |
| StatefulSet | argo-cd-redis-ha-server | redis-exporter  | :             |
| StatefulSet | argo-cd-redis-ha-server | sentinel        | :6.2.6-alpine |
| StatefulSet | argo-cd-redis-ha-server | split-brain-fix | :6.2.6-alpine |
