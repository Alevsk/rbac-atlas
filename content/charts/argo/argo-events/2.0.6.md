...
| ClusterRole `argo-events-controller-manager` | core/secrets                        | create · delete · get · list · patch · update · watch                    | {{< risk Critical >}} | {{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "Persistence" >}} (+4 more) |
...
| ---------- | ------------------------------ | ------------------ | ----------------------------------- |
| Deployment | argo-events-controller-manager | controller-manager | quay.io/argoproj/argo-events:v1.7.3 |
