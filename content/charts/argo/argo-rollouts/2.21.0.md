...
| ------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`argo-rollouts`](#sa-argo-rollouts) | default   | ❌        | —       | 36          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `argo-rollouts` | core/secrets                          | create · get · list · patch · update · watch          | {{< risk Critical >}} | {{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}} |
| ClusterRole `argo-rollouts` | core/configmaps                       | create · get · list · patch · update · watch          | {{< risk High >}}     | {{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}                                                                   |
...
| ClusterRole `argo-rollouts` | core/pods                             | list · update                                         | {{< risk Low >}}      |                                                                                                                                                                |
...
| ---------- | ------------- | ------------- | ------------------------------------- |
| Deployment | argo-rollouts | argo-rollouts | quay.io/argoproj/argo-rollouts:v1.3.0 |
