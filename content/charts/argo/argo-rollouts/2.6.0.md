...
| ------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`argo-rollouts`](#sa-argo-rollouts) | default   | ❌        | —       | 33          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `argo-rollouts` | core/services                         | create · get · list · patch · watch                   | {{< risk Low >}}      |                                                                                                                                                                |
...
| ---------- | ------------- | ------------- | ------------------------------------- |
| Deployment | argo-rollouts | argo-rollouts | quay.io/argoproj/argo-rollouts:v1.1.0 |
