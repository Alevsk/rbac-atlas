...
| -------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`trivy-operator`](#sa-trivy-operator) | default   | ❌        | —       | 36          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `trivy-operator`          | aquasecurity.github.io/clusterrbacassessmentreports    | create · delete · get · list · update · watch | {{< risk Low >}}      |                                                                                                                                                                |
...
| ClusterRole `trivy-operator`          | aquasecurity.github.io/rbacassessmentreports           | create · delete · get · list · update · watch | {{< risk Low >}}      |                                                                                                                                                                |
...
| ---------- | -------------- | -------------- | -------------------------------------- |
| Deployment | trivy-operator | trivy-operator | docker.io/aquasec/trivy-operator:0.1.3 |
