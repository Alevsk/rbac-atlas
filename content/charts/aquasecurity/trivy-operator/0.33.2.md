...
|---|---|---|---|---|---|---|
|[`trivy-operator`](#sa-trivy-operator)|default|❌|—|46|1|{{< risk "Critical" >}}|
...
|ClusterRole `trivy-operator`|core/persistentvolumeclaims|get · list · watch|{{< risk Low >}}||
|ClusterRole `trivy-operator`|core/persistentvolumes|get · list · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|trivy-operator|trivy-operator|mirror.gcr.io/aquasec/trivy-operator:0.31.2|
