...
| -------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`trivy-operator`](#sa-trivy-operator) | default   | ❌        | —       | 33          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `trivy-operator` | aquasecurity.github.io/exposedsecretreports            | create · delete · get · list · update · watch | {{< risk Low >}}      |                                                                                                                                                                |
...
| ClusterRole `trivy-operator` | coordination.k8s.io/leases                             | create · get · update                         | {{< risk Low >}}      |                                                                                                                                                                |
...
| ---------- | -------------- | -------------- | -------------------------------------- |
| Deployment | trivy-operator | trivy-operator | docker.io/aquasec/trivy-operator:0.1.0 |
