...
| -------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ------------------- |
| [`trivy-operator`](#sa-trivy-operator) | default   | ❌        | —       | 34          | 1         | {{< risk "High" >}} |
...
| ClusterRole `trivy-operator`          | core/secrets                                           | create · get                                          | {{< risk Low >}}    |                                                                                                                                   |
...
| ---------- | -------------- | -------------- | ----------------------------------------- |
| Deployment | trivy-operator | trivy-operator | ghcr.io/aquasecurity/trivy-operator:0.1.7 |
