...
| -------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`spire-agent`](#sa-spire-agent) | default   | ❌        | —       | 3           | 1         | {{< risk "Critical" >}} |
...
| --------- | ----------- | ------------------- | ----------------------------------- |
| DaemonSet | spire-agent | appmesh-spire-agent | gcr.io/spiffe-io/spire-agent:0.12.0 |
