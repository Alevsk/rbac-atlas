...
|---|---|---|---|
|Job|redis-enterprise-installer|install-crds|redislabs/operator:8.0.18-14|
|Job|redis-enterprise-installer|label-namespace|redislabs/operator:8.0.18-14|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|redis-enterprise-uninstaller|unlabel-namespace|redislabs/operator:8.0.18-14|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|redis-enterprise-operator|admission|redislabs/operator:8.0.18-14|
|Deployment|redis-enterprise-operator|redis-enterprise-operator|redislabs/operator:8.0.18-14|
