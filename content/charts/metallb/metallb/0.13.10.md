...
| ---------- | ------------------ | ---------- | ----------------------------------- |
| Deployment | metallb-controller | controller | quay.io/metallb/controller:v0.13.10 |
...
| Kind      | Name            | Container   | Image                            |
| --------- | --------------- | ----------- | -------------------------------- |
| DaemonSet | metallb-speaker | frr         | quay.io/frrouting/frr:8.4.2      |
| DaemonSet | metallb-speaker | frr-metrics | quay.io/frrouting/frr:8.4.2      |
| DaemonSet | metallb-speaker | reloader    | quay.io/frrouting/frr:8.4.2      |
| DaemonSet | metallb-speaker | speaker     | quay.io/metallb/speaker:v0.13.10 |
