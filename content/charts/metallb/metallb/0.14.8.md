...
| DaemonSet | metallb-speaker | speaker     | quay.io/metallb/speaker:v0.14.8 |
...
| Kind       | Name               | Container  | Image                              |
| ---------- | ------------------ | ---------- | ---------------------------------- |
| Deployment | metallb-controller | controller | quay.io/metallb/controller:v0.14.8 |
...
| Kind       | Name                           | Container              | Image                                      |
| ---------- | ------------------------------ | ---------------------- | ------------------------------------------ |
| DaemonSet  | metallb-frr-k8s                | controller             | quay.io/metallb/frr-k8s:v0.0.14            |
...
| Deployment | metallb-frr-k8s-webhook-server | frr-k8s-webhook-server | quay.io/metallb/frr-k8s:v0.0.14            |
