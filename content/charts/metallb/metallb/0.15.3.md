...
| -------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | --------------------- |
| [`metallb-speaker`](#sa-metallb-speaker)                       | default   | ❌        | —       | 10          | 4         | {{< risk "High" >}}   |
| [`metallb-controller`](#sa-metallb-controller)                 | default   | ❌        | —       | 17          | 1         | {{< risk "Medium" >}} |
...
| --------- | --------------- | ----------- | ------------------------------- |
| DaemonSet | metallb-speaker | frr         | quay.io/frrouting/frr:10.4.1    |
| DaemonSet | metallb-speaker | frr-metrics | quay.io/frrouting/frr:10.4.1    |
| DaemonSet | metallb-speaker | reloader    | quay.io/frrouting/frr:10.4.1    |
| DaemonSet | metallb-speaker | speaker     | quay.io/metallb/speaker:v0.15.3 |
...
| Kind       | Name               | Container  | Image                              |
| ---------- | ------------------ | ---------- | ---------------------------------- |
| Deployment | metallb-controller | controller | quay.io/metallb/controller:v0.15.3 |
...
| Kind       | Name                          | Container             | Image                                      |
| ---------- | ----------------------------- | --------------------- | ------------------------------------------ |
| DaemonSet  | metallb-frr-k8s               | controller            | quay.io/metallb/frr-k8s:v0.0.21            |
| DaemonSet  | metallb-frr-k8s               | frr                   | quay.io/frrouting/frr:10.4.1               |
| DaemonSet  | metallb-frr-k8s               | frr-metrics           | quay.io/frrouting/frr:10.4.1               |
| DaemonSet  | metallb-frr-k8s               | frr-status            | quay.io/frrouting/frr:10.4.1               |
...
| DaemonSet  | metallb-frr-k8s               | reloader              | quay.io/frrouting/frr:10.4.1               |
| Deployment | metallb-frr-k8s-statuscleaner | frr-k8s-statuscleaner | quay.io/metallb/frr-k8s:v0.0.21            |
