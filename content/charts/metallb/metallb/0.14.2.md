...
| [`metallb-frr-k8s-controller`](#sa-metallb-frr-k8s-controller) | default   | ❌        | —       | 8           | 7         | {{< risk "Medium" >}} |
| [`metallb-speaker`](#sa-metallb-speaker)                       | default   | ❌        | —       | 6           | 4         | {{< risk "Low" >}}    |
...
| ---------- | ------------------ | ---------- | ---------------------------------- |
| Deployment | metallb-controller | controller | quay.io/metallb/controller:v0.14.2 |
...
| Kind       | Name                           | Container              | Image                                      |
| ---------- | ------------------------------ | ---------------------- | ------------------------------------------ |
| DaemonSet  | metallb-frr-k8s                | controller             | quay.io/metallb/frr-k8s:v0.0.8             |
| DaemonSet  | metallb-frr-k8s                | frr                    | quay.io/frrouting/frr:8.4.2                |
| DaemonSet  | metallb-frr-k8s                | frr-metrics            | quay.io/frrouting/frr:8.4.2                |
...
| DaemonSet  | metallb-frr-k8s                | reloader               | quay.io/frrouting/frr:8.4.2                |
| Deployment | metallb-frr-k8s-webhook-server | frr-k8s-webhook-server | quay.io/metallb/frr-k8s:v0.0.8             |
...
| Kind      | Name            | Container   | Image                           |
| --------- | --------------- | ----------- | ------------------------------- |
| DaemonSet | metallb-speaker | frr         | quay.io/frrouting/frr:8.5.2     |
| DaemonSet | metallb-speaker | frr-metrics | quay.io/frrouting/frr:8.5.2     |
| DaemonSet | metallb-speaker | reloader    | quay.io/frrouting/frr:8.5.2     |
| DaemonSet | metallb-speaker | speaker     | quay.io/metallb/speaker:v0.14.2 |
