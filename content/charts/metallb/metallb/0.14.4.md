...
| --------- | --------------- | ----------- | ------------------------------- |
| DaemonSet | metallb-speaker | frr         | quay.io/frrouting/frr:9.0.2     |
| DaemonSet | metallb-speaker | frr-metrics | quay.io/frrouting/frr:9.0.2     |
| DaemonSet | metallb-speaker | reloader    | quay.io/frrouting/frr:9.0.2     |
| DaemonSet | metallb-speaker | speaker     | quay.io/metallb/speaker:v0.14.4 |
...
| Kind       | Name               | Container  | Image                              |
| ---------- | ------------------ | ---------- | ---------------------------------- |
| Deployment | metallb-controller | controller | quay.io/metallb/controller:v0.14.4 |
...
| Kind       | Name                           | Container              | Image                                      |
| ---------- | ------------------------------ | ---------------------- | ------------------------------------------ |
| DaemonSet  | metallb-frr-k8s                | controller             | quay.io/metallb/frr-k8s:v0.0.10            |
| DaemonSet  | metallb-frr-k8s                | frr                    | quay.io/frrouting/frr:9.0.2                |
| DaemonSet  | metallb-frr-k8s                | frr-metrics            | quay.io/frrouting/frr:9.0.2                |
...
| DaemonSet  | metallb-frr-k8s                | reloader               | quay.io/frrouting/frr:9.0.2                |
| Deployment | metallb-frr-k8s-webhook-server | frr-k8s-webhook-server | quay.io/metallb/frr-k8s:v0.0.10            |
