...
| Kind        | Name                       | Container  | Image                                            |
| ----------- | -------------------------- | ---------- | ------------------------------------------------ |
| StatefulSet | netbox-operator-postgresql | postgresql | docker.io/bitnami/postgresql:17.2.0-debian-12-r3 |
...
| Kind        | Name                         | Container | Image                                      |
| ----------- | ---------------------------- | --------- | ------------------------------------------ |
| StatefulSet | netbox-operator-redis-master | redis     | docker.io/bitnami/redis:7.4.1-debian-12-r2 |
...
| Kind        | Name                           | Container | Image                                      |
| ----------- | ------------------------------ | --------- | ------------------------------------------ |
| StatefulSet | netbox-operator-redis-replicas | redis     | docker.io/bitnami/redis:7.4.1-debian-12-r2 |
