...
| ---------- | --------------- | --------------- | ----------------------------------------------- |
| Deployment | netbox-operator | netbox-operator | ghcr.io/netbox-community/netbox-operator:v0.1.0 |
...
| Kind       | Name                                    | Container           | Image                                  |
| ---------- | --------------------------------------- | ------------------- | -------------------------------------- |
| CronJob    | netbox-operator-netbox-app-housekeeping | netbox-housekeeping | ghcr.io/netbox-community/netbox:v4.3.1 |
| Deployment | netbox-operator-netbox-app              | netbox              | ghcr.io/netbox-community/netbox:v4.3.1 |
| Deployment | netbox-operator-netbox-app-worker       | netbox-worker       | ghcr.io/netbox-community/netbox:v4.3.1 |
...
| Kind        | Name                       | Container  | Image                                             |
| ----------- | -------------------------- | ---------- | ------------------------------------------------- |
| StatefulSet | netbox-operator-postgresql | postgresql | docker.io/bitnami/postgresql:17.5.0-debian-12-r10 |
...
| Kind        | Name                           | Container | Image                                       |
| ----------- | ------------------------------ | --------- | ------------------------------------------- |
| StatefulSet | netbox-operator-valkey-primary | valkey    | docker.io/bitnami/valkey:8.1.1-debian-12-r1 |
...
| Kind        | Name                            | Container | Image                                       |
| ----------- | ------------------------------- | --------- | ------------------------------------------- |
| StatefulSet | netbox-operator-valkey-replicas | valkey    | docker.io/bitnami/valkey:8.1.1-debian-12-r1 |
