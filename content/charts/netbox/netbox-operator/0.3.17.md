...
| Kind        | Name                         | Container | Image                                      |
| ----------- | ---------------------------- | --------- | ------------------------------------------ |
| StatefulSet | netbox-operator-redis-master | redis     | docker.io/bitnami/redis:7.4.2-debian-12-r6 |
...
| Kind        | Name                           | Container | Image                                      |
| ----------- | ------------------------------ | --------- | ------------------------------------------ |
| StatefulSet | netbox-operator-redis-replicas | redis     | docker.io/bitnami/redis:7.4.2-debian-12-r6 |
