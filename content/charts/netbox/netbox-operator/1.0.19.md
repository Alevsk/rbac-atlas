...
| Kind        | Name                           | Container | Image                                       |
| ----------- | ------------------------------ | --------- | ------------------------------------------- |
| StatefulSet | netbox-operator-valkey-primary | valkey    | docker.io/bitnami/valkey:8.1.1-debian-12-r2 |
...
| Kind        | Name                            | Container | Image                                       |
| ----------- | ------------------------------- | --------- | ------------------------------------------- |
| StatefulSet | netbox-operator-valkey-replicas | valkey    | docker.io/bitnami/valkey:8.1.1-debian-12-r2 |
