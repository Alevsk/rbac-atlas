...
| ---------- | --------------- | --------------- | ------------------------------------------------------- |
| Deployment | netbox-operator | netbox-operator | ghcr.io/netbox-community/netbox-operator:v0.1.0-alpha.1 |
...
| Kind       | Name                                    | Container           | Image                                   |
| ---------- | --------------------------------------- | ------------------- | --------------------------------------- |
| CronJob    | netbox-operator-netbox-app-housekeeping | netbox-housekeeping | docker.io/netboxcommunity/netbox:v4.0.0 |
| Deployment | netbox-operator-netbox-app              | netbox              | docker.io/netboxcommunity/netbox:v4.0.0 |
| Deployment | netbox-operator-netbox-app-worker       | netbox-worker       | docker.io/netboxcommunity/netbox:v4.0.0 |
...
| Kind        | Name                       | Container  | Image                                                        |
| ----------- | -------------------------- | ---------- | ------------------------------------------------------------ |
| StatefulSet | netbox-operator-postgresql | postgresql | registry-1.docker.io/bitnami/postgresql:16.1.0-debian-11-r25 |
...
| Kind        | Name                         | Container | Image                                      |
| ----------- | ---------------------------- | --------- | ------------------------------------------ |
| StatefulSet | netbox-operator-redis-master | redis     | docker.io/bitnami/redis:7.2.4-debian-12-r9 |
...
| Kind        | Name                           | Container | Image                                      |
| ----------- | ------------------------------ | --------- | ------------------------------------------ |
| StatefulSet | netbox-operator-redis-replicas | redis     | docker.io/bitnami/redis:7.2.4-debian-12-r9 |
