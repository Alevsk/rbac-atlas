...
| ---------- | ---------------- | ---------------- | ------------------------------------------------- |
| Deployment | external-secrets | external-secrets | ghcr.io/external-secrets/external-secrets:v0.10.1 |
...
| ClusterRole `external-secrets-cert-controller` | admissionregistration.k8s.io/validatingwebhookconfigurations                                              | list                                | {{< risk Low >}}      |                                                                                                                                                                |
| ClusterRole `external-secrets-cert-controller` | admissionregistration.k8s.io/validatingwebhookconfigurations **(restricted to: externalsecret-validate)** | get · patch · update · watch        | {{< risk Low >}}      | {{< tag "ResourceNameRestricted" >}}                                                                                                                           |
| ClusterRole `external-secrets-cert-controller` | admissionregistration.k8s.io/validatingwebhookconfigurations **(restricted to: secretstore-validate)**    | get · patch · update · watch        | {{< risk Low >}}      | {{< tag "ResourceNameRestricted" >}}                                                                                                                           |
...
| Kind       | Name                             | Container       | Image                                             |
| ---------- | -------------------------------- | --------------- | ------------------------------------------------- |
| Deployment | external-secrets-cert-controller | cert-controller | ghcr.io/external-secrets/external-secrets:v0.10.1 |
...
| Kind       | Name                 | Container            | Image                                                |
| ---------- | -------------------- | -------------------- | ---------------------------------------------------- |
| Deployment | bitwarden-sdk-server | bitwarden-sdk-server | ghcr.io/external-secrets/bitwarden-sdk-server:v0.1.4 |
...
| Kind       | Name                     | Container | Image                                             |
| ---------- | ------------------------ | --------- | ------------------------------------------------- |
| Deployment | external-secrets-webhook | webhook   | ghcr.io/external-secrets/external-secrets:v0.10.1 |
