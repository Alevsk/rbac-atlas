...
|---|---|---|---|---|---|---|
|[`external-secrets`](#sa-external-secrets)|default|❌|—|45|1|{{< risk "Critical" >}}|
...
|---|---|---|---|
|Deployment|external-secrets|external-secrets|ghcr.io/external-secrets/external-secrets:v2.7.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|external-secrets-cert-controller|cert-controller|ghcr.io/external-secrets/external-secrets:v2.7.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|external-secrets-webhook|webhook|ghcr.io/external-secrets/external-secrets:v2.7.0|
