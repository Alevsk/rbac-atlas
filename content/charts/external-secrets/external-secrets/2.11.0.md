...
|---|---|---|---|---|---|---|
|[`external-secrets`](#sa-external-secrets)|default|❌|—|46|1|{{< risk "Critical" >}}|
|[`external-secrets-cert-controller`](#sa-external-secrets-cert-controller)|default|❌|—|13|1|{{< risk "Critical" >}}|
...
|ClusterRole `external-secrets-controller`|generators.external-secrets.io/beyondtrustworkloadcredentialsdynamicsecrets|get · list · watch|{{< risk Low >}}||
...
|ClusterRole `external-secrets-controller`|generators.external-secrets.io/gitlabdeploytokens|get · list · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|external-secrets|external-secrets|ghcr.io/external-secrets/external-secrets:v2.11.0|
...
|Role|Resource|Verbs|Risk|Tags|
|---|---|---|---|---|
|ClusterRole `external-secrets-cert-controller`|core/secrets|get · list · watch|{{< risk Critical >}}|{{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}}|
...
|ClusterRole `external-secrets-cert-controller`|apiextensions.k8s.io/customresourcedefinitions|get · list · watch|{{< risk Low >}}||
...
|ClusterRole `external-secrets-cert-controller`|apiextensions.k8s.io/customresourcedefinitions **(restricted to: clustersecretstores.external-secrets.io)**|patch · update|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
|ClusterRole `external-secrets-cert-controller`|core/secrets **(restricted to: external-secrets-webhook)**|patch · update|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
...
|ClusterRole `external-secrets-cert-controller`|apiextensions.k8s.io/customresourcedefinitions **(restricted to: externalsecrets.external-secrets.io)**|patch · update|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
...
|ClusterRole `external-secrets-cert-controller`|apiextensions.k8s.io/customresourcedefinitions **(restricted to: secretstores.external-secrets.io)**|patch · update|{{< risk Low >}}|{{< tag "ResourceNameRestricted" >}}|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|external-secrets-cert-controller|cert-controller|ghcr.io/external-secrets/external-secrets:v2.11.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|external-secrets-webhook|webhook|ghcr.io/external-secrets/external-secrets:v2.11.0|
