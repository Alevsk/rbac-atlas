...
| ---------- | ---------------- | ---------------- | ------------------------------------------------- |
| Deployment | external-secrets | external-secrets | ghcr.io/external-secrets/external-secrets:v0.9.13 |
...
| Kind       | Name                             | Container       | Image                                             |
| ---------- | -------------------------------- | --------------- | ------------------------------------------------- |
| Deployment | external-secrets-cert-controller | cert-controller | ghcr.io/external-secrets/external-secrets:v0.9.13 |
...
| Kind       | Name                     | Container | Image                                             |
| ---------- | ------------------------ | --------- | ------------------------------------------------- |
| Deployment | external-secrets-webhook | webhook   | ghcr.io/external-secrets/external-secrets:v0.9.13 |
