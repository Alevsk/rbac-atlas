...
| ---------- | ------------- | --------------- | ----------------------------------------- |
| Deployment | snapscheduler | kube-rbac-proxy | gcr.io/kubebuilder/kube-rbac-proxy:v0.8.0 |
| Deployment | snapscheduler | manager         | quay.io/backube/snapscheduler:2.0.0       |
