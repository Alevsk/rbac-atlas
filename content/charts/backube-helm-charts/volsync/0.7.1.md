...
| ------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`volsync`](#sa-volsync) | default   | ❌        | —       | 28          | 2         | {{< risk "Critical" >}} |
...
| ---------- | ------- | --------------- | -------------------------------------- |
| Deployment | volsync | kube-rbac-proxy | quay.io/brancz/kube-rbac-proxy:v0.14.0 |
| Deployment | volsync | manager         | quay.io/backube/volsync:0.7.1          |
