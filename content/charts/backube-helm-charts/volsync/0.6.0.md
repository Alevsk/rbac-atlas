...
| ------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`volsync`](#sa-volsync) | default   | ❌        | —       | 27          | 2         | {{< risk "Critical" >}} |
...
| ---------- | ------- | --------------- | -------------------------------------- |
| Deployment | volsync | kube-rbac-proxy | quay.io/brancz/kube-rbac-proxy:v0.13.1 |
| Deployment | volsync | manager         | quay.io/backube/volsync:0.6.0          |
