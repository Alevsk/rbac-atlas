...
| ------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`volsync`](#sa-volsync) | default   | ❌        | —       | 32          | 2         | {{< risk "Critical" >}} |
...
| ClusterRole `volsync-manager`  | security.openshift.io/securitycontextconstraints   | create · get · list · patch · update · use · watch                       | {{< risk Low >}}      |                                                                                                                                                                              |
