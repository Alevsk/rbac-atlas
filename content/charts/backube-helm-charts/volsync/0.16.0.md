...
|---|---|---|---|---|---|---|
|[`volsync`](#sa-volsync)|default|❌|—|34|1|{{< risk "Critical" >}}|
...
|ClusterRole `volsync-manager`|config.openshift.io/apiservers|get · list · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|volsync|manager|quay.io/backube/volsync:0.16.0|
