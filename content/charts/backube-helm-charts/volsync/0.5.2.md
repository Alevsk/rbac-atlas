...
| ------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`volsync`](#sa-volsync) | default   | ❌        | —       | 25          | 2         | {{< risk "Critical" >}} |
...
| ---------- | ------- | --------------- | ------------------------------------------ |
| Deployment | volsync | kube-rbac-proxy | gcr.io/kubebuilder/kube-rbac-proxy:v0.13.0 |
| Deployment | volsync | manager         | quay.io/backube/volsync:0.5.2              |
