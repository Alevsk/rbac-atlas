...
| ---------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`sops-secrets-operator`](#sa-sops-secrets-operator) | default   | ❌        | —       | 6           | 1         | {{< risk "Critical" >}} |
...
| ---------- | --------------------- | --------------------- | ------------------------------------ |
| Deployment | sops-secrets-operator | sops-secrets-operator | isindir/sops-secrets-operator:0.1.17 |
