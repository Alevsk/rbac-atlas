...
| ClusterRole `sops-secrets-operator` | coordination.k8s.io/leases                | get · patch · update · watch                          | {{< risk Low >}}      |                                                                                                                                                                                   |
...
| ---------- | --------------------- | --------------------- | ----------------------------------- |
| Deployment | sops-secrets-operator | sops-secrets-operator | isindir/sops-secrets-operator:0.2.0 |
