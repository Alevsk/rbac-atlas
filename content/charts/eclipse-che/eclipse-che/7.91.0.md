...
| ---------------------------------- | ----------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`che-operator`](#sa-che-operator) | eclipse-che | ❌        | —       | 47          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ------------ | ------------ | ----------------------------------- |
| Deployment | che-operator | che-operator | quay.io/eclipse/che-operator:7.91.0 |
