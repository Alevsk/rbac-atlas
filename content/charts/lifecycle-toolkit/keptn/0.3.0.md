...
| [`lifecycle-operator`](#sa-lifecycle-operator)     | default   | ❌        | —       | 51          | 1         | {{< risk "Critical" >}} |
| [`metrics-operator`](#sa-metrics-operator)         | default   | ❌        | —       | 15          | 1         | {{< risk "Critical" >}} |
| [`keptn-scheduler`](#sa-keptn-scheduler)           | default   | ❌        | —       | 30          | 1         | {{< risk "High" >}}     |
...
| ClusterRole `lifecycle-operator-role`          | lifecycle.keptn.sh/keptnevaluationproviders            | get · list · watch                                    | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `lifecycle-operator-role`          | lifecycle.keptn.sh/keptnworkloadinstances              | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `lifecycle-operator-role`          | lifecycle.keptn.sh/keptnworkloadinstances/finalizers   | update                                                | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `lifecycle-operator-role`          | lifecycle.keptn.sh/keptnworkloadinstances/status       | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ---------- | ------------------ | ------------------ | --------------------------------------- |
| Deployment | lifecycle-operator | lifecycle-operator | ghcr.io/keptn/lifecycle-operator:v0.8.3 |
...
| Kind       | Name             | Container        | Image                                 |
| ---------- | ---------------- | ---------------- | ------------------------------------- |
| Deployment | metrics-operator | metrics-operator | ghcr.io/keptn/metrics-operator:v0.8.3 |
...
| Kind       | Name                 | Container            | Image                                     |
| ---------- | -------------------- | -------------------- | ----------------------------------------- |
| Deployment | certificate-operator | certificate-operator | ghcr.io/keptn/certificate-operator:v1.2.0 |
...
| Kind       | Name      | Container | Image                          |
| ---------- | --------- | --------- | ------------------------------ |
| Deployment | scheduler | scheduler | ghcr.io/keptn/scheduler:v0.8.3 |
