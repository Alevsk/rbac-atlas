...
| ---------- | ------------------ | ------------------ | --------------------------------------- |
| Deployment | lifecycle-operator | lifecycle-operator | ghcr.io/keptn/lifecycle-operator:v1.2.0 |
...
| Kind       | Name      | Container | Image                          |
| ---------- | --------- | --------- | ------------------------------ |
| Deployment | scheduler | scheduler | ghcr.io/keptn/scheduler:v1.0.2 |
...
| Kind       | Name             | Container        | Image                                 |
| ---------- | ---------------- | ---------------- | ------------------------------------- |
| Deployment | metrics-operator | metrics-operator | ghcr.io/keptn/metrics-operator:v1.1.1 |
...
| Kind       | Name                 | Container            | Image                                     |
| ---------- | -------------------- | -------------------- | ----------------------------------------- |
| Deployment | certificate-operator | certificate-operator | ghcr.io/keptn/certificate-operator:v2.2.2 |
