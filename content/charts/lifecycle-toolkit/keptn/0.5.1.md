...
| ---------- | ------------------ | ------------------ | --------------------------------------- |
| Deployment | lifecycle-operator | lifecycle-operator | ghcr.io/keptn/lifecycle-operator:v0.9.1 |
...
| Kind       | Name             | Container        | Image                                 |
| ---------- | ---------------- | ---------------- | ------------------------------------- |
| Deployment | metrics-operator | metrics-operator | ghcr.io/keptn/metrics-operator:v0.9.2 |
...
| Kind       | Name                 | Container            | Image                                     |
| ---------- | -------------------- | -------------------- | ----------------------------------------- |
| Deployment | certificate-operator | certificate-operator | ghcr.io/keptn/certificate-operator:v2.1.0 |
...
| Kind       | Name      | Container | Image                          |
| ---------- | --------- | --------- | ------------------------------ |
| Deployment | scheduler | scheduler | ghcr.io/keptn/scheduler:v0.9.1 |
