...
| ---------- | ----------------- | --------- | --------------------------------------------- |
| Deployment | dynatrace-webhook | webhook   | docker.io/dynatrace/dynatrace-operator:v0.7.1 |
...
| Kind       | Name               | Container          | Image                                         |
| ---------- | ------------------ | ------------------ | --------------------------------------------- |
| Deployment | dynatrace-operator | dynatrace-operator | docker.io/dynatrace/dynatrace-operator:v0.7.1 |
