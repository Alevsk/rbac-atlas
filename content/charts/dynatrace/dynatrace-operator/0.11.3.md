...
| ---------- | ----------------- | --------- | ---------------------------------------------- |
| Deployment | dynatrace-webhook | webhook   | docker.io/dynatrace/dynatrace-operator:v0.11.3 |
...
| ClusterRole `dynatrace-operator` | core/secrets **(restricted to: dynatrace-activegate-internal-proxy)**                               | delete · get · list · update | {{< risk Low >}} | {{< tag "ResourceNameRestricted" >}}                                                            |
...
| Kind       | Name               | Container          | Image                                          |
| ---------- | ------------------ | ------------------ | ---------------------------------------------- |
| Deployment | dynatrace-operator | dynatrace-operator | docker.io/dynatrace/dynatrace-operator:v0.11.3 |
