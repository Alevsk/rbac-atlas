...
| ------------------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`dynatrace-kubernetes-monitoring`](#sa-dynatrace-kubernetes-monitoring) | default   | ❌        | —       | 18          | 0         | {{< risk "Critical" >}} |
| [`dynatrace-oneagent-csi-driver`](#sa-dynatrace-oneagent-csi-driver)     | default   | ❌        | —       | 10          | 4         | {{< risk "Critical" >}} |
...
| ---------- | ----------------- | --------- | -------------------------------------------------- |
| Deployment | dynatrace-webhook | webhook   | public.ecr.aws/dynatrace/dynatrace-operator:v1.0.0 |
...
| Kind      | Name                          | Container      | Image                                              |
| --------- | ----------------------------- | -------------- | -------------------------------------------------- |
| DaemonSet | dynatrace-oneagent-csi-driver | liveness-probe | public.ecr.aws/dynatrace/dynatrace-operator:v1.0.0 |
| DaemonSet | dynatrace-oneagent-csi-driver | provisioner    | public.ecr.aws/dynatrace/dynatrace-operator:v1.0.0 |
| DaemonSet | dynatrace-oneagent-csi-driver | registrar      | public.ecr.aws/dynatrace/dynatrace-operator:v1.0.0 |
| DaemonSet | dynatrace-oneagent-csi-driver | server         | public.ecr.aws/dynatrace/dynatrace-operator:v1.0.0 |
...
| ClusterRole `dynatrace-operator` | core/secrets **(restricted to: dynatrace-data-ingest-endpoint)**                                    | delete · get · list · update | {{< risk Low >}} | {{< tag "ResourceNameRestricted" >}}                                                            |
...
| ClusterRole `dynatrace-operator` | core/secrets **(restricted to: dynatrace-internal-proxy)**                                          | delete · get · list · update | {{< risk Low >}} | {{< tag "ResourceNameRestricted" >}}                                                            |
...
| Kind       | Name               | Container | Image                                              |
| ---------- | ------------------ | --------- | -------------------------------------------------- |
| Deployment | dynatrace-operator | operator  | public.ecr.aws/dynatrace/dynatrace-operator:v1.0.0 |
