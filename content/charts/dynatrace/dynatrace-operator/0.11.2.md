...
| ---------- | ----------------- | --------- | ---------------------------------------------- |
| Deployment | dynatrace-webhook | webhook   | docker.io/dynatrace/dynatrace-operator:v0.11.2 |
...
| Kind       | Name               | Container          | Image                                          |
| ---------- | ------------------ | ------------------ | ---------------------------------------------- |
| Deployment | dynatrace-operator | dynatrace-operator | docker.io/dynatrace/dynatrace-operator:v0.11.2 |
