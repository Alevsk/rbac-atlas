...
| ---------- | ----------------- | --------- | -------------------------------------------------- |
| Deployment | dynatrace-webhook | webhook   | public.ecr.aws/dynatrace/dynatrace-operator:v1.4.0 |
...
| Kind      | Name                          | Container      | Image                                              |
| --------- | ----------------------------- | -------------- | -------------------------------------------------- |
| DaemonSet | dynatrace-oneagent-csi-driver | liveness-probe | public.ecr.aws/dynatrace/dynatrace-operator:v1.4.0 |
| DaemonSet | dynatrace-oneagent-csi-driver | provisioner    | public.ecr.aws/dynatrace/dynatrace-operator:v1.4.0 |
| DaemonSet | dynatrace-oneagent-csi-driver | registrar      | public.ecr.aws/dynatrace/dynatrace-operator:v1.4.0 |
| DaemonSet | dynatrace-oneagent-csi-driver | server         | public.ecr.aws/dynatrace/dynatrace-operator:v1.4.0 |
...
| Kind       | Name               | Container | Image                                              |
| ---------- | ------------------ | --------- | -------------------------------------------------- |
| Deployment | dynatrace-operator | operator  | public.ecr.aws/dynatrace/dynatrace-operator:v1.4.0 |
