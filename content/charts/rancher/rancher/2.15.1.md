...
|[`rancher-pre-upgrade`](#sa-rancher-pre-upgrade)|default|❌|—|1|1|{{< risk "Low" >}}|
...
|---|---|---|---|
|Job|rancher-post-delete|rancher-post-delete|rancher/shell:v0.8.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|rancher-pre-upgrade|rancher-pre-upgrade|rancher/shell:v0.8.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|rancher|rancher|rancher/rancher:v2.15.1|
