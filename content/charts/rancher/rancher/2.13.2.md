...
| ---- | ------------------- | ------------------- | -------------------- |
| Job  | rancher-post-delete | rancher-post-delete | rancher/shell:v0.6.1 |
...
| Kind | Name                | Container           | Image                |
| ---- | ------------------- | ------------------- | -------------------- |
| Job  | rancher-pre-upgrade | rancher-pre-upgrade | rancher/shell:v0.6.1 |
...
| Kind       | Name    | Container | Image                   |
| ---------- | ------- | --------- | ----------------------- |
| Deployment | rancher | rancher   | rancher/rancher:v2.13.2 |
