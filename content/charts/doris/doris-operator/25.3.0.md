...
description: "Kubernetes operator for creating, configuring and managing Doris clusters (dcr) and Doris disaggregated clusters  (ddc). It can deploy and manage all components for Doris clusters: meta service, fe, be, cn, compute group, and  broker. "
version: v25.3.0
...
Kubernetes operator for creating, configuring and managing Doris clusters (dcr) and Doris disaggregated clusters (ddc). It can deploy and manage all components for Doris clusters: meta service, fe, be, cn, compute group, and broker.
