...
| ---------- | ---------------------------- | --------- | ------------------------------- |
| Deployment | kyverno-admission-controller | kyverno   | ghcr.io/kyverno/kyverno:v1.13.2 |
...
| Kind       | Name                          | Container  | Image                                         |
| ---------- | ----------------------------- | ---------- | --------------------------------------------- |
| Deployment | kyverno-background-controller | controller | ghcr.io/kyverno/background-controller:v1.13.2 |
...
| Kind       | Name                       | Container  | Image                                      |
| ---------- | -------------------------- | ---------- | ------------------------------------------ |
| Deployment | kyverno-reports-controller | controller | ghcr.io/kyverno/reports-controller:v1.13.2 |
...
| Kind       | Name                       | Container  | Image                                      |
| ---------- | -------------------------- | ---------- | ------------------------------------------ |
| Deployment | kyverno-cleanup-controller | controller | ghcr.io/kyverno/cleanup-controller:v1.13.2 |
