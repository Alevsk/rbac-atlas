...
|---|---|---|---|
|Deployment|kyverno-admission-controller|kyverno|reg.kyverno.io/kyverno/kyverno:v1.17.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kyverno-background-controller|controller|reg.kyverno.io/kyverno/background-controller:v1.17.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kyverno-reports-controller|controller|reg.kyverno.io/kyverno/reports-controller:v1.17.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|kyverno-migrate-resources|kubectl|reg.kyverno.io/kyverno/kyverno-cli:v1.17.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kyverno-cleanup-controller|controller|reg.kyverno.io/kyverno/cleanup-controller:v1.17.0|
