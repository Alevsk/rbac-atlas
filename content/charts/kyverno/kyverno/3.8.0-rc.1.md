...
|[`kyverno-cleanup-controller`](#sa-kyverno-cleanup-controller)|default|❌|—|11|1|{{< risk "Low" >}}|
...
|---|---|---|---|
|Deployment|kyverno-admission-controller|kyverno|reg.kyverno.io/kyverno/kyverno:v1.18.0-rc.1|
|Job|kyverno-rm-webhooks|kubectl|ghcr.io/kyverno/readiness-checker:v1.18.0-rc.1|
|Job|kyverno-scale-to-zero|kubectl|ghcr.io/kyverno/readiness-checker:v1.18.0-rc.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kyverno-background-controller|controller|reg.kyverno.io/kyverno/background-controller:v1.18.0-rc.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kyverno-reports-controller|controller|reg.kyverno.io/kyverno/reports-controller:v1.18.0-rc.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|kyverno-migrate-resources|kyverno-cli|reg.kyverno.io/kyverno/kyverno-cli:v1.18.0-rc.1|
...
|Role `kyverno:cleanup-controller`|core/secrets **(restricted to: kyverno-cleanup-controller.default.metering.kyverno-tls-ca)**|delete · get · list · update · watch|{{< risk Low >}}|{{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "ResourceNameRestricted" >}} {{< tag "SecretAccess" >}}|
|Role `kyverno:cleanup-controller`|core/secrets **(restricted to: kyverno-cleanup-controller.default.metering.kyverno-tls-pair)**|delete · get · list · update · watch|{{< risk Low >}}|{{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "ResourceNameRestricted" >}} {{< tag "SecretAccess" >}}|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kyverno-cleanup-controller|controller|reg.kyverno.io/kyverno/cleanup-controller:v1.18.0-rc.1|
