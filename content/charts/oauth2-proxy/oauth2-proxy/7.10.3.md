...
| ---------- | ------------ | ------------ | ---------------------------------------- |
| Deployment | oauth2-proxy | oauth2-proxy | quay.io/oauth2-proxy/oauth2-proxy:v7.8.1 |
...
| Kind        | Name                      | Container | Image                                      |
| ----------- | ------------------------- | --------- | ------------------------------------------ |
| StatefulSet | oauth2-proxy-redis-master | redis     | docker.io/bitnami/redis:7.4.2-debian-12-r0 |
...
| Kind        | Name                        | Container | Image                                      |
| ----------- | --------------------------- | --------- | ------------------------------------------ |
| StatefulSet | oauth2-proxy-redis-replicas | redis     | docker.io/bitnami/redis:7.4.2-debian-12-r0 |
