...
| ClusterRole `system:metrics-server` | core/nodes/stats | get · list · watch | {{< risk Low >}}  |                                                                                                 |
...
| ---------- | -------------- | -------------- | ----------------------------------------------- |
| Deployment | metrics-server | metrics-server | k8s.gcr.io/metrics-server/metrics-server:v0.5.2 |
