...
| [`capsule-pre-delete`](#sa-capsule-pre-delete)       | default   | ❌        | —       | 3           | 1         | {{< risk "Low" >}} |
...
| -------------------------------- | --------------------------------------------- | ------ | ---------------- | ---- |
| ClusterRole `capsule-pre-delete` | rbac.authorization.k8s.io/clusterrolebindings | delete | {{< risk Low >}} |      |
| ClusterRole `capsule-pre-delete` | rbac.authorization.k8s.io/clusterroles        | delete | {{< risk Low >}} |      |
| Role `capsule-pre-delete`        | core/secrets                                  | delete | {{< risk Low >}} |      |
