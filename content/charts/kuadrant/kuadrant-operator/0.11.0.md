...
| [`dns-operator-controller-manager`](#sa-dns-operator-controller-manager)             | dns-operator-system       | ❌        | —       | 7           | 1         | {{< risk "Critical" >}} |
| [`kuadrant-operator-controller-manager`](#sa-kuadrant-operator-controller-manager)   | kuadrant-system           | ❌        | —       | 53          | 1         | {{< risk "Critical" >}} |
| [`limitador-operator-controller-manager`](#sa-limitador-operator-controller-manager) | limitador-operator-system | ❌        | —       | 15          | 1         | {{< risk "Critical" >}} |
...
**Namespace:** `kuadrant-system`  |  **Automount:** ❌
...
| ClusterRole `kuadrant-operator-manager-role`  | core/secrets                                  | get · list · watch                                    | {{< risk Critical >}} | {{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}}  |
...
| ClusterRole `kuadrant-operator-manager-role`  | security.istio.io/authorizationpolicies       | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `kuadrant-operator-manager-role`  | kuadrant.io/authpolicies                      | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `kuadrant-operator-manager-role`  | kuadrant.io/dnspolicies                       | delete · get · list · patch · update · watch          | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `kuadrant-operator-manager-role`  | gateway.networking.k8s.io/gatewayclasses      | list · watch                                          | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `kuadrant-operator-manager-role`  | gateway.networking.k8s.io/gateways            | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `kuadrant-operator-manager-role`  | install.istio.io/istiooperators               | create · get · list · patch · update · watch          | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `kuadrant-operator-manager-role`  | operator.istio.io/istios                      | create · get · list · patch · update · watch          | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `kuadrant-operator-manager-role`  | kuadrant.io/kuadrants                         | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `kuadrant-operator-manager-role`  | gateway.networking.k8s.io/referencegrants     | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `kuadrant-operator-manager-role`  | gateway.envoyproxy.io/securitypolicies        | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `kuadrant-operator-manager-role`  | maistra.io/servicemeshcontrolplanes           | get · list · patch · update · use · watch             | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `kuadrant-operator-manager-role`  | maistra.io/servicemeshmembers                 | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `kuadrant-operator-manager-role`  | kuadrant.io/tlspolicies                       | delete · get · list · patch · update · watch          | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ---------- | ------------------------------------ | --------- | ------------------------------------------ |
| Deployment | kuadrant-operator-controller-manager | manager   | quay.io/kuadrant/kuadrant-operator:v0.11.0 |
...
| Kind       | Name               | Container | Image                                       |
| ---------- | ------------------ | --------- | ------------------------------------------- |
| Deployment | authorino-operator | manager   | quay.io/kuadrant/authorino-operator:v0.13.0 |

---

### 🤖 `limitador-operator-controller-manager` {#sa-limitador-operator-controller-manager}

**Namespace:** `limitador-operator-system`  |  **Automount:** ❌
...
| Kind       | Name                                  | Container | Image                                       |
| ---------- | ------------------------------------- | --------- | ------------------------------------------- |
| Deployment | limitador-operator-controller-manager | manager   | quay.io/kuadrant/limitador-operator:v0.11.0 |

---

### 🤖 `dns-operator-controller-manager` {#sa-dns-operator-controller-manager}

**Namespace:** `dns-operator-system`  |  **Automount:** ❌
...
| Kind       | Name                            | Container | Image                                |
| ---------- | ------------------------------- | --------- | ------------------------------------ |
| Deployment | dns-operator-controller-manager | manager   | quay.io/kuadrant/dns-operator:v0.6.0 |
