...
|[`developer-portal-controller-manager`](#sa-developer-portal-controller-manager)|default|❌|—|20|0|{{< risk "Critical" >}}|
|[`dns-operator-controller-manager`](#sa-dns-operator-controller-manager)|default|❌|—|11|1|{{< risk "Critical" >}}|
|[`kuadrant-operator-controller-manager`](#sa-kuadrant-operator-controller-manager)|default|❌|—|67|1|{{< risk "Critical" >}}|
...
|---|---|---|---|
|Deployment|kuadrant-operator-controller-manager|manager|quay.io/kuadrant/kuadrant-operator:v1.5.2-rc1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|authorino-operator|manager|quay.io/kuadrant/authorino-operator:v0.25.2|
...
|ClusterRole `developer-portal-manager-role`|core/secrets|create · delete · get · list · watch|{{< risk Critical >}}|{{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}}|
...
|ClusterRole `developer-portal-manager-role`|devportal.kuadrant.io/apikeyapprovals|create · delete · get · list · patch · update · watch|{{< risk Low >}}||
|ClusterRole `developer-portal-manager-role`|devportal.kuadrant.io/apikeyapprovals/status|get · patch · update|{{< risk Low >}}||
|ClusterRole `developer-portal-manager-role`|devportal.kuadrant.io/apikeyrequests|create · delete · get · list · patch · update · watch|{{< risk Low >}}||
|ClusterRole `developer-portal-manager-role`|devportal.kuadrant.io/apikeyrequests/finalizers|update|{{< risk Low >}}||
|ClusterRole `developer-portal-manager-role`|devportal.kuadrant.io/apikeyrequests/status|get · patch · update|{{< risk Low >}}||
|ClusterRole `developer-portal-manager-role`|devportal.kuadrant.io/apikeys|get · list · watch|{{< risk Low >}}||
...
|ClusterRole `developer-portal-manager-role`|kuadrant.io/kuadrants|get · list · watch|{{< risk Low >}}||
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|limitador-operator-controller-manager|manager|quay.io/kuadrant/limitador-operator:v0.18.3|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|dns-operator-controller-manager|manager|quay.io/kuadrant/dns-operator:v0.17.1|
