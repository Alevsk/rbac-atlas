...
|---|---|---|---|
|Deployment|kuadrant-operator-controller-manager|manager|quay.io/kuadrant/kuadrant-operator:v1.4.0|
...
|ClusterRole `authorino-operator-manager`|core/serviceaccounts|create · get · list · patch · update · watch|{{< risk Low >}}||
|ClusterRole `authorino-operator-manager`|core/services|create · get · list · patch · update · watch|{{< risk Low >}}||
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|authorino-operator|manager|quay.io/kuadrant/authorino-operator:v0.23.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|limitador-operator-controller-manager|manager|quay.io/kuadrant/limitador-operator:v0.17.0|
