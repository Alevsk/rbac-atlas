...
medium_findings: 0
low_findings: 7
categories: [dns, managed zone, kubernetes, kuadrant]
tags:
  [
...
Kubernetes operator responsible for reconciling DNS Record and Managed Zone custom resources.
...
| ------------------------------------------------------------------------ | ------------------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`dns-operator-controller-manager`](#sa-dns-operator-controller-manager) | dns-operator-system | ❌        | —       | 10          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `dns-operator-manager-role`  | kuadrant.io/managedzones            | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `dns-operator-manager-role`  | kuadrant.io/managedzones/finalizers | update                                                | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `dns-operator-manager-role`  | kuadrant.io/managedzones/status     | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ---------- | ------------------------------- | --------- | ------------------------------------ |
| Deployment | dns-operator-controller-manager | manager   | quay.io/kuadrant/dns-operator:v0.4.1 |
