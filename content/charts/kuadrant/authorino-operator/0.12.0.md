...
| ---------------------------------------------- | ------------------ | --------- | ------- | ----------- | --------- | ----------------------- |
| [`authorino-operator`](#sa-authorino-operator) | authorino-operator | ❌        | —       | 22          | 1         | {{< risk "Critical" >}} |
...
**Namespace:** `authorino-operator`  |  **Automount:** ❌
...
| ---------- | ------------------ | --------- | ------------------------------------------- |
| Deployment | authorino-operator | manager   | quay.io/kuadrant/authorino-operator:v0.12.0 |
