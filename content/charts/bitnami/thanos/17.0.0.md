...
|---|---|---|---|---|---|---|
|[`thanos-minio`](#sa-thanos-minio)|default|❌|thanos-minio|0|2|—|
...
|Deployment|thanos-minio-console|console|docker.io/bitnami/minio-object-browser:2.0.1-debian-12-r0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|thanos-query|query|docker.io/bitnami/thanos:0.38.0-debian-12-r3|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|thanos-query-frontend|query-frontend|docker.io/bitnami/thanos:0.38.0-debian-12-r3|
