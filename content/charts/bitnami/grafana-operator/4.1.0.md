...
| ------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`grafana-operator`](#sa-grafana-operator) | default   | ❌        | —       | 28          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ---------------- | ---------------- | ----------------------------------------------------- |
| Deployment | grafana-operator | grafana-operator | docker.io/bitnami/grafana-operator:5.8.1-debian-12-r1 |
