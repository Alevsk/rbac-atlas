...
| ------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`grafana-operator`](#sa-grafana-operator) | default   | ❌        | —       | 31          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `grafana-operator-default` | grafana.integreatly.org/grafanaalertrulegroups/status     | get                                                   | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ClusterRole `grafana-operator-default` | grafana.integreatly.org/grafanacontactpoints/finalizers   | update                                                | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ---------- | ---------------- | ---------------- | ------------------------------------------------------ |
| Deployment | grafana-operator | grafana-operator | docker.io/bitnami/grafana-operator:5.11.0-debian-12-r1 |
