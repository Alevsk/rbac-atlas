...
| ---------- | ------------- | --------- | --------------------------------------------------------- |
| Deployment | minio         | minio     | docker.io/bitnami/minio:2025.5.24-debian-12-r4            |
| Deployment | minio-console | console   | docker.io/bitnami/minio-object-browser:2.0.1-debian-12-r0 |
