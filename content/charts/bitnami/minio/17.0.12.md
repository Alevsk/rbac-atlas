...
| ---------- | ------------- | --------- | --------------------------------------------------------- |
| Deployment | minio         | minio     | docker.io/bitnami/minio:2025.6.13-debian-12-r1            |
| Deployment | minio-console | console   | docker.io/bitnami/minio-object-browser:2.0.2-debian-12-r1 |
