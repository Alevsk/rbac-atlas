...
|---|---|---|---|
|Deployment|wordpress|wordpress|docker.io/bitnami/wordpress:6.7.2-debian-12-r6|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|wordpress-mariadb|mariadb|docker.io/bitnami/mariadb:11.4.5-debian-12-r4|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|wordpress-memcached|memcached|docker.io/bitnami/memcached:1.6.37-debian-12-r0|
