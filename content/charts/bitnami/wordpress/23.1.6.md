...
| ---------- | --------- | --------- | ----------------------------------------------- |
| Deployment | wordpress | wordpress | docker.io/bitnami/wordpress:6.6.1-debian-12-r12 |
...
| Kind        | Name              | Container | Image                                         |
| ----------- | ----------------- | --------- | --------------------------------------------- |
| StatefulSet | wordpress-mariadb | mariadb   | docker.io/bitnami/mariadb:11.4.3-debian-12-r0 |
...
| Kind       | Name                | Container | Image                                           |
| ---------- | ------------------- | --------- | ----------------------------------------------- |
| Deployment | wordpress-memcached | memcached | docker.io/bitnami/memcached:1.6.29-debian-12-r4 |
