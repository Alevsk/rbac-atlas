...
| ---------- | --------------------------- | ---------------------------- | -------------------------------------- |
| DaemonSet  | openebs-ndm                 | openebs-ndm                  | openebs/node-disk-manager:0.7.0        |
| Deployment | openebs-admission-server    | admission-webhook            | openebs/admission-server:1.12.0        |
| Deployment | openebs-apiserver           | openebs-apiserver            | openebs/m-apiserver:1.12.0             |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner  | openebs/provisioner-localpv:1.12.0     |
| Deployment | openebs-ndm-operator        | openebs-ndm-operator         | openebs/node-disk-operator:0.7.0       |
| Deployment | openebs-provisioner         | openebs-provisioner          | openebs/openebs-k8s-provisioner:1.12.0 |
| Deployment | openebs-snapshot-operator   | openebs-snapshot-controller  | openebs/snapshot-controller:1.12.0     |
| Deployment | openebs-snapshot-operator   | openebs-snapshot-provisioner | openebs/snapshot-provisioner:1.12.0    |
