...
version: v3.8.0
version_order: f0003f0008f0000
date: ""
service_accounts: 26
workloads: 30
bindings: 362
critical_findings: 90
high_findings: 73
medium_findings: 30
low_findings: 169
...
| [`openebs-lvm-controller-sa`](#sa-openebs-lvm-controller-sa)               | default   | ❌        | —       | 16          | 5         | {{< risk "Critical" >}} |
...
| [`openebs-prometheus-server`](#sa-openebs-prometheus-server)               | default   | ❌        | —       | 12          | 2         | {{< risk "Critical" >}} |
| [`openebs-promtail`](#sa-openebs-promtail)                                 | default   | ❌        | —       | 5           | 1         | {{< risk "Critical" >}} |
...
| [`openebs-service-account`](#sa-openebs-service-account)                   | default   | ❌        | —       | 20          | 2         | {{< risk "Medium" >}}   |
...
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner | openebs/provisioner-localpv:3.4.0 |
...
| StatefulSet | openebs-cstor-csi-controller | cstor-csi-plugin    | openebs/cstor-csi-driver:3.5.0                         |
...
| StatefulSet | openebs-jiva-csi-controller | jiva-csi-plugin | openebs/jiva-csi:3.4.0                             |
...
| Kind       | Name                           | Container                       | Image                       |
| ---------- | ------------------------------ | ------------------------------- | --------------------------- |
| Deployment | openebs-cstor-admission-server | openebs-cstor-admission-webhook | openebs/cstor-webhook:3.5.0 |
| Deployment | openebs-cstor-cspc-operator    | openebs-cstor-cspc-operator     | openebs/cspc-operator:3.5.0 |
| Deployment | openebs-cstor-cvc-operator     | openebs-cstor-cvc-operator      | openebs/cvc-operator:3.5.0  |
...
| Kind       | Name                    | Container               | Image                          |
| ---------- | ----------------------- | ----------------------- | ------------------------------ |
| Deployment | openebs-nfs-provisioner | openebs-nfs-provisioner | openebs/provisioner-nfs:0.10.0 |
...
| Kind       | Name                  | Container             | Image                       |
| ---------- | --------------------- | --------------------- | --------------------------- |
| Deployment | openebs-jiva-operator | openebs-jiva-operator | openebs/jiva-operator:3.4.0 |
...
| StatefulSet | openebs-zfs-localpv-controller | openebs-zfs-plugin  | openebs/zfs-driver:2.3.0                               |
...
| StatefulSet | openebs-lvm-localpv-controller | openebs-lvm-plugin  | openebs/lvm-driver:1.2.0                               |
...
| Role                                    | Resource                           | Verbs              | Risk                  | Tags                                                                                                                                                                      |
| --------------------------------------- | ---------------------------------- | ------------------ | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `openebs-prometheus-server` | core/nodes/proxy                   | get · list · watch | {{< risk Critical >}} | {{< tag "AuthorizationBypass" >}} {{< tag "ClusterAdminAccess" >}} {{< tag "CodeExecution" >}} {{< tag "ElevationOfPrivilege" >}} {{< tag "LateralMovement" >}} (+1 more) |
...
| Role                           | Resource         | Verbs              | Risk                  | Tags                                                                                                                                                                      |
| ------------------------------ | ---------------- | ------------------ | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `openebs-promtail` | core/nodes/proxy | get · list · watch | {{< risk Critical >}} | {{< tag "AuthorizationBypass" >}} {{< tag "ClusterAdminAccess" >}} {{< tag "CodeExecution" >}} {{< tag "ElevationOfPrivilege" >}} {{< tag "LateralMovement" >}} (+1 more) |
...
| DaemonSet | openebs-cstor-csi-node | cstor-csi-plugin          | openebs/cstor-csi-driver:3.5.0                               |
...
| DaemonSet | openebs-jiva-csi-node | jiva-csi-plugin           | openebs/jiva-csi:3.4.0                                       |
...
| ClusterRole `openebs-cluster-role` | core/events                                           | create · list · patch · update · watch                 | {{< risk Medium >}} | {{< tag "InformationDisclosure" >}} {{< tag "OperationalData" >}} {{< tag "Reconnaissance" >}}                                   |
| ClusterRole `openebs-cluster-role` | core/configmaps                                       | create · get · patch · update                          | {{< risk Low >}}    |                                                                                                                                  |
| ClusterRole `openebs-cluster-role` | apiextensions.k8s.io/customresourcedefinitions        | create · get · list · update                           | {{< risk Low >}}    |                                                                                                                                  |
...
| ClusterRole `openebs-cluster-role` | core/nodes                                            | get · list · watch                                     | {{< risk Low >}}    |                                                                                                                                  |
...
| Kind       | Name                 | Container          | Image                                                |
| ---------- | -------------------- | ------------------ | ---------------------------------------------------- |
| Deployment | openebs-obs-callhome | obs-callhome       | docker.io/openebs/mayastor-obs-callhome:v2.3.0       |
| Deployment | openebs-obs-callhome | obs-callhome-stats | docker.io/openebs/mayastor-obs-callhome-stats:v2.3.0 |
