...
| ---------- | --------------------------- | --------------------------- | --------------------------------- |
| DaemonSet  | openebs-ndm                 | openebs-ndm                 | openebs/node-disk-manager:1.9.0   |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner | openebs/provisioner-localpv:3.2.0 |
| Deployment | openebs-ndm-operator        | openebs-ndm-operator        | openebs/node-disk-operator:1.9.0  |
...
| Kind       | Name                           | Container                       | Image                       |
| ---------- | ------------------------------ | ------------------------------- | --------------------------- |
| Deployment | openebs-cstor-admission-server | openebs-cstor-admission-webhook | openebs/cstor-webhook:3.3.0 |
| Deployment | openebs-cstor-cspc-operator    | openebs-cstor-cspc-operator     | openebs/cspc-operator:3.3.0 |
| Deployment | openebs-cstor-cvc-operator     | openebs-cstor-cvc-operator      | openebs/cvc-operator:3.3.0  |
...
| Kind       | Name                  | Container             | Image                       |
| ---------- | --------------------- | --------------------- | --------------------------- |
| Deployment | openebs-jiva-operator | openebs-jiva-operator | openebs/jiva-operator:3.3.0 |
...
| Kind       | Name                        | Container                   | Image                             |
| ---------- | --------------------------- | --------------------------- | --------------------------------- |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner | openebs/provisioner-localpv:3.3.0 |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner | openebs/provisioner-localpv:3.3.0 |
...
| Kind       | Name                 | Container            | Image                            |
| ---------- | -------------------- | -------------------- | -------------------------------- |
| DaemonSet  | openebs-ndm          | openebs-ndm          | openebs/node-disk-manager:2.0.0  |
| DaemonSet  | openebs-ndm          | openebs-ndm          | openebs/node-disk-manager:2.0.0  |
| DaemonSet  | openebs-ndm          | openebs-ndm          | openebs/node-disk-manager:2.0.0  |
| DaemonSet  | openebs-ndm          | openebs-ndm          | openebs/node-disk-manager:2.0.0  |
| Deployment | openebs-ndm-operator | openebs-ndm-operator | openebs/node-disk-operator:2.0.0 |
| Deployment | openebs-ndm-operator | openebs-ndm-operator | openebs/node-disk-operator:2.0.0 |
| Deployment | openebs-ndm-operator | openebs-ndm-operator | openebs/node-disk-operator:2.0.0 |
| Deployment | openebs-ndm-operator | openebs-ndm-operator | openebs/node-disk-operator:2.0.0 |
