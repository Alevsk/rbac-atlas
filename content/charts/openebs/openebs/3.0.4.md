...
| ---------- | --------------------------- | --------------------------- | --------------------------------- |
| DaemonSet  | openebs-ndm                 | openebs-ndm                 | openebs/node-disk-manager:1.7.0   |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner | openebs/provisioner-localpv:3.0.0 |
| Deployment | openebs-ndm-operator        | openebs-ndm-operator        | openebs/node-disk-operator:1.7.0  |
...
| Kind       | Name                           | Container                       | Image                       |
| ---------- | ------------------------------ | ------------------------------- | --------------------------- |
| Deployment | openebs-cstor-admission-server | openebs-cstor-admission-webhook | openebs/cstor-webhook:3.0.0 |
| Deployment | openebs-cstor-cspc-operator    | openebs-cstor-cspc-operator     | openebs/cspc-operator:3.0.0 |
| Deployment | openebs-cstor-cvc-operator     | openebs-cstor-cvc-operator      | openebs/cvc-operator:3.0.0  |
...
| Kind       | Name                    | Container               | Image                         |
| ---------- | ----------------------- | ----------------------- | ----------------------------- |
| Deployment | openebs-nfs-provisioner | openebs-nfs-provisioner | openebs/provisioner-nfs:0.8.0 |
...
| Kind       | Name                  | Container             | Image                       |
| ---------- | --------------------- | --------------------- | --------------------------- |
| Deployment | openebs-jiva-operator | openebs-jiva-operator | openebs/jiva-operator:3.0.0 |
