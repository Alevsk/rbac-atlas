...
| ---------- | --------------------------- | ---------------------------- | -------------------------------------- |
| DaemonSet  | openebs-ndm                 | openebs-ndm                  | openebs/node-disk-manager:1.6.1        |
| Deployment | openebs-admission-server    | admission-webhook            | openebs/admission-server:2.12.2        |
| Deployment | openebs-apiserver           | openebs-apiserver            | openebs/m-apiserver:2.12.2             |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner  | openebs/provisioner-localpv:2.12.2     |
| Deployment | openebs-ndm-operator        | openebs-ndm-operator         | openebs/node-disk-operator:1.6.1       |
| Deployment | openebs-provisioner         | openebs-provisioner          | openebs/openebs-k8s-provisioner:2.12.2 |
| Deployment | openebs-snapshot-operator   | openebs-snapshot-controller  | openebs/snapshot-controller:2.12.2     |
| Deployment | openebs-snapshot-operator   | openebs-snapshot-provisioner | openebs/snapshot-provisioner:2.12.2    |
...
| Kind       | Name                           | Container                       | Image                        |
| ---------- | ------------------------------ | ------------------------------- | ---------------------------- |
| Deployment | openebs-cstor-admission-server | openebs-cstor-admission-webhook | openebs/cstor-webhook:2.12.0 |
| Deployment | openebs-cstor-cspc-operator    | openebs-cstor-cspc-operator     | openebs/cspc-operator:2.12.0 |
| Deployment | openebs-cstor-cvc-operator     | openebs-cstor-cvc-operator      | openebs/cvc-operator:2.12.0  |
...
| Kind       | Name                    | Container               | Image                         |
| ---------- | ----------------------- | ----------------------- | ----------------------------- |
| Deployment | openebs-nfs-provisioner | openebs-nfs-provisioner | openebs/provisioner-nfs:0.7.1 |
...
| Kind       | Name                  | Container             | Image                        |
| ---------- | --------------------- | --------------------- | ---------------------------- |
| Deployment | openebs-jiva-operator | openebs-jiva-operator | openebs/jiva-operator:2.12.2 |
...
| Kind       | Name                        | Container                   | Image                              |
| ---------- | --------------------------- | --------------------------- | ---------------------------------- |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner | openebs/provisioner-localpv:2.12.1 |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner | openebs/provisioner-localpv:2.12.0 |
