...
| [`openebs-localpv-provisioner`](#sa-openebs-localpv-provisioner)           | default   | ❌        | —       | 12          | 3         | {{< risk "Critical" >}} |
...
| StatefulSet | openebs-lvm-localpv-controller | openebs-lvm-plugin  | openebs/lvm-driver:1.3.0                               |
...
| Kind       | Name                 | Container          | Image                                                |
| ---------- | -------------------- | ------------------ | ---------------------------------------------------- |
| Deployment | openebs-obs-callhome | obs-callhome       | docker.io/openebs/mayastor-obs-callhome:v2.4.0       |
| Deployment | openebs-obs-callhome | obs-callhome-stats | docker.io/openebs/mayastor-obs-callhome-stats:v2.4.0 |
