...
| [`openebs-service-account`](#sa-openebs-service-account)                   | default   | ❌        | —       | 15          | 0         | {{< risk "Medium" >}}   |
...
| Kind       | Name                           | Container                       | Image                       |
| ---------- | ------------------------------ | ------------------------------- | --------------------------- |
| Deployment | openebs-cstor-admission-server | openebs-cstor-admission-webhook | openebs/cstor-webhook:3.4.0 |
| Deployment | openebs-cstor-cspc-operator    | openebs-cstor-cspc-operator     | openebs/cspc-operator:3.4.0 |
| Deployment | openebs-cstor-cvc-operator     | openebs-cstor-cvc-operator      | openebs/cvc-operator:3.4.0  |
...
| ClusterRole `openebs-cluster-role` | snapshot.storage.k8s.io/volumesnapshotcontents | get · list                                             | {{< risk Low >}}    |                                                                                                                                  |
| ClusterRole `openebs-cluster-role` | snapshot.storage.k8s.io/volumesnapshots        | get · list                                             | {{< risk Low >}}    |                                                                                                                                  |
