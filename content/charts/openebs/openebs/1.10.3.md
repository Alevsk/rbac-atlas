...
| ---------- | --------------------------- | ---------------------------- | ---------------------------------------------- |
| DaemonSet  | openebs-ndm                 | openebs-ndm                  | quay.io/openebs/node-disk-manager-amd64:0.5.0  |
| Deployment | openebs-admission-server    | admission-webhook            | quay.io/openebs/admission-server:1.10.0        |
| Deployment | openebs-apiserver           | openebs-apiserver            | quay.io/openebs/m-apiserver:1.10.0             |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner  | quay.io/openebs/provisioner-localpv:1.10.0     |
| Deployment | openebs-ndm-operator        | openebs-ndm-operator         | quay.io/openebs/node-disk-operator-amd64:0.5.0 |
| Deployment | openebs-provisioner         | openebs-provisioner          | quay.io/openebs/openebs-k8s-provisioner:1.10.0 |
| Deployment | openebs-snapshot-operator   | openebs-snapshot-controller  | quay.io/openebs/snapshot-controller:1.10.0     |
| Deployment | openebs-snapshot-operator   | openebs-snapshot-provisioner | quay.io/openebs/snapshot-provisioner:1.10.0    |
