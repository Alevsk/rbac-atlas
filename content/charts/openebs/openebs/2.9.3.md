...
| ------------------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`openebs`](#sa-openebs)                                                 | default   | ❌        | —       | 36          | 9         | {{< risk "Critical" >}} |
...
| [`openebs-jiva-operator`](#sa-openebs-jiva-operator)                     | default   | ❌        | —       | 16          | 1         | {{< risk "Critical" >}} |
...
| ---------- | --------------------------- | ---------------------------- | ------------------------------------- |
| DaemonSet  | openebs-ndm                 | openebs-ndm                  | openebs/node-disk-manager:1.4.1       |
| Deployment | openebs-admission-server    | admission-webhook            | openebs/admission-server:2.9.0        |
| Deployment | openebs-apiserver           | openebs-apiserver            | openebs/m-apiserver:2.9.0             |
| Deployment | openebs-localpv-provisioner | openebs-localpv-provisioner  | openebs/provisioner-localpv:2.9.0     |
| Deployment | openebs-ndm-operator        | openebs-ndm-operator         | openebs/node-disk-operator:1.4.1      |
| Deployment | openebs-provisioner         | openebs-provisioner          | openebs/openebs-k8s-provisioner:2.9.0 |
| Deployment | openebs-snapshot-operator   | openebs-snapshot-controller  | openebs/snapshot-controller:2.9.0     |
| Deployment | openebs-snapshot-operator   | openebs-snapshot-provisioner | openebs/snapshot-provisioner:2.9.0    |
| Job        | openebs-webhook-cleanup     | kubectl                      | bitnami/kubectl:1.20                  |
...
| Kind       | Name                           | Container                       | Image                       |
| ---------- | ------------------------------ | ------------------------------- | --------------------------- |
| Deployment | openebs-cstor-admission-server | openebs-cstor-admission-webhook | openebs/cstor-webhook:2.9.0 |
| Deployment | openebs-cstor-cspc-operator    | openebs-cstor-cspc-operator     | openebs/cspc-operator:2.9.0 |
| Deployment | openebs-cstor-cvc-operator     | openebs-cstor-cvc-operator      | openebs/cvc-operator:2.9.0  |
...
| Role                 | Resource                                                       | Verbs        | Risk                  | Tags                                                                                                                                                                        |
| -------------------- | -------------------------------------------------------------- | ------------ | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Role `jiva-operator` | apps/daemonsets                                                | \*           | {{< risk Critical >}} | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "NodeAccess" >}} {{< tag "Persistence" >}} {{< tag "PrivilegeEscalation" >}} (+3 more)               |
| Role `jiva-operator` | core/secrets                                                   | \*           | {{< risk Critical >}} | {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} (+5 more)      |
| Role `jiva-operator` | core/configmaps                                                | \*           | {{< risk High >}}     | {{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} (+3 more)       |
| Role `jiva-operator` | apps/deployments                                               | \*           | {{< risk High >}}     | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "Persistence" >}} {{< tag "PotentialPrivilegeEscalation" >}} {{< tag "Tampering" >}} (+2 more)       |
| Role `jiva-operator` | core/endpoints                                                 | \*           | {{< risk High >}}     | {{< tag "DenialOfService" >}} {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "NetworkManipulation" >}} {{< tag "Tampering" >}} (+2 more)            |
| Role `jiva-operator` | core/pods                                                      | \* · get     | {{< risk High >}}     | {{< tag "LateralMovement" >}} {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "Persistence" >}} {{< tag "PotentialPrivilegeEscalation" >}} (+3 more) |
| Role `jiva-operator` | core/services                                                  | \*           | {{< risk High >}}     | {{< tag "DenialOfService" >}} {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "NetworkManipulation" >}} {{< tag "ServiceExposure" >}} (+2 more)      |
| Role `jiva-operator` | apps/statefulsets                                              | \*           | {{< risk High >}}     | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "Persistence" >}} {{< tag "PotentialPrivilegeEscalation" >}} {{< tag "Tampering" >}} (+2 more)       |
| Role `jiva-operator` | openebs.io/\*                                                  | \*           | {{< risk Medium >}}   | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                             |
| Role `jiva-operator` | core/events                                                    | \*           | {{< risk Medium >}}   | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                             |
| Role `jiva-operator` | core/persistentvolumeclaims                                    | \*           | {{< risk Medium >}}   | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                             |
| Role `jiva-operator` | policy/poddisruptionbudgets                                    | \*           | {{< risk Medium >}}   | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                             |
| Role `jiva-operator` | apps/replicasets                                               | \* · get     | {{< risk Medium >}}   | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                             |
| Role `jiva-operator` | core/services/finalizers                                       | \*           | {{< risk Medium >}}   | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                             |
| Role `jiva-operator` | monitoring.coreos.com/servicemonitors                          | create · get | {{< risk Low >}}      |                                                                                                                                                                             |
| Role `jiva-operator` | apps/deployments/finalizers **(restricted to: jiva-operator)** | update       | {{< risk Low >}}      | {{< tag "ResourceNameRestricted" >}}                                                                                                                                        |
...
| Kind       | Name                  | Container             | Image                       |
| ---------- | --------------------- | --------------------- | --------------------------- |
| Deployment | openebs-jiva-operator | openebs-jiva-operator | openebs/jiva-operator:2.9.0 |
