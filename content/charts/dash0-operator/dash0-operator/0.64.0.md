...
medium_findings: 4
low_findings: 28
categories: [OpenTelemetry, Observability, Monitoring, Dash0, Node.js, Java, JVM]
tags:
  [
    AuthorizationBypass,
...
| ------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`dash0-operator-controller`](#sa-dash0-operator-controller) | default   | ❌        | —       | 45          | 3         | {{< risk "Critical" >}} |
...
| Deployment | dash0-operator-controller | manager         | ghcr.io/dash0hq/operator-controller:0.64.0 |
| Job        | dash0-operator-pre-delete | pre-delete-job  | ghcr.io/dash0hq/operator-controller:0.64.0 |
