...
| ------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`dash0-operator-controller`](#sa-dash0-operator-controller) | default   | ❌        | —       | 42          | 3         | {{< risk "Critical" >}} |
...
| ClusterRole `dash0-operator-manager-role`  | core/endpoints                                            | get                                                                      | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| Deployment | dash0-operator-controller | manager         | ghcr.io/dash0hq/operator-controller:0.24.3 |
| Job        | dash0-operator-pre-delete | pre-delete-job  | ghcr.io/dash0hq/operator-controller:0.24.3 |
