...
| Kind       | Name                 | Container            | Image                                                       |
| ---------- | -------------------- | -------------------- | ----------------------------------------------------------- |
| Deployment | gitlab-gitlab-runner | gitlab-gitlab-runner | registry.gitlab.com/gitlab-org/gitlab-runner:alpine-v16.3.0 |
...
| Kind | Name            | Container     | Image                                                    |
| ---- | --------------- | ------------- | -------------------------------------------------------- |
| Job  | gitlab-issuer-1 | create-issuer | registry.gitlab.com/gitlab-org/build/cng/kubectl:v16.4.1 |
...
| Kind | Name                        | Container | Image                                                    |
| ---- | --------------------------- | --------- | -------------------------------------------------------- |
| Job  | gitlab-shared-secrets-1-yuu | gitlab    | registry.gitlab.com/gitlab-org/build/cng/kubectl:v16.4.1 |
