...
| ---------------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`gitlab-cert-manager`](#sa-gitlab-cert-manager)                       | default   | ❌        | —       | 47          | 1         | {{< risk "Critical" >}} |
| [`gitlab-cert-manager-cainjector`](#sa-gitlab-cert-manager-cainjector) | default   | ❌        | —       | 11          | 1         | {{< risk "Critical" >}} |
...
| [`gitlab-cert-manager-webhook`](#sa-gitlab-cert-manager-webhook)       | default   | ❌        | —       | 2           | 1         | {{< risk "Low" >}}      |
...
| ---------- | ------------------- | ------------ | ----------------------------------------------- |
| Deployment | gitlab-cert-manager | cert-manager | quay.io/jetstack/cert-manager-controller:v1.2.0 |
...
| Kind       | Name                           | Container    | Image                                           |
| ---------- | ------------------------------ | ------------ | ----------------------------------------------- |
| Deployment | gitlab-cert-manager-cainjector | cert-manager | quay.io/jetstack/cert-manager-cainjector:v1.2.0 |
...
| Kind       | Name                 | Container            | Image                               |
| ---------- | -------------------- | -------------------- | ----------------------------------- |
| Deployment | gitlab-gitlab-runner | gitlab-gitlab-runner | gitlab/gitlab-runner:alpine-v14.2.0 |
...
| Kind       | Name                        | Container    | Image                                        |
| ---------- | --------------------------- | ------------ | -------------------------------------------- |
| Deployment | gitlab-cert-manager-webhook | cert-manager | quay.io/jetstack/cert-manager-webhook:v1.2.0 |
...
| Kind | Name                        | Container | Image                                                    |
| ---- | --------------------------- | --------- | -------------------------------------------------------- |
| Job  | gitlab-shared-secrets-1-3gq | gitlab    | registry.gitlab.com/gitlab-org/build/cng/kubectl:1.16.15 |
