...
| [`gitlab-gitlab-runner`](#sa-gitlab-gitlab-runner)                               | default   | ❌        | —       | 2           | 1         | {{< risk "Critical" >}} |
...
| Role `gitlab-gitlab-runner` | core/services | create · get · list | {{< risk Low >}}      |                                                                                                                                                              |
...
| Kind | Name                        | Container | Image                                                    |
| ---- | --------------------------- | --------- | -------------------------------------------------------- |
| Job  | gitlab-shared-secrets-1-3t9 | gitlab    | registry.gitlab.com/gitlab-org/build/cng/kubectl:1.16.15 |
