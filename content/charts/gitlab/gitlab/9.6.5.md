...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|gitlab-prometheus-server|prometheus-server|quay.io/prometheus/prometheus:v3.6.0|
|Deployment|gitlab-prometheus-server|prometheus-server-configmap-reload|quay.io/prometheus-operator/prometheus-config-reloader:v0.85.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|gitlab-issuer-1867259|create-issuer|registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.6.5|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|gitlab-shared-secrets-964e514|gitlab|registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.6.5|
