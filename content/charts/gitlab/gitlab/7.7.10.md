...
| ---------- | ------------------- | ----------------------- | ------------------------------------------------ |
| Deployment | gitlab-cert-manager | cert-manager-controller | quay.io/jetstack/cert-manager-controller:v1.12.6 |
...
| Kind       | Name                           | Container               | Image                                            |
| ---------- | ------------------------------ | ----------------------- | ------------------------------------------------ |
| Deployment | gitlab-cert-manager-cainjector | cert-manager-cainjector | quay.io/jetstack/cert-manager-cainjector:v1.12.6 |
...
| Kind       | Name                 | Container            | Image                                                       |
| ---------- | -------------------- | -------------------- | ----------------------------------------------------------- |
| Deployment | gitlab-gitlab-runner | gitlab-gitlab-runner | registry.gitlab.com/gitlab-org/gitlab-runner:alpine-v16.6.1 |
...
| Kind       | Name                        | Container            | Image                                         |
| ---------- | --------------------------- | -------------------- | --------------------------------------------- |
| Deployment | gitlab-cert-manager-webhook | cert-manager-webhook | quay.io/jetstack/cert-manager-webhook:v1.12.6 |
...
| Kind | Name                                | Container                    | Image                                     |
| ---- | ----------------------------------- | ---------------------------- | ----------------------------------------- |
| Job  | gitlab-cert-manager-startupapicheck | cert-manager-startupapicheck | quay.io/jetstack/cert-manager-ctl:v1.12.6 |
...
| Kind | Name            | Container     | Image                                                     |
| ---- | --------------- | ------------- | --------------------------------------------------------- |
| Job  | gitlab-issuer-1 | create-issuer | registry.gitlab.com/gitlab-org/build/cng/kubectl:v16.7.10 |
...
| Kind | Name                        | Container | Image                                                     |
| ---- | --------------------------- | --------- | --------------------------------------------------------- |
| Job  | gitlab-shared-secrets-1-zbq | gitlab    | registry.gitlab.com/gitlab-org/build/cng/kubectl:v16.7.10 |
...
| StatefulSet | gitlab-gitlab-zoekt | zoekt-indexer             | registry.gitlab.com/gitlab-org/build/cng/gitlab-zoekt-indexer:v0.2.0-25cbe             |
| StatefulSet | gitlab-gitlab-zoekt | zoekt-internal-gateway    | nginx:latest                                                                           |
