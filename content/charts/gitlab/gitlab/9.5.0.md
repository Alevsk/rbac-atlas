...
| Kind       | Name                 | Container            | Image                                                       |
| ---------- | -------------------- | -------------------- | ----------------------------------------------------------- |
| Deployment | gitlab-gitlab-runner | gitlab-gitlab-runner | registry.gitlab.com/gitlab-org/gitlab-runner:alpine-v18.4.0 |
...
| Kind       | Name           | Container      | Image                             |
| ---------- | -------------- | -------------- | --------------------------------- |
| Deployment | gitlab-openbao | openbao-server | quay.io/openbao/openbao-ubi:2.4.1 |
...
| Kind | Name                  | Container     | Image                                                    |
| ---- | --------------------- | ------------- | -------------------------------------------------------- |
| Job  | gitlab-issuer-ad68197 | create-issuer | registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.5.0 |
...
| Kind | Name                          | Container | Image                                                    |
| ---- | ----------------------------- | --------- | -------------------------------------------------------- |
| Job  | gitlab-shared-secrets-5a6c368 | gitlab    | registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.5.0 |
