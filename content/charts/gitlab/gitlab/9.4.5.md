...
| [`gitlab-openbao`](#sa-gitlab-openbao)                                           | default   | ✅        | —       | 1           | 2         | {{< risk "High" >}}     |
...
| Kind       | Name                 | Container            | Image                                                       |
| ---------- | -------------------- | -------------------- | ----------------------------------------------------------- |
| Deployment | gitlab-gitlab-runner | gitlab-gitlab-runner | registry.gitlab.com/gitlab-org/gitlab-runner:alpine-v18.3.1 |
...
| Role                  | Resource  | Verbs                               | Risk              | Tags                                                                                               |
| --------------------- | --------- | ----------------------------------- | ----------------- | -------------------------------------------------------------------------------------------------- |
| Role `gitlab-openbao` | core/pods | get · list · patch · update · watch | {{< risk High >}} | {{< tag "PotentialPrivilegeEscalation" >}} {{< tag "Tampering" >}} {{< tag "WorkloadExecution" >}} |
...
| Kind       | Name           | Container        | Image                             |
| ---------- | -------------- | ---------------- | --------------------------------- |
| Deployment | gitlab-openbao | openbao-server   | quay.io/openbao/openbao-ubi:2.3.2 |
| Deployment | gitlab-openbao | openbao-unsealer | quay.io/openbao/openbao-ubi:2.3.2 |
...
| Kind | Name                  | Container     | Image                                                    |
| ---- | --------------------- | ------------- | -------------------------------------------------------- |
| Job  | gitlab-issuer-ef1adaa | create-issuer | registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.4.5 |
...
| Kind | Name                          | Container | Image                                                    |
| ---- | ----------------------------- | --------- | -------------------------------------------------------- |
| Job  | gitlab-shared-secrets-46f7b4b | gitlab    | registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.4.5 |
...
| Kind        | Name                | Container              | Image                                                        |
| ----------- | ------------------- | ---------------------- | ------------------------------------------------------------ |
| StatefulSet | gitlab-gitlab-zoekt | zoekt-indexer          | registry.gitlab.com/gitlab-org/build/cng/gitlab-zoekt:v1.4.4 |
| StatefulSet | gitlab-gitlab-zoekt | zoekt-internal-gateway | nginx:1.25.5                                                 |
| StatefulSet | gitlab-gitlab-zoekt | zoekt-webserver        | registry.gitlab.com/gitlab-org/build/cng/gitlab-zoekt:v1.4.4 |
