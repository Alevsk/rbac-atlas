...
| Kind | Name                  | Container     | Image                                                    |
| ---- | --------------------- | ------------- | -------------------------------------------------------- |
| Job  | gitlab-issuer-ce8f1d1 | create-issuer | registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.3.5 |
...
| Kind | Name                          | Container | Image                                                    |
| ---- | ----------------------------- | --------- | -------------------------------------------------------- |
| Job  | gitlab-shared-secrets-504e97e | gitlab    | registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.3.5 |
...
| Kind        | Name                | Container              | Image                                                        |
| ----------- | ------------------- | ---------------------- | ------------------------------------------------------------ |
| StatefulSet | gitlab-gitlab-zoekt | zoekt-indexer          | registry.gitlab.com/gitlab-org/build/cng/gitlab-zoekt:v1.0.0 |
| StatefulSet | gitlab-gitlab-zoekt | zoekt-internal-gateway | nginx:1.25.5                                                 |
| StatefulSet | gitlab-gitlab-zoekt | zoekt-webserver        | registry.gitlab.com/gitlab-org/build/cng/gitlab-zoekt:v1.0.0 |
