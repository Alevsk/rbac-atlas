...
| Role `gitlab-nginx-ingress`        | coordination.k8s.io/leases **(restricted to: gitlab-nginx-ingress-leader)** | get · update       | {{< risk Low >}}      | {{< tag "ResourceNameRestricted" >}}                                                                                                                           |
...
| Kind       | Name                 | Container            | Image                                                       |
| ---------- | -------------------- | -------------------- | ----------------------------------------------------------- |
| Deployment | gitlab-gitlab-runner | gitlab-gitlab-runner | registry.gitlab.com/gitlab-org/gitlab-runner:alpine-v18.1.1 |
...
| Kind | Name                  | Container     | Image                                                    |
| ---- | --------------------- | ------------- | -------------------------------------------------------- |
| Job  | gitlab-issuer-67378ef | create-issuer | registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.2.0 |
...
| Kind | Name                          | Container | Image                                                    |
| ---- | ----------------------------- | --------- | -------------------------------------------------------- |
| Job  | gitlab-shared-secrets-d3c2877 | gitlab    | registry.gitlab.com/gitlab-org/build/cng/kubectl:v18.2.0 |
