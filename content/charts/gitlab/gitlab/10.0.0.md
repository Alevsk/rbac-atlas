...
|[`gitlab-prometheus-server`](#sa-gitlab-prometheus-server)|default|❌|—|10|2|{{< risk "High" >}}|
...
|[`gitlab-shared-secrets`](#sa-gitlab-shared-secrets)|default|❌|—|1|2|{{< risk "Low" >}}|
|[`gitlab-ai-gateway`](#sa-gitlab-ai-gateway)|default|✅|—|0|1|—|
...
|Role `gitlab-gateway-helm-infra-manager`|core/configmaps|create · delete · deletecollection · get · list · patch · watch|{{< risk Medium >}}|{{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}|
...
|Role `gitlab-gateway-helm-infra-manager`|apps/daemonsets|create · delete · deletecollection · get · list · patch · watch|{{< risk Low >}}||
|ClusterRole `gitlab-gateway-helm-envoy-gateway-role`|apps/deployments|get · list · watch|{{< risk Low >}}||
|Role `gitlab-gateway-helm-infra-manager`|apps/deployments|create · delete · deletecollection · get · list · patch · watch|{{< risk Low >}}||
...
|Role `gitlab-gateway-helm-infra-manager`|autoscaling/horizontalpodautoscalers|create · delete · deletecollection · get · list · patch · watch|{{< risk Low >}}||
|Role `gitlab-gateway-helm-infra-manager`|policy/horizontalpodautoscalers|create · delete · deletecollection · get · list · patch · watch|{{< risk Low >}}||
...
|ClusterRole `gitlab-gateway-helm-envoy-gateway-role`|gateway.networking.k8s.io/listenersets|get · list · watch|{{< risk Low >}}||
|ClusterRole `gitlab-gateway-helm-envoy-gateway-role`|gateway.networking.k8s.io/listenersets/status|update|{{< risk Low >}}||
...
|Role `gitlab-gateway-helm-infra-manager`|autoscaling/poddisruptionbudgets|create · delete · deletecollection · get · list · patch · watch|{{< risk Low >}}||
|Role `gitlab-gateway-helm-infra-manager`|policy/poddisruptionbudgets|create · delete · deletecollection · get · list · patch · watch|{{< risk Low >}}||
...
|Role `gitlab-gateway-helm-infra-manager`|core/serviceaccounts|create · delete · deletecollection · get · list · patch · watch|{{< risk Low >}}||
...
|Role `gitlab-gateway-helm-infra-manager`|core/services|create · delete · deletecollection · get · list · patch · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|envoy-gateway|envoy-gateway|docker.io/envoyproxy/gateway:v1.8.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|gitlab-kube-state-metrics|kube-state-metrics|registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.18.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|gitlab-gitlab-runner|gitlab-gitlab-runner|registry.gitlab.com/gitlab-org/gitlab-runner:alpine-v18.11.3|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|gitlab-prometheus-server|prometheus-server|quay.io/prometheus/prometheus:v3.11.2|
|Deployment|gitlab-prometheus-server|prometheus-server-configmap-reload|quay.io/prometheus-operator/prometheus-config-reloader:v0.90.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|gitlab-openbao|openbao-server|registry.gitlab.com/gitlab-org/build/cng/gitlab-openbao:v2.5.2-gitlab1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|gitlab-gateway-helm-certgen|envoy-gateway-certgen|docker.io/envoyproxy/gateway:v1.8.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|gitlab-issuer-1fca4c3|create-issuer|registry.gitlab.com/gitlab-org/build/cng/kubectl:v19.0.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|gitlab-shared-secrets-c3710d1|gitlab|registry.gitlab.com/gitlab-org/build/cng/kubectl:v19.0.0|
|Job|gitlab-shared-secrets-c3710d1-selfsign|kubectl|registry.gitlab.com/gitlab-org/build/cng/kubectl:v19.0.0|

---

### 🤖 `gitlab-ai-gateway` {#sa-gitlab-ai-gateway}
 **Namespace:** `default`  |  **Automount:** ✅
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|gitlab-ai-gateway|ai-gateway|registry.gitlab.com/gitlab-org/modelops/applied-ml/code-suggestions/ai-assist/model-gateway:self-hosted-v18.10.0-ee|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|gitlab-alertmanager|alertmanager|quay.io/prometheus/alertmanager:v0.32.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|DaemonSet|gitlab-prometheus-node-exporter|node-exporter|quay.io/prometheus/node-exporter:v1.11.1|
