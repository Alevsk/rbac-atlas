...
| [`gitlab-nginx-ingress`](#sa-gitlab-nginx-ingress)                                                 | default   | ❌        | —       | 24          | 0         | {{< risk "Critical" >}} |
...
| Deployment | gitlab-controller-manager | manager         | registry.gitlab.com/gitlab-org/cloud-native/gitlab-operator:1.4.1 |
