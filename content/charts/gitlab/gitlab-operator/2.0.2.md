...
| -------------------------------------------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`gitlab-manager`](#sa-gitlab-manager)                                                             | default   | ❌        | —       | 30          | 1         | {{< risk "Critical" >}} |
| [`gitlab-nginx-ingress`](#sa-gitlab-nginx-ingress)                                                 | default   | ❌        | —       | 23          | 0         | {{< risk "Critical" >}} |
| [`gitlab-operator-cert-manager`](#sa-gitlab-operator-cert-manager)                                 | default   | ✅        | —       | 57          | 1         | {{< risk "Critical" >}} |
| [`gitlab-operator-cert-manager-cainjector`](#sa-gitlab-operator-cert-manager-cainjector)           | default   | ✅        | —       | 10          | 1         | {{< risk "Critical" >}} |
| [`gitlab-operator-cert-manager-webhook`](#sa-gitlab-operator-cert-manager-webhook)                 | default   | ✅        | —       | 2           | 1         | {{< risk "Critical" >}} |
...
| Role `gitlab-operator-cert-manager:leaderelection`                               | core/configmaps                                       | create · get · patch · update                 | {{< risk Low >}}      |                                                                                                                                                                      |
...
| Role `gitlab-operator-cert-manager:leaderelection`                               | coordination.k8s.io/leases                            | create · get · patch · update                 | {{< risk Low >}}      |                                                                                                                                                                      |
...
| ClusterRole `gitlab-operator-cert-manager-controller-approve:cert-manager-io`    | cert-manager.io/signers                               | approve                                       | {{< risk Low >}}      |                                                                                                                                                                      |
| ClusterRole `gitlab-operator-cert-manager-controller-certificatesigningrequests` | certificates.k8s.io/signers                           | sign                                          | {{< risk Low >}}      |                                                                                                                                                                      |
...
| Kind       | Name                      | Container | Image                                                             |
| ---------- | ------------------------- | --------- | ----------------------------------------------------------------- |
| Deployment | gitlab-controller-manager | manager   | registry.gitlab.com/gitlab-org/cloud-native/gitlab-operator:2.0.2 |
...
| Role `gitlab-operator-cert-manager-cainjector:leaderelection` | core/configmaps                                              | create · get · patch · update | {{< risk Low >}}      |                                                                                                                                                                |
...
| Role `gitlab-operator-cert-manager-cainjector:leaderelection` | coordination.k8s.io/leases                                   | create · get · patch · update | {{< risk Low >}}      |                                                                                                                                                                |
...
| Role                                                                    | Resource                                  | Verbs                                | Risk                  | Tags                                                                                                                     |
| ----------------------------------------------------------------------- | ----------------------------------------- | ------------------------------------ | --------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Role `gitlab-operator-cert-manager-webhook:dynamic-serving`             | core/secrets                              | create · get · list · update · watch | {{< risk Critical >}} | {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}} |
...
| Role                                  | Resource                                         | Verbs | Risk             | Tags |
| ------------------------------------- | ------------------------------------------------ | ----- | ---------------- | ---- |
| ClusterRole `gitlab-app-role-nonroot` | security.openshift.io/securitycontextconstraints | use   | {{< risk Low >}} |      |
