...
| ---------- | ----------------------- | ---------- | --------------------------------------------- |
| Deployment | crossplane-rbac-manager | crossplane | xpkg.upbound.io/crossplane/crossplane:v1.17.2 |
...
| Kind       | Name       | Container  | Image                                         |
| ---------- | ---------- | ---------- | --------------------------------------------- |
| Deployment | crossplane | crossplane | xpkg.upbound.io/crossplane/crossplane:v1.17.2 |
