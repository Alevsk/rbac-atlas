...
| ---------- | ----------------------- | ---------- | --------------------------------------------- |
| Deployment | crossplane-rbac-manager | crossplane | xpkg.upbound.io/crossplane/crossplane:v1.14.7 |
...
| Kind       | Name       | Container  | Image                                         |
| ---------- | ---------- | ---------- | --------------------------------------------- |
| Deployment | crossplane | crossplane | xpkg.upbound.io/crossplane/crossplane:v1.14.7 |
