...
medium_findings: 1
low_findings: 11
categories: [cloud, infrastructure, services, application, database, cache, bucket, infra, app, ops, gcp, azure, aws, alibaba, cloudsql, rds, s3, azuredatabase, asparadb, gke, aks, eks]
tags: [BindingToPrivilegedRole, ClusterAdminAccess, ClusterStructure, ClusterWideAccess, ConfigMapAccess, ControlPlaneDisruption, CriticalNamespace, DataExposure, DenialOfService, InformationDisclosure, LeaderElectionAbuse, PotentialPrivilegeEscalation, PrivilegeEscalation, RBACManipulation, RBACQuery, Reconnaissance, Tampering, WildcardPermission, letter-C]
---
## Description
...
|---|---|---|---|
|Deployment|crossplane-rbac-manager|crossplane|xpkg.crossplane.io/crossplane/crossplane:v2.2.0-rc.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|crossplane|crossplane|xpkg.crossplane.io/crossplane/crossplane:v2.2.0-rc.1|
