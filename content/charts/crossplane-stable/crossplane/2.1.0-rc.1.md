...
| ---------- | ----------------------- | ---------- | ---------------------------------------------------- |
| Deployment | crossplane-rbac-manager | crossplane | xpkg.crossplane.io/crossplane/crossplane:v2.1.0-rc.1 |
...
| Kind       | Name       | Container  | Image                                                |
| ---------- | ---------- | ---------- | ---------------------------------------------------- |
| Deployment | crossplane | crossplane | xpkg.crossplane.io/crossplane/crossplane:v2.1.0-rc.1 |
