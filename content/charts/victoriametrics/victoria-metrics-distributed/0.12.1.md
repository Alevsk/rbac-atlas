...
| ---------- | ------------------------------------------------------ | --------- | -------------------------------- |
| Deployment | victoria-metrics-distributed-victoria-metrics-operator | operator  | victoriametrics/operator:v0.55.0 |
...
| Kind      | Name                                                  | Container     | Image                                   |
| --------- | ----------------------------------------------------- | ------------- | --------------------------------------- |
| DaemonSet | victoria-metrics-distributed-prometheus-node-exporter | node-exporter | quay.io/prometheus/node-exporter:v1.9.0 |
