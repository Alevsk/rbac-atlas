...
|---|---|---|---|---|---|---|
|[`victoria-metrics-distributed-grafana`](#sa-victoria-metrics-distributed-grafana)|default|❌|—|2|3|{{< risk "Critical" >}}|
...
|[`victoria-metrics-distributed-victoria-metrics-operator`](#sa-victoria-metrics-distributed-victoria-metrics-operator)|default|✅|—|117|1|{{< risk "Critical" >}}|
|[`victoria-metrics-distributed-victoria-metrics-operator-cleanup-hook`](#sa-victoria-metrics-distributed-victoria-metrics-operator-cleanup-hook)|default|❌|—|69|1|{{< risk "High" >}}|
...
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator`|gateway.networking.k8s.io/httproutes|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator`|gateway.networking.k8s.io/httproutes/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator`|core/pods/eviction|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator`|operator.victoriametrics.com/vmdistributed|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator`|operator.victoriametrics.com/vmdistributed/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator`|operator.victoriametrics.com/vmdistributed/status|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|---|---|---|---|
|Deployment|victoria-metrics-distributed-victoria-metrics-operator|operator|victoriametrics/operator:v0.68.3|
...
|ClusterRole `victoria-metrics-distributed-kube-state-metrics`|discovery.k8s.io/endpointslices|list · watch|{{< risk Low >}}||
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|victoria-metrics-distributed-kube-state-metrics|kube-state-metrics|registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.18.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|victoria-metrics-distributed-grafana|grafana|docker.io/grafana/grafana:12.4.1|
|Deployment|victoria-metrics-distributed-grafana|grafana-sc-dashboard|quay.io/kiwigrid/k8s-sidecar:2.5.0|
|Deployment|victoria-metrics-distributed-grafana|grafana-sc-datasources|quay.io/kiwigrid/k8s-sidecar:2.5.0|
...
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator-cleanup-hook`|operator.victoriametrics.com/vmagents/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator-cleanup-hook`|operator.victoriametrics.com/vmdistributed|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator-cleanup-hook`|operator.victoriametrics.com/vmdistributed/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator-cleanup-hook`|operator.victoriametrics.com/vmdistributed/status|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `victoria-metrics-distributed-victoria-metrics-operator-cleanup-hook`|operator.victoriametrics.com/vtclusters/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|DaemonSet|victoria-metrics-distributed-prometheus-node-exporter|node-exporter|quay.io/prometheus/node-exporter:v1.10.2|
