...
|---|---|---|---|---|---|---|
|[`victoria-metrics-operator`](#sa-victoria-metrics-operator)|default|✅|—|122|1|{{< risk "Critical" >}}|
...
|ClusterRole `victoria-metrics-operator`|networking.k8s.io/networkpolicies|*|{{< risk Critical >}}|{{< tag "ClusterWideAccess" >}} {{< tag "DenialOfService" >}} {{< tag "LateralMovement" >}} {{< tag "NetworkManipulation" >}} {{< tag "NetworkPolicyManagement" >}} (+2 more)|
...
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vldistributed|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vldistributed/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vldistributed/status|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vmanomalyconfigs|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vmanomalyconfigs/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vmanomalyconfigs/status|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vmdistributed|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vmdistributed/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-operator`|operator.victoriametrics.com/vmdistributed/status|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|---|---|---|---|
|Deployment|victoria-metrics-operator|operator|victoriametrics/operator:v0.74.0|
