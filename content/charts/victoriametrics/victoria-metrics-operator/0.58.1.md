...
| ------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`victoria-metrics-operator`](#sa-victoria-metrics-operator) | default   | ✅        | —       | 115         | 1         | {{< risk "Critical" >}} |
...
| ---------- | ------------------------- | --------- | -------------------------------- |
| Deployment | victoria-metrics-operator | operator  | victoriametrics/operator:v0.67.0 |
