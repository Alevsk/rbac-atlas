...
| ------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`victoria-metrics-operator`](#sa-victoria-metrics-operator) | default   | ❌        | —       | 98          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `victoria-metrics-operator` | operator.victoriametrics.com/vlogs/status                     | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                                        |
...
| ---------- | ------------------------- | ------------------------- | -------------------------------- |
| Deployment | victoria-metrics-operator | victoria-metrics-operator | victoriametrics/operator:v0.47.0 |
