...
|---|---|---|---|---|---|---|
|[`victoria-metrics-operator`](#sa-victoria-metrics-operator)|default|✅|—|120|1|{{< risk "Critical" >}}|
...
|ClusterRole `victoria-metrics-operator`|gateway.networking.k8s.io/httproutes|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `victoria-metrics-operator`|gateway.networking.k8s.io/httproutes/finalizers|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|---|---|---|---|
|Deployment|victoria-metrics-operator|operator|victoriametrics/operator:v0.69.0|
