...
| ---------- | ------------- | ------------- | --------------------------- |
| Deployment | solr-operator | solr-operator | apache/solr-operator:v0.3.0 |
...
| Kind       | Name                             | Container                        | Image                            |
| ---------- | -------------------------------- | -------------------------------- | -------------------------------- |
| Deployment | solr-operator-zookeeper-operator | solr-operator-zookeeper-operator | pravega/zookeeper-operator:0.2.9 |
