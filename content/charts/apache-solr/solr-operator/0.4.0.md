...
| -------------------------------------------------------------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`solr-operator`](#sa-solr-operator)                                                                                 | default   | ❌        | —       | 26          | 1         | {{< risk "Critical" >}} |
| [`zookeeper-operator`](#sa-zookeeper-operator)                                                                       | default   | ❌        | —       | 14          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `solr-operator-role` | networking.k8s.io/ingresses/status             | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ---------- | ------------- | ------------- | --------------------------- |
| Deployment | solr-operator | solr-operator | apache/solr-operator:v0.4.0 |
...
| Kind       | Name                             | Container                        | Image                             |
| ---------- | -------------------------------- | -------------------------------- | --------------------------------- |
| Deployment | solr-operator-zookeeper-operator | solr-operator-zookeeper-operator | pravega/zookeeper-operator:0.2.12 |
...
| Kind | Name                                        | Container      | Image                               |
| ---- | ------------------------------------------- | -------------- | ----------------------------------- |
| Job  | solr-operator-zookeeper-operator-pre-delete | pre-delete-job | lachlanevenson/k8s-kubectl:v1.16.10 |
...
| Kind | Name                                                  | Container                | Image                               |
| ---- | ----------------------------------------------------- | ------------------------ | ----------------------------------- |
| Job  | solr-operator-zookeeper-operator-post-install-upgrade | post-install-upgrade-job | lachlanevenson/k8s-kubectl:v1.16.10 |
