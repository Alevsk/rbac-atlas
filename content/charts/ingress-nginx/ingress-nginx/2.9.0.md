...
| ---------- | ------------------------ | ---------- | --------------------------------------------------------------------- |
| Deployment | ingress-nginx-controller | controller | quay.io/kubernetes-ingress-controller/nginx-ingress-controller:0.33.0 |
...
| Kind | Name                           | Container | Image                                         |
| ---- | ------------------------------ | --------- | --------------------------------------------- |
| Job  | ingress-nginx-admission-create | create    | docker.io/jettech/kube-webhook-certgen:v1.2.0 |
| Job  | ingress-nginx-admission-patch  | patch     | docker.io/jettech/kube-webhook-certgen:v1.2.0 |
