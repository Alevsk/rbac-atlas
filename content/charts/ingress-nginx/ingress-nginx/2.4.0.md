...
| Kind | Name                           | Container | Image                               |
| ---- | ------------------------------ | --------- | ----------------------------------- |
| Job  | ingress-nginx-admission-create | create    | jettech/kube-webhook-certgen:v1.2.0 |
| Job  | ingress-nginx-admission-patch  | patch     | jettech/kube-webhook-certgen:v1.2.0 |
