...
| ------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`flagger`](#sa-flagger) | default   | ❌        | —       | 1           | 1         | {{< risk "Critical" >}} |
...
| --------------------- | -------- | ----- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ClusterRole `flagger` | \*       | \*    | {{< risk Critical >}} | {{< tag "APIServerDoS" >}} {{< tag "APIServiceManipulation" >}} {{< tag "AuthorizationBypass" >}} {{< tag "AvailabilityImpact" >}} {{< tag "BackupAccess" >}} (+68 more) |
...
| ---------- | ------- | --------- | ---------------------------------- |
| Deployment | flagger | flagger   | quay.io/stefanprodan/flagger:0.4.0 |
