...
description: "A Helm chart for Raven Agents Operator"
version: v0.2.0
...
A Helm chart for Raven Agents Operator
...
| [`raven-operator-agent`](#sa-raven-operator-agent)                           | default   | ❌        | —       | 3           | 0         | {{< risk "Low" >}}      |
...
| Role `raven-operator-manager-role`         | ravenio.raven.io/ravenagents            | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                              |
| Role `raven-operator-manager-role`         | ravenio.raven.io/ravenagents/finalizers | update                                                | {{< risk Low >}}      |                                                                                                                                                                              |
| Role `raven-operator-manager-role`         | ravenio.raven.io/ravenagents/status     | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                              |
...
### 🤖 `raven-operator-agent` {#sa-raven-operator-agent}
