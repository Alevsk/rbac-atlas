...
| [`raven-operator-collector`](#sa-raven-operator-collector)                   | default   | ❌        | —       | 0           | 0         | —                       |
...
| ---------- | --------------------------------- | --------- | ---------------------------------------------------------- |
| Deployment | raven-operator-controller-manager | manager   | releases.cloud.raven.io/raven-public/raven-operator:v1.1.0 |
