...
| Role                                            | Resource                                                                                  | Verbs               | Risk             | Tags                                 |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------- | ---------------- | ------------------------------------ |
| ClusterRole `raven-operator-controller-upgrade` | apiextensions.k8s.io/customresourcedefinitions **(restricted to: ravensensors.raven.io)** | apply · get · patch | {{< risk Low >}} | {{< tag "ResourceNameRestricted" >}} |
