...
| ---------------------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`raven-operator-controller-manager`](#sa-raven-operator-controller-manager) | default   | ❌        | —       | 18          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `raven-operator-manager-role`  | apiextensions.k8s.io/customresourcedefinitions | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                              |
...
| Role                                            | Resource                                       | Verbs                         | Risk             | Tags |
| ----------------------------------------------- | ---------------------------------------------- | ----------------------------- | ---------------- | ---- |
| ClusterRole `raven-operator-controller-upgrade` | apiextensions.k8s.io/customresourcedefinitions | create · get · patch · update | {{< risk Low >}} |      |
