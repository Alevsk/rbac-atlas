...
| ---------- | ------------ | ------------ | ----------------------------------------------- |
| Deployment | cert-manager | cert-manager | quay.io/jetstack/cert-manager-controller:v1.0.0 |
...
| Kind       | Name                    | Container    | Image                                           |
| ---------- | ----------------------- | ------------ | ----------------------------------------------- |
| Deployment | cert-manager-cainjector | cert-manager | quay.io/jetstack/cert-manager-cainjector:v1.0.0 |
...
| Kind       | Name                 | Container    | Image                                        |
| ---------- | -------------------- | ------------ | -------------------------------------------- |
| Deployment | cert-manager-webhook | cert-manager | quay.io/jetstack/cert-manager-webhook:v1.0.0 |
