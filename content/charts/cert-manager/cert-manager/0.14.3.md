...
| ---------- | ------------ | ------------ | ------------------------------------------------ |
| Deployment | cert-manager | cert-manager | quay.io/jetstack/cert-manager-controller:v0.14.3 |
...
| Kind       | Name                    | Container    | Image                                            |
| ---------- | ----------------------- | ------------ | ------------------------------------------------ |
| Deployment | cert-manager-cainjector | cert-manager | quay.io/jetstack/cert-manager-cainjector:v0.14.3 |
...
| Kind       | Name                 | Container    | Image                                         |
| ---------- | -------------------- | ------------ | --------------------------------------------- |
| Deployment | cert-manager-webhook | cert-manager | quay.io/jetstack/cert-manager-webhook:v0.14.3 |
