...
|---|---|---|---|---|---|---|
|[`cert-manager`](#sa-cert-manager)|default|✅|—|55|1|{{< risk "Critical" >}}|
...
|ClusterRole `cert-manager-controller-ingress-shim`|gateway.networking.x-k8s.io/xlistenersets|get · list · watch|{{< risk Low >}}||
|ClusterRole `cert-manager-controller-ingress-shim`|gateway.networking.x-k8s.io/xlistenersets/finalizers|update|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|cert-manager|cert-manager-controller|quay.io/jetstack/cert-manager-controller:v1.20.0-alpha.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|cert-manager-cainjector|cert-manager-cainjector|quay.io/jetstack/cert-manager-cainjector:v1.20.0-alpha.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|cert-manager-webhook|cert-manager-webhook|quay.io/jetstack/cert-manager-webhook:v1.20.0-alpha.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|cert-manager-startupapicheck|cert-manager-startupapicheck|quay.io/jetstack/cert-manager-startupapicheck:v1.20.0-alpha.1|
