...
| [`minio-operator`](#sa-minio-operator) | default   | ❌        | —       | 17          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ---------------------- | -------------- | -------------------- |
| Deployment | minio-operator-console | minio-operator | minio/console:v0.6.3 |
...
| Kind       | Name           | Container      | Image                 |
| ---------- | -------------- | -------------- | --------------------- |
| Deployment | minio-operator | minio-operator | minio/operator:v4.0.4 |
