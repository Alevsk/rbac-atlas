...
| [`minio-operator`](#sa-minio-operator) | default   | ❌        | —       | 20          | 1         | {{< risk "Critical" >}} |
...
| ---------- | -------------- | -------------- | --------------------- |
| Deployment | minio-operator | minio-operator | minio/operator:v4.1.1 |
...
| Kind       | Name                   | Container      | Image                |
| ---------- | ---------------------- | -------------- | -------------------- |
| Deployment | minio-operator-console | minio-operator | minio/console:v0.7.4 |
