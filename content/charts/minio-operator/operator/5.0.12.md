...
| [`minio-operator`](#sa-minio-operator) | default   | ❌        | —       | 30          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ------- | --------- | ------------------------------ |
| Deployment | console | operator  | quay.io/minio/operator:v5.0.12 |
...
| Kind       | Name           | Container | Image                          |
| ---------- | -------------- | --------- | ------------------------------ |
| Deployment | minio-operator | operator  | quay.io/minio/operator:v5.0.12 |
