...
| ---------- | -------------- | --------- | ------------------------------ |
| Deployment | minio-operator | operator  | quay.io/minio/operator:v5.0.17 |
...
| Kind       | Name    | Container | Image                          |
| ---------- | ------- | --------- | ------------------------------ |
| Deployment | console | operator  | quay.io/minio/operator:v5.0.17 |
