...
| [`minio-operator`](#sa-minio-operator) | default   | ❌        | —       | 31          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `minio-operator-role` | core/persistentvolumeclaims                                                          | delete · get · list · update                                             | {{< risk Low >}}      |                                                                                                                                                                              |
...
| ---------- | -------------- | --------- | ------------------------------ |
| Deployment | minio-operator | operator  | quay.io/minio/operator:v5.0.15 |
...
| ClusterRole `console-sa-role` | core/secrets                                            | create · delete · deletecollection · get · list · patch · update · watch | {{< risk Critical >}} | {{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "Persistence" >}} (+4 more) |
...
| ClusterRole `console-sa-role` | min.io/\*                                               | get · list · watch                                                       | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                        |
...
| Kind       | Name    | Container | Image                          |
| ---------- | ------- | --------- | ------------------------------ |
| Deployment | console | operator  | quay.io/minio/operator:v5.0.15 |
