...
| ---------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`hazelcast-platform-operator`](#sa-hazelcast-platform-operator) | default   | ❌        | —       | 67          | 1         | {{< risk "Critical" >}} |
...
| ---------- | --------------------------- | --------- | -------------------------------------------- |
| Deployment | hazelcast-platform-operator | manager   | hazelcast/hazelcast-platform-operator:5.12.0 |
