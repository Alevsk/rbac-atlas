...
| ------------------------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`k8sgpt`](#sa-k8sgpt)                                                         | default   | ❌        | —       | 2           | 0         | {{< risk "Critical" >}} |
...
| ---------- | ---------------------------------- | --------------- | ------------------------------------------ |
| Deployment | k8sgpt-operator-controller-manager | kube-rbac-proxy | gcr.io/kubebuilder/kube-rbac-proxy:v0.16.0 |
| Deployment | k8sgpt-operator-controller-manager | manager         | ghcr.io/k8sgpt-ai/k8sgpt-operator:v0.2.4   |
...
| Role                                 | Resource                | Verbs                                | Risk                  | Tags                                                                                                                                                                   |
| ------------------------------------ | ----------------------- | ------------------------------------ | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `k8sgpt-operator-k8sgpt` | \*                      | create · delete · get · list · watch | {{< risk Critical >}} | {{< tag "AuthorizationBypass" >}} {{< tag "CSRCreation" >}} {{< tag "ClusterAdminAccess" >}} {{< tag "ClusterStructure" >}} {{< tag "ClusterWideAccess" >}} (+41 more) |
| ClusterRole `k8sgpt-operator-k8sgpt` | apiextensions.k8s.io/\* | \*                                   | {{< risk Critical >}} | {{< tag "CRDManipulation" >}} {{< tag "ClusterWideAccess" >}} {{< tag "PotentialPrivilegeEscalation" >}} {{< tag "Tampering" >}} {{< tag "WildcardPermission" >}}      |
...
| Kind        | Name                      | Container | Image                                  |
| ----------- | ------------------------- | --------- | -------------------------------------- |
| StatefulSet | k8sgpt-operator-interplex | interplex | ghcr.io/interplex-ai/interplex:v0.0.11 |
