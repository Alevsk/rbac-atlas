...
| ------------------------------------------- | ----------------------------------------- | ----------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `k8sgpt-operator-manager-role`  | \*                                        | create · delete · get · list · patch · update · watch | {{< risk Critical >}} | {{< tag "APIServerDoS" >}} {{< tag "APIServiceManipulation" >}} {{< tag "AvailabilityImpact" >}} {{< tag "BackupAccess" >}} {{< tag "BindingToPrivilegedRole" >}} (+63 more) |
...
| Deployment | k8sgpt-operator-controller-manager | manager         | ghcr.io/k8sgpt-ai/k8sgpt-operator:v0.2.23 |
