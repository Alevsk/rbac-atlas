...
| ------------------------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`k8sgpt-operator-controller-manager`](#sa-k8sgpt-operator-controller-manager) | default   | ❌        | —       | 10          | 2         | {{< risk "Critical" >}} |
...
| Deployment | k8sgpt-operator-controller-manager | manager         | ghcr.io/k8sgpt-ai/k8sgpt-operator:v0.0.13  |
