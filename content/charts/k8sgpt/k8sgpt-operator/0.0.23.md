...
| ---------- | ---------------------------------- | --------------- | ------------------------------------------ |
| Deployment | k8sgpt-operator-controller-manager | kube-rbac-proxy | gcr.io/kubebuilder/kube-rbac-proxy:v0.14.1 |
| Deployment | k8sgpt-operator-controller-manager | manager         | ghcr.io/k8sgpt-ai/k8sgpt-operator:v0.0.23  |
