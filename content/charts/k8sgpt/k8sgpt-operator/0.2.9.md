...
| ---------- | ---------------------------------- | --------------- | ---------------------------------------- |
| Deployment | k8sgpt-operator-controller-manager | kube-rbac-proxy | quay.io/brancz/kube-rbac-proxy:v0.18.2   |
| Deployment | k8sgpt-operator-controller-manager | manager         | ghcr.io/k8sgpt-ai/k8sgpt-operator:v0.2.9 |
