...
tags: [ClusterStructure, ClusterWideSecretAccess, ConfigMapAccess, CredentialAccess, DataExposure, InformationDisclosure, Reconnaissance, SecretAccess, letter-T]
---
## Description
...
|---|---|---|---|
|Deployment|traefik|traefik|docker.io/traefik:v3.7.0-ea.3|
