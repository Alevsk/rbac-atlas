...
| ------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`opentelemetry-operator`](#sa-opentelemetry-operator) | default   | ❌        | —       | 23          | 2         | {{< risk "Critical" >}} |
...
| ---------- | ---------------------- | --------------- | ---------------------------------------------------------------------------- |
| Deployment | opentelemetry-operator | kube-rbac-proxy | gcr.io/kubebuilder/kube-rbac-proxy:v0.14.0                                   |
| Deployment | opentelemetry-operator | manager         | ghcr.io/open-telemetry/opentelemetry-operator/opentelemetry-operator:v0.73.0 |
