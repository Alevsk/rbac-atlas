...
| ------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`opentelemetry-operator`](#sa-opentelemetry-operator) | default   | ❌        | —       | 41          | 2         | {{< risk "Critical" >}} |
...
| Deployment | opentelemetry-operator | manager         | ghcr.io/open-telemetry/opentelemetry-operator/opentelemetry-operator:0.118.0 |
