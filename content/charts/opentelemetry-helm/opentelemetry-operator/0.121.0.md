...
low_findings: 63
categories: []
tags: [AuthorizationBypass, AvailabilityImpact, ClusterAdminAccess, ClusterStructure, CodeExecution, ConfigMapAccess, CredentialAccess, DataExposure, DenialOfService, ElevationOfPrivilege, IdentityManagement, InformationDisclosure, LateralMovement, NetworkManipulation, NetworkPolicyManagement, NodeAccess, OperationalData, Persistence, PotentialPrivilegeEscalation, PrivilegeEscalation, QuotaTampering, RBACQuery, Reconnaissance, ResourceConfiguration, SecretAccess, ServiceExposure, Tampering, WorkloadExecution, WorkloadLifecycle, letter-O]
---
## Description
...
|ClusterRole `opentelemetry-operator-manager`|core/nodes/proxy|get|{{< risk Critical >}}|{{< tag "AuthorizationBypass" >}} {{< tag "ClusterAdminAccess" >}} {{< tag "CodeExecution" >}} {{< tag "ElevationOfPrivilege" >}} {{< tag "LateralMovement" >}} (+1 more)|
...
|ClusterRole `opentelemetry-operator-manager`|events.k8s.io/events|create · list · patch · watch|{{< risk Medium >}}|{{< tag "InformationDisclosure" >}} {{< tag "OperationalData" >}} {{< tag "Reconnaissance" >}}|
...
|ClusterRole `opentelemetry-operator-manager`|authentication.k8s.io/tokenreviews|create|{{< risk Medium >}}|{{< tag "CredentialAccess" >}} {{< tag "InformationDisclosure" >}} {{< tag "RBACQuery" >}}|
...
|ClusterRole `opentelemetry-operator-manager`|operators.coreos.com/clusterserviceversions|get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `opentelemetry-operator-manager`|discovery.k8s.io/endpointslices|get · list|{{< risk Low >}}||
...
|ClusterRole `opentelemetry-operator-manager`|gateway.networking.k8s.io/httproutes|create · delete · get · list · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `opentelemetry-operator-manager`|opentelemetry.io/instrumentations/status|get · patch · update|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|opentelemetry-operator|manager|ghcr.io/open-telemetry/opentelemetry-operator/opentelemetry-operator:0.157.0|
