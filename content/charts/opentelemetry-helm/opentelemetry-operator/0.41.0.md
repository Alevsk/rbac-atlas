...
| ------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`opentelemetry-operator`](#sa-opentelemetry-operator) | default   | ❌        | —       | 26          | 2         | {{< risk "Critical" >}} |
...
| Deployment | opentelemetry-operator | manager         | ghcr.io/open-telemetry/opentelemetry-operator/opentelemetry-operator:v0.87.0 |
