...
| ------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`opentelemetry-operator`](#sa-opentelemetry-operator) | default   | ❌        | —       | 29          | 2         | {{< risk "Critical" >}} |
...
| ClusterRole `opentelemetry-operator-manager`  | discovery.k8s.io/endpointslices                     | get · list · watch                                    | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `opentelemetry-operator-manager`  | opentelemetry.io/opampbridges                       | get · list · patch · update · watch                   | {{< risk Low >}}      |                                                                                                                                                                 |
| ClusterRole `opentelemetry-operator-manager`  | opentelemetry.io/opampbridges/finalizers            | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ---------- | ---------------------- | --------------- | ---------------------------------------------------------------------------- |
| Deployment | opentelemetry-operator | kube-rbac-proxy | quay.io/brancz/kube-rbac-proxy:v0.14.2                                       |
| Deployment | opentelemetry-operator | manager         | ghcr.io/open-telemetry/opentelemetry-operator/opentelemetry-operator:v0.88.0 |
