...
|---|---|---|---|
|StatefulSet|airflow-triggerer|triggerer|apache/airflow:3.2.2|
|StatefulSet|airflow-triggerer|triggerer-log-groomer|apache/airflow:3.2.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|airflow-worker|worker|apache/airflow:3.2.2|
|StatefulSet|airflow-worker|worker-log-groomer|apache/airflow:3.2.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|airflow-api-server|api-server|apache/airflow:3.2.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|airflow-create-user|create-user|apache/airflow:3.2.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|airflow-dag-processor|dag-processor|apache/airflow:3.2.2|
|Deployment|airflow-dag-processor|dag-processor-log-groomer|apache/airflow:3.2.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|airflow-run-airflow-migrations|run-airflow-migrations|apache/airflow:3.2.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|airflow-scheduler|scheduler|apache/airflow:3.2.2|
|Deployment|airflow-scheduler|scheduler-log-groomer|apache/airflow:3.2.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|airflow-statsd|statsd|quay.io/prometheus/statsd-exporter:v0.30.0|
