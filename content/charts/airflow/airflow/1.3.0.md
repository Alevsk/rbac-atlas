...
| [`airflow-flower`](#sa-airflow-flower)                             | default   | ❌        | —       | 0           | 1         | —                     |
...
| [`airflow-triggerer`](#sa-airflow-triggerer)                       | default   | ❌        | —       | 0           | 1         | —                     |
...
| ----------- | -------------- | ------------------ | -------------------- |
| StatefulSet | airflow-worker | worker             | apache/airflow:2.2.1 |
| StatefulSet | airflow-worker | worker-log-groomer | apache/airflow:2.2.1 |
...
| Kind       | Name              | Container | Image                |
| ---------- | ----------------- | --------- | -------------------- |
| Deployment | airflow-webserver | webserver | apache/airflow:2.2.1 |
...
| Kind | Name                | Container   | Image                |
| ---- | ------------------- | ----------- | -------------------- |
| Job  | airflow-create-user | create-user | apache/airflow:2.2.1 |

---

### 🤖 `airflow-flower` {#sa-airflow-flower}
...
| Kind       | Name           | Container | Image                |
| ---------- | -------------- | --------- | -------------------- |
| Deployment | airflow-flower | flower    | apache/airflow:2.2.1 |
...
| Kind | Name                           | Container              | Image                |
| ---- | ------------------------------ | ---------------------- | -------------------- |
| Job  | airflow-run-airflow-migrations | run-airflow-migrations | apache/airflow:2.2.1 |
...
| Kind        | Name          | Container | Image          |
| ----------- | ------------- | --------- | -------------- |
| StatefulSet | airflow-redis | redis     | redis:6-buster |
...
| Kind       | Name              | Container             | Image                |
| ---------- | ----------------- | --------------------- | -------------------- |
| Deployment | airflow-scheduler | scheduler             | apache/airflow:2.2.1 |
| Deployment | airflow-scheduler | scheduler-log-groomer | apache/airflow:2.2.1 |
...
| Kind       | Name              | Container | Image                |
| ---------- | ----------------- | --------- | -------------------- |
| Deployment | airflow-triggerer | triggerer | apache/airflow:2.2.1 |
