...
| ----------- | -------------- | ------------------ | -------------------- |
| StatefulSet | airflow-worker | worker             | apache/airflow:2.1.2 |
| StatefulSet | airflow-worker | worker-log-groomer | apache/airflow:2.1.2 |
...
| Kind       | Name              | Container | Image                |
| ---------- | ----------------- | --------- | -------------------- |
| Deployment | airflow-webserver | webserver | apache/airflow:2.1.2 |
...
| Kind | Name                | Container   | Image                |
| ---- | ------------------- | ----------- | -------------------- |
| Job  | airflow-create-user | create-user | apache/airflow:2.1.2 |
...
| Kind       | Name           | Container | Image                |
| ---------- | -------------- | --------- | -------------------- |
| Deployment | airflow-flower | flower    | apache/airflow:2.1.2 |
...
| Kind | Name                           | Container              | Image                |
| ---- | ------------------------------ | ---------------------- | -------------------- |
| Job  | airflow-run-airflow-migrations | run-airflow-migrations | apache/airflow:2.1.2 |
...
| Kind       | Name              | Container             | Image                |
| ---------- | ----------------- | --------------------- | -------------------- |
| Deployment | airflow-scheduler | scheduler             | apache/airflow:2.1.2 |
| Deployment | airflow-scheduler | scheduler-log-groomer | apache/airflow:2.1.2 |
