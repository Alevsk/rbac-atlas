...
| ----------- | -------------- | ------------------ | -------------------- |
| StatefulSet | airflow-worker | worker             | apache/airflow:2.5.1 |
| StatefulSet | airflow-worker | worker-log-groomer | apache/airflow:2.5.1 |
...
| Kind       | Name              | Container | Image                |
| ---------- | ----------------- | --------- | -------------------- |
| Deployment | airflow-triggerer | triggerer | apache/airflow:2.5.1 |
...
| Kind       | Name              | Container | Image                |
| ---------- | ----------------- | --------- | -------------------- |
| Deployment | airflow-webserver | webserver | apache/airflow:2.5.1 |
...
| Kind | Name                | Container   | Image                |
| ---- | ------------------- | ----------- | -------------------- |
| Job  | airflow-create-user | create-user | apache/airflow:2.5.1 |
...
| Kind | Name                           | Container              | Image                |
| ---- | ------------------------------ | ---------------------- | -------------------- |
| Job  | airflow-run-airflow-migrations | run-airflow-migrations | apache/airflow:2.5.1 |
...
| Kind        | Name          | Container | Image            |
| ----------- | ------------- | --------- | ---------------- |
| StatefulSet | airflow-redis | redis     | redis:7-bullseye |
...
| Kind       | Name              | Container             | Image                |
| ---------- | ----------------- | --------------------- | -------------------- |
| Deployment | airflow-scheduler | scheduler             | apache/airflow:2.5.1 |
| Deployment | airflow-scheduler | scheduler-log-groomer | apache/airflow:2.5.1 |
...
| Kind       | Name           | Container | Image                                      |
| ---------- | -------------- | --------- | ------------------------------------------ |
| Deployment | airflow-statsd | statsd    | quay.io/prometheus/statsd-exporter:v0.22.8 |
