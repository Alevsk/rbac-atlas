...
| [`k8gb-external-dns`](#sa-k8gb-external-dns) | default   | ❌        | —       | 2           | 0         | {{< risk "High" >}} |
| [`coredns`](#sa-coredns)                     | default   | ❌        | —       | 7           | 1         | {{< risk "Low" >}}  |
| [`hook-sa`](#sa-hook-sa)                     | default   | ❌        | —       | 1           | 1         | {{< risk "Low" >}}  |
...
| ---------- | ---- | --------- | ------------------- |
| Deployment | k8gb | k8gb      | absaoss/k8gb:v0.8.2 |
...
| Role                            | Resource                               | Verbs              | Risk              | Tags                                                             |
| ------------------------------- | -------------------------------------- | ------------------ | ----------------- | ---------------------------------------------------------------- |
| ClusterRole `k8gb-external-dns` | externaldns.k8s.io/dnsendpoints/status | \*                 | {{< risk High >}} | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}} |
| ClusterRole `k8gb-external-dns` | externaldns.k8s.io/dnsendpoints        | get · list · watch | {{< risk Low >}}  |                                                                  |
...
| Kind       | Name         | Container | Image                  |
| ---------- | ------------ | --------- | ---------------------- |
| Deployment | k8gb-coredns | coredns   | absaoss/k8s_crd:v0.0.6 |
...
| Role             | Resource      | Verbs         | Risk             | Tags |
| ---------------- | ------------- | ------------- | ---------------- | ---- |
| Role `hook-role` | core/services | delete · list | {{< risk Low >}} |      |
...
| Kind | Name                | Container | Image                  |
| ---- | ------------------- | --------- | ---------------------- |
| Job  | hook-service-delete | kubectl   | bitnami/kubectl:1.21.1 |
