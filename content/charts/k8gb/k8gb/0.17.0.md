...
| ---------- | ---- | --------- | ------------------------------ |
| Deployment | k8gb | k8gb      | docker.io/absaoss/k8gb:v0.17.0 |
...
| Kind       | Name         | Container | Image                  |
| ---------- | ------------ | --------- | ---------------------- |
| Deployment | k8gb-coredns | coredns   | absaoss/k8s_crd:v0.1.2 |
...
| Kind       | Name              | Container    | Image                                             |
| ---------- | ----------------- | ------------ | ------------------------------------------------- |
| Deployment | k8gb-external-dns | external-dns | registry.k8s.io/external-dns/external-dns:v0.19.0 |
