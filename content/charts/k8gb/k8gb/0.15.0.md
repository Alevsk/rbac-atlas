...
|---|---|---|---|---|---|---|
|[`k8gb`](#sa-k8gb)|default|❌|—|10|1|{{< risk "High" >}}|
...
|---|---|---|---|
|Deployment|k8gb|k8gb|docker.io/absaoss/k8gb:v0.15.0|
...
|Role|Resource|Verbs|Risk|Tags|
|---|---|---|---|---|
|ClusterRole `k8gb-external-dns`|core/endpoints|get · list · watch|{{< risk Low >}}||
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|k8gb-external-dns|external-dns|registry.k8s.io/external-dns/external-dns:v0.17.0|
