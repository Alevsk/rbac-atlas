...
| ---------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`kubevault-operator`](#sa-kubevault-operator) | default   | ❌        | —       | 31          | 2         | {{< risk "Critical" >}} |
...
| ClusterRole `appscode:license-checker` | core/namespaces                                              | get · list                                   | {{< risk Low >}}      |                                                                                                                                                                      |
...
| ---------- | -------------------------- | --------- | ------------------------------- |
| Deployment | kubevault-operator         | operator  | kubevault/vault-operator:v0.7.0 |
