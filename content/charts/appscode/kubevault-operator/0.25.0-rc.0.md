...
low_findings: 16
categories: []
tags: [BindingToPrivilegedRole, CRDManipulation, CertificateManagement, ClusterAdminAccess, ClusterWideAccess, ClusterWidePodExec, ClusterWideSecretAccess, CodeExecution, ConfigMapAccess, CredentialAccess, DataExposure, ElevationOfPrivilege, InformationDisclosure, LateralMovement, Persistence, PodExec, PotentialPrivilegeEscalation, PrivilegeEscalation, RBACManipulation, RBACQuery, ResourceNameRestricted, SecretAccess, Spoofing, Tampering, WildcardPermission, WorkloadExecution, letter-K]
---
## Description
...
|---|---|---|---|---|---|---|
|[`kubevault-operator`](#sa-kubevault-operator)|default|❌|—|36|1|{{< risk "Critical" >}}|
...
|---|---|---|---|
|Deployment|kubevault-operator|operator|ghcr.io/kubevault/vault-operator:v0.25.0-rc.0|
