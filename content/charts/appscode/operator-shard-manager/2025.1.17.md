...
| ------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`operator-shard-manager`](#sa-operator-shard-manager) | default   | ✅        | —       | 6           | 1         | {{< risk "Critical" >}} |
...
| ------------------------------------------------- | ----------------------------------------- | ----------------------------------------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `operator-shard-manager:manager`      | \*                                        | create · get · list · patch · update · watch          | {{< risk Critical >}} | {{< tag "AuthorizationBypass" >}} {{< tag "AvailabilityImpact" >}} {{< tag "CSRApproval" >}} {{< tag "CSRCreation" >}} {{< tag "CertificateManagement" >}} (+48 more) |
...
| ClusterRole `operator-shard-manager:metrics-auth` | authorization.k8s.io/subjectaccessreviews | create                                                | {{< risk Medium >}}   | {{< tag "InformationDisclosure" >}} {{< tag "RBACQuery" >}}                                                                                                           |
| ClusterRole `operator-shard-manager:metrics-auth` | authentication.k8s.io/tokenreviews        | create                                                | {{< risk Medium >}}   | {{< tag "CredentialAccess" >}} {{< tag "InformationDisclosure" >}} {{< tag "RBACQuery" >}}                                                                            |
...
| ---------- | ---------------------- | ---------------------- | ---------------------------------------------- |
| Deployment | operator-shard-manager | operator-shard-manager | ghcr.io/appscode/operator-shard-manager:v0.0.1 |
