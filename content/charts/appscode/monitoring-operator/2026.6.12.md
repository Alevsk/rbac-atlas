...
|ClusterRole `monitoring-operator`|monitoring.coreos.com/alertmanagerconfigs|create · delete · get · list · patch · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|monitoring-operator|operator|ghcr.io/appscode/grafana-tools:v0.8.0|
