...
| ------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`monitoring-operator`](#sa-monitoring-operator) | default   | ❌        | —       | 26          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ------------------- | --------- | ------------------------------------- |
| Deployment | monitoring-operator | operator  | ghcr.io/appscode/grafana-tools:v0.2.0 |
