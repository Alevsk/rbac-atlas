...
|---|---|---|---|---|---|---|
|[`kubestash-operator`](#sa-kubestash-operator)|default|❌|—|44|2|{{< risk "Critical" >}}|
...
|---|---|---|---|
|Deployment|kubestash-operator-operator|operator|ghcr.io/kubestash/kubestash:v0.26.0|
|Deployment|kubestash-operator-webhook-server|webhook-server|ghcr.io/kubestash/kubestash:v0.26.0|
