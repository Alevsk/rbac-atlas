...
| -------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`kubestash-operator`](#sa-kubestash-operator)                 | default   | ❌        | —       | 52          | 3         | {{< risk "Critical" >}} |
...
| ClusterRole `kubestash-operator`            | cert-manager.io/clusterissuers                               | get · list · watch                                    | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `kubestash-operator`            | cert-manager.io/issuers                                      | get · list · watch                                    | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ---------- | --------------------------------- | --------------- | ---------------------------------------- |
| Deployment | kubestash-operator-operator       | operator        | ghcr.io/kubestash/kubestash:v0.10.0      |
| Deployment | kubestash-operator-webhook-server | kube-rbac-proxy | ghcr.io/appscode/kube-rbac-proxy:v0.11.0 |
| Deployment | kubestash-operator-webhook-server | webhook-server  | ghcr.io/kubestash/kubestash:v0.10.0      |
