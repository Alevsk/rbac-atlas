...
|---|---|---|---|---|---|---|
|[`kubestash-operator`](#sa-kubestash-operator)|default|❌|—|46|2|{{< risk "Critical" >}}|
...
|ClusterRole `kubestash-operator`|discovery.k8s.io/endpointslices|get · list · watch|{{< risk Low >}}||
...
|ClusterRole `kubestash-operator`|kubevault.com/vaultservers|get · list · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|kubestash-operator-operator|operator|ghcr.io/kubestash/kubestash:v0.27.0|
|Deployment|kubestash-operator-webhook-server|webhook-server|ghcr.io/kubestash/kubestash:v0.27.0|
