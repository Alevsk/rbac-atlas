...
| -------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`kubestash-operator`](#sa-kubestash-operator)                 | default   | ❌        | —       | 50          | 3         | {{< risk "Critical" >}} |
...
| ---------- | --------------------------------- | --------------- | ---------------------------------------- |
| Deployment | kubestash-operator-operator       | operator        | ghcr.io/kubestash/kubestash:v0.9.0       |
| Deployment | kubestash-operator-webhook-server | kube-rbac-proxy | ghcr.io/appscode/kube-rbac-proxy:v0.11.0 |
| Deployment | kubestash-operator-webhook-server | webhook-server  | ghcr.io/kubestash/kubestash:v0.9.0       |
