...
| -------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`kubestash-operator`](#sa-kubestash-operator)                 | default   | ❌        | —       | 47          | 2         | {{< risk "Critical" >}} |
...
| ---------- | ------------------ | --------------- | ---------------------------------------- |
| Deployment | kubestash-operator | kube-rbac-proxy | ghcr.io/appscode/kube-rbac-proxy:v0.11.0 |
| Deployment | kubestash-operator | operator        | ghcr.io/kubestash/kubestash:v0.4.0       |
