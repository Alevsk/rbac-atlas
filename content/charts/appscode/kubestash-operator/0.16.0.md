...
| -------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`kubestash-operator`](#sa-kubestash-operator)                 | default   | ❌        | —       | 44          | 3         | {{< risk "Critical" >}} |
...
| ClusterRole `kubestash-operator`            | archiver.kubedb.com/\*                                       | create · get                                          | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                      |
...
| ---------- | --------------------------------- | --------------- | ---------------------------------------- |
| Deployment | kubestash-operator-operator       | operator        | ghcr.io/kubestash/kubestash:v0.16.0      |
| Deployment | kubestash-operator-webhook-server | kube-rbac-proxy | ghcr.io/appscode/kube-rbac-proxy:v0.15.0 |
| Deployment | kubestash-operator-webhook-server | webhook-server  | ghcr.io/kubestash/kubestash:v0.16.0      |
