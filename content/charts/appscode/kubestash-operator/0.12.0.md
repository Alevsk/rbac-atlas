...
| ---------- | --------------------------------- | --------------- | ---------------------------------------- |
| Deployment | kubestash-operator-operator       | operator        | ghcr.io/kubestash/kubestash:v0.12.1      |
| Deployment | kubestash-operator-webhook-server | kube-rbac-proxy | ghcr.io/appscode/kube-rbac-proxy:v0.11.0 |
| Deployment | kubestash-operator-webhook-server | webhook-server  | ghcr.io/kubestash/kubestash:v0.12.1      |
