...
|ClusterRole `istiod-clusterrole-default`|gateway.networking.k8s.io/listenersets/status|patch · update|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|istiod|discovery|registry.istio.io/testing/pilot:1.30.0-alpha.2|
