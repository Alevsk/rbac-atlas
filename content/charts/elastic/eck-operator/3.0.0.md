...
| ------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`elastic-operator`](#sa-elastic-operator) | default   | ✅        | —       | 46          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `elastic-operator` | coordination.k8s.io/leases                                      | create · get · update · watch                         | {{< risk Low >}}      |                                                                                                                                                                         |
