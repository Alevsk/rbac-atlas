...
| Kind       | Name                          | Container  | Image                                    |
| ---------- | ----------------------------- | ---------- | ---------------------------------------- |
| DaemonSet  | metricbeat-metricbeat         | metricbeat | docker.elastic.co/beats/metricbeat:7.7.0 |
| Deployment | metricbeat-metricbeat-metrics | metricbeat | docker.elastic.co/beats/metricbeat:7.7.0 |
