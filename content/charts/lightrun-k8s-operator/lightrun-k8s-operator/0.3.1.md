...
| ---------- | ---------------------------------------- | --------------- | ------------------------------------------ |
| Deployment | lightrun-k8s-operator-controller-manager | kube-rbac-proxy | gcr.io/kubebuilder/kube-rbac-proxy:v0.15.0 |
| Deployment | lightrun-k8s-operator-controller-manager | manager         | lightruncom/lightrun-k8s-operator:0.3.1    |
