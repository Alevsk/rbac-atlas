...
| ---------- | ----------------------------- | --------- | ---------------------------------- |
| Deployment | gatekeeper-audit              | manager   | openpolicyagent/gatekeeper:v3.11.1 |
| Deployment | gatekeeper-controller-manager | manager   | openpolicyagent/gatekeeper:v3.11.1 |
...
| Kind | Name                        | Container    | Image                                   |
| ---- | --------------------------- | ------------ | --------------------------------------- |
| Job  | gatekeeper-update-crds-hook | crds-upgrade | openpolicyagent/gatekeeper-crds:v3.11.1 |
