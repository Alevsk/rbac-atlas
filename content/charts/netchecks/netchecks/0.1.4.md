...
| ------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ------------------- |
| [`netcheck-operator`](#sa-netcheck-operator)                 | default   | ❌        | —       | 17          | 1         | {{< risk "High" >}} |
...
| ClusterRole `netchecks` | core/configmaps                                                      | create                                       | {{< risk Low >}}  |                                                                                                                           |
...
| ---------- | --------- | --------- | ----------------------------------------- |
| Deployment | netchecks | netchecks | ghcr.io/hardbyte/netchecks-operator:0.3.2 |
...
| Kind       | Name                     | Container      | Image                                                |
| ---------- | ------------------------ | -------------- | ---------------------------------------------------- |
| Deployment | netchecks-kyverno-plugin | kyverno-plugin | ghcr.io/kyverno/policy-reporter-kyverno-plugin:1.5.0 |
...
| Kind       | Name                      | Container       | Image                                  |
| ---------- | ------------------------- | --------------- | -------------------------------------- |
| Deployment | netchecks-policy-reporter | policy-reporter | ghcr.io/kyverno/policy-reporter:2.11.1 |
