...
| ---------- | --------- | --------- | ----------------------------------------- |
| Deployment | netchecks | netchecks | ghcr.io/hardbyte/netchecks-operator:0.4.1 |
...
| Kind       | Name                      | Container       | Image                                  |
| ---------- | ------------------------- | --------------- | -------------------------------------- |
| Deployment | netchecks-policy-reporter | policy-reporter | ghcr.io/kyverno/policy-reporter:2.15.0 |
