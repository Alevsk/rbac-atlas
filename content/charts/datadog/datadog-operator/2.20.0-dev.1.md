...
|---|---|---|---|---|---|---|
|[`datadog-operator`](#sa-datadog-operator)|default|❌|—|102|1|{{< risk "Critical" >}}|
...
|ClusterRole `datadog-operator`|apps/controllerrevisions|list · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|datadog-operator|datadog-operator|registry.datadoghq.com/operator:1.25.0-rc.1|
