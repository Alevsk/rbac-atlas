...
|---|---|---|---|---|---|---|
|[`datadog-operator`](#sa-datadog-operator)|default|❌|—|137|1|{{< risk "Critical" >}}|
...
|ClusterRole `datadog-operator`|datadoghq.com/extendeddaemonsetreplicasets|delete · get · list · watch|{{< risk Low >}}||
...
|ClusterRole `datadog-operator`|gateway.networking.k8s.io/referencegrants|create · delete · get · patch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|datadog-operator|datadog-operator|registry.datadoghq.com/operator:1.30.0-rc.3|
