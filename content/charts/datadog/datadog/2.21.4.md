...
| [`datadog-cluster-agent`](#sa-datadog-cluster-agent)           | default   | ❌        | —       | 23          | 1         | {{< risk "Medium" >}}   |
...
| Kind      | Name    | Container     | Image                         |
| --------- | ------- | ------------- | ----------------------------- |
| DaemonSet | datadog | agent         | gcr.io/datadoghq/agent:7.30.1 |
| DaemonSet | datadog | process-agent | gcr.io/datadoghq/agent:7.30.1 |
| DaemonSet | datadog | trace-agent   | gcr.io/datadoghq/agent:7.30.1 |
...
| Kind       | Name                  | Container     | Image                                 |
| ---------- | --------------------- | ------------- | ------------------------------------- |
| Deployment | datadog-cluster-agent | cluster-agent | gcr.io/datadoghq/cluster-agent:1.14.0 |
