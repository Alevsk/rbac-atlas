...
| -------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`datadog`](#sa-datadog)                                       | default   | ❌        | —       | 10          | 3         | {{< risk "Critical" >}} |
| [`datadog-cluster-agent`](#sa-datadog-cluster-agent)           | default   | ❌        | —       | 33          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `datadog-cluster-agent` | admissionregistration.k8s.io/mutatingwebhookconfigurations                                  | create · get · list · update · watch | {{< risk Medium >}}   | {{< tag "InformationDisclosure" >}} {{< tag "Reconnaissance" >}} {{< tag "WebhookReconnaissance" >}}                                                            |
...
| ---------- | --------------------- | ------------- | ------------------------------------- |
| Deployment | datadog-cluster-agent | cluster-agent | gcr.io/datadoghq/cluster-agent:1.21.0 |
...
| Kind      | Name    | Container     | Image                         |
| --------- | ------- | ------------- | ----------------------------- |
| DaemonSet | datadog | agent         | gcr.io/datadoghq/agent:7.37.1 |
| DaemonSet | datadog | process-agent | gcr.io/datadoghq/agent:7.37.1 |
| DaemonSet | datadog | trace-agent   | gcr.io/datadoghq/agent:7.37.1 |
