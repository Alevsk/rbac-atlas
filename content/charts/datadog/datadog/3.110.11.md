...
| ClusterRole `datadog-cluster-agent` | apps/replicationcontrollers                                                                       | get                                  | {{< risk Low >}}      |                                                                                                                                                                |
...
| ---------- | --------------------- | ------------- | ------------------------------------- |
| Deployment | datadog-cluster-agent | cluster-agent | gcr.io/datadoghq/cluster-agent:7.64.1 |
