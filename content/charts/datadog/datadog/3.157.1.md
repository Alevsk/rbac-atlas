...
| [`datadog-datadog-operator`](#sa-datadog-datadog-operator)     | default   | ❌        | —       | 83          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `datadog-datadog-operator` | apiextensions.k8s.io/customresourcedefinitions                                   | list · watch                                                             | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `datadog-datadog-operator` | networking.k8s.io/ingresses                                                      | list · watch                                                             | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `datadog-datadog-operator` | core/nodes/proxy                                                                 | get                                                                      | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| Kind       | Name                     | Container        | Image                            |
| ---------- | ------------------------ | ---------------- | -------------------------------- |
| Deployment | datadog-datadog-operator | datadog-operator | gcr.io/datadoghq/operator:1.21.0 |
