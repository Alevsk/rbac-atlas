...
| [`datadog-cluster-agent`](#sa-datadog-cluster-agent)           | default   | ✅        | —       | 65          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `datadog-cluster-agent` | coordination.k8s.io/leases **(restricted to: datadog-leader-election)**                     | create · get · update                | {{< risk Low >}}      | {{< tag "ResourceNameRestricted" >}}                                                                                                                            |
...
| ---------- | --------------------- | ------------- | ------------------------------------- |
| Deployment | datadog-cluster-agent | cluster-agent | gcr.io/datadoghq/cluster-agent:7.44.1 |
