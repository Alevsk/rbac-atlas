...
| -------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`datadog`](#sa-datadog)                                       | default   | ✅        | —       | 10          | 0         | {{< risk "Critical" >}} |
...
| ClusterRole `datadog-cluster-agent` | apps/daemonsets                                                                                 | get · list · patch · watch           | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `datadog-cluster-agent` | apps/deployments                                                                                | get · list · patch · watch           | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `datadog-cluster-agent` | apps/replicasets                                                                                | get · list · patch · watch           | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `datadog-cluster-agent` | apps/statefulsets                                                                               | get · list · patch · watch           | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ---------- | --------------------- | ------------- | ------------------------------------- |
| Deployment | datadog-cluster-agent | cluster-agent | gcr.io/datadoghq/cluster-agent:7.47.0 |
