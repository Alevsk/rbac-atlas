...
| [`datadog-cluster-agent`](#sa-datadog-cluster-agent)           | default   | ❌        | —       | 26          | 1         | {{< risk "Medium" >}}   |
...
| Kind      | Name    | Container     | Image                         |
| --------- | ------- | ------------- | ----------------------------- |
| DaemonSet | datadog | agent         | gcr.io/datadoghq/agent:7.33.0 |
| DaemonSet | datadog | process-agent | gcr.io/datadoghq/agent:7.33.0 |
| DaemonSet | datadog | trace-agent   | gcr.io/datadoghq/agent:7.33.0 |
...
| ClusterRole `datadog-cluster-agent` | networking.k8s.io/ingresses                                                                 | list · watch                | {{< risk Low >}}    |                                                                                                                                                                 |
...
| Kind       | Name                  | Container     | Image                                 |
| ---------- | --------------------- | ------------- | ------------------------------------- |
| Deployment | datadog-cluster-agent | cluster-agent | gcr.io/datadoghq/cluster-agent:1.17.0 |
