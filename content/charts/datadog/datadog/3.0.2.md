...
| [`datadog-cluster-agent`](#sa-datadog-cluster-agent)           | default   | ❌        | —       | 59          | 1         | {{< risk "Critical" >}} |
...
| ---------- | --------------------- | ------------- | ------------------------------------- |
| Deployment | datadog-cluster-agent | cluster-agent | gcr.io/datadoghq/cluster-agent:1.22.0 |
...
| Kind      | Name    | Container     | Image                         |
| --------- | ------- | ------------- | ----------------------------- |
| DaemonSet | datadog | agent         | gcr.io/datadoghq/agent:7.38.2 |
| DaemonSet | datadog | process-agent | gcr.io/datadoghq/agent:7.38.2 |
| DaemonSet | datadog | trace-agent   | gcr.io/datadoghq/agent:7.38.2 |
