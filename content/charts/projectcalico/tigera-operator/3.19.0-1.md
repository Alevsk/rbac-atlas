...
| ---------------------------------------- | --------------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`tigera-operator`](#sa-tigera-operator) | tigera-operator | ❌        | —       | 30          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `tigera-operator` | apiregistration.k8s.io/apiservices                               | list · watch                                                    | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `tigera-operator` | crd.projectcalico.org/felixconfigurations                        | patch                                                           | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `tigera-operator` | policy/podsecuritypolicies                                       | create · get · list · update · watch                            | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ---------- | --------------- | --------------- | ------------------------------- |
| Deployment | tigera-operator | tigera-operator | quay.io/tigera/operator:v1.17.0 |
