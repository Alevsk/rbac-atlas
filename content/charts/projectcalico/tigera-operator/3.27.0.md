...
| ---------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`tigera-operator`](#sa-tigera-operator) | default   | ❌        | —       | 45          | 2         | {{< risk "Critical" >}} |
...
| ClusterRole `tigera-operator` | operator.tigera.io/apiservers                                    | get · list · patch · update · watch                             | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ClusterRole `tigera-operator` | operator.tigera.io/installations                                 | get · list · patch · update · watch                             | {{< risk Low >}}      |                                                                                                                                                                                       |
...
| ---------- | ------------------------- | --------------- | ------------------------------- |
| Deployment | tigera-operator           | tigera-operator | quay.io/tigera/operator:v1.32.3 |
| Job        | tigera-operator-uninstall | cleanup-job     | quay.io/tigera/operator:v1.32.3 |
