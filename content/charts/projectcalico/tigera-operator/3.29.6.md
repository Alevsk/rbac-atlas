...
| ---------- | ------------------------- | --------------- | -------------------------------- |
| Deployment | tigera-operator           | tigera-operator | quay.io/tigera/operator:v1.36.14 |
| Job        | tigera-operator-uninstall | cleanup-job     | quay.io/tigera/operator:v1.36.14 |
