...
| ---------- | ------------------------- | --------------- | ------------------------------- |
| Deployment | tigera-operator           | tigera-operator | quay.io/tigera/operator:v1.32.5 |
| Job        | tigera-operator-uninstall | cleanup-job     | quay.io/tigera/operator:v1.32.5 |
