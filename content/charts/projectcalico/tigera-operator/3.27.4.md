...
| ---------- | ------------------------- | --------------- | -------------------------------- |
| Deployment | tigera-operator           | tigera-operator | quay.io/tigera/operator:v1.32.10 |
| Job        | tigera-operator-uninstall | cleanup-job     | quay.io/tigera/operator:v1.32.10 |
