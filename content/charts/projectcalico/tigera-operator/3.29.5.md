...
| ---------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`tigera-operator`](#sa-tigera-operator) | default   | ❌        | —       | 51          | 2         | {{< risk "Critical" >}} |
...
| ---------- | ------------------------- | --------------- | -------------------------------- |
| Deployment | tigera-operator           | tigera-operator | quay.io/tigera/operator:v1.36.12 |
| Job        | tigera-operator-uninstall | cleanup-job     | quay.io/tigera/operator:v1.36.12 |
