...
| ClusterRole `meshery-operator-role`   | cloud.layer5.io/brokers                   | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                          |
| ClusterRole `meshery-operator-role`   | cloud.layer5.io/brokers/status            | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                          |
