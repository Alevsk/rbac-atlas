...
| ------------------------------------- | ----------------------------------------- | ----------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `meshery-controller-role` | _/_                                       | create · delete · get · list · patch · update · watch | {{< risk Critical >}} | {{< tag "APIServerDoS" >}} {{< tag "APIServiceManipulation" >}} {{< tag "AvailabilityImpact" >}} {{< tag "BackupAccess" >}} {{< tag "BindingToPrivilegedRole" >}} (+63 more) |
