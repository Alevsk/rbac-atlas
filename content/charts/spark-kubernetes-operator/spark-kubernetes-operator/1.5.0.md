...
| -------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`spark-operator`](#sa-spark-operator) | default   | ❌        | —       | 10          | 2         | {{< risk "Critical" >}} |
...
| ClusterRole `spark-operator-clusterrole` | policy/poddisruptionbudgets          | \*    | {{< risk Medium >}}   | {{< tag "AvailabilityImpact" >}} {{< tag "ClusterWideAccess" >}} {{< tag "DenialOfService" >}} {{< tag "Tampering" >}} {{< tag "WildcardPermission" >}}                           |
...
| ---------- | -------------------------------------------- | ------------------------- | -------------------------------------- |
| Deployment | spark-kubernetes-operator                    | spark-kubernetes-operator | apache/spark-kubernetes-operator:0.7.0 |
