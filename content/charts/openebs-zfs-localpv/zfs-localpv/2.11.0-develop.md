...
tags: [ClusterStructure, ClusterWideAccess, DenialOfService, InformationDisclosure, NamespaceLifecycle, NetworkManipulation, NodeAccess, OperationalData, PotentialPrivilegeEscalation, PrivilegeEscalation, Reconnaissance, ResourceDeletion, ServiceExposure, StorageDetailsDisclosure, Tampering, WildcardPermission, WorkloadExecution, letter-Z]
---
## Description
...
|Deployment|zfs-localpv-controller|openebs-zfs-plugin|docker.io/openebs/zfs-driver:2.11.0-develop|
...
|DaemonSet|zfs-localpv-node|openebs-zfs-plugin|docker.io/openebs/zfs-driver:2.11.0-develop|
