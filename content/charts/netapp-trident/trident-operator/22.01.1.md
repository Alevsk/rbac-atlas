...
| ------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`trident-operator`](#sa-trident-operator) | default   | ❌        | —       | 75          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `trident-operator` | core/pods/exec                                                                  | create · list                                         | {{< risk Critical >}} | {{< tag "ClusterWidePodExec" >}} {{< tag "CodeExecution" >}} {{< tag "ElevationOfPrivilege" >}} {{< tag "LateralMovement" >}} {{< tag "PodExec" >}} (+1 more)           |
...
| ClusterRole `trident-operator` | core/namespaces                                                                 | create · get · list                                   | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ClusterRole `trident-operator` | core/serviceaccounts                                                            | create · list                                         | {{< risk Low >}}      |                                                                                                                                                                         |
| ClusterRole `trident-operator` | core/services                                                                   | create · list                                         | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ClusterRole `trident-operator` | snapshot.storage.k8s.io/volumesnapshotclasses                                   | get · list · patch · update · watch                   | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ClusterRole `trident-operator` | policy/podsecuritypolicies **(restricted to: tridentpods)**                     | delete · patch · update · use                         | {{< risk Low >}}      | {{< tag "DeprecatedFeature" >}} {{< tag "NodeAccess" >}} {{< tag "PodSecurityPolicy" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "ResourceNameRestricted" >}}         |
...
| ---------- | ---------------- | ---------------- | ------------------------------- |
| Deployment | trident-operator | trident-operator | netapp/trident-operator:22.01.1 |
