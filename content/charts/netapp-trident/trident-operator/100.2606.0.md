...
|---|---|---|---|---|---|---|
|[`trident-operator`](#sa-trident-operator)|default|❌|—|157|1|{{< risk "Critical" >}}|
...
|ClusterRole `trident-operator`|trident.netapp.io/tridentvolumemoves|create · delete · get · list · patch · update · watch|{{< risk Low >}}||
|ClusterRole `trident-operator`|trident.netapp.io/tridentvolumemoves/status|create · delete · get · list · patch · update · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|trident-operator|trident-operator|docker.io/netapp/trident-operator:26.06.0|
