...
| ------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ------------------ |
| [`sbom-operator`](#sa-sbom-operator) | default   | ❌        | —       | 4           | 1         | {{< risk "Low" >}} |
...
| --------------------------- | --------------- | ---------------------------- | ---------------- | ---- |
| ClusterRole `sbom-operator` | core/configmaps | create · delete · get · list | {{< risk Low >}} |      |
...
| ---------- | ------------- | ------------- | --------------------------------------- |
| Deployment | sbom-operator | sbom-operator | ghcr.io/ckotzbauer/sbom-operator:0.36.0 |
