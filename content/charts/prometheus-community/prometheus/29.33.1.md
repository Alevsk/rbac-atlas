...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|prometheus-server|prometheus-server|quay.io/prometheus/prometheus:v3.15.0|
|Deployment|prometheus-server|prometheus-server-configmap-reload|quay.io/prometheus-operator/prometheus-config-reloader:v0.94.1|
...
|StatefulSet|prometheus-alertmanager|alertmanager-configmap-reload|quay.io/prometheus-operator/prometheus-config-reloader:v0.94.1|
