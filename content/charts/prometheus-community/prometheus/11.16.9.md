...
| Kind       | Name              | Container                          | Image                              |
| ---------- | ----------------- | ---------------------------------- | ---------------------------------- |
| Deployment | prometheus-server | prometheus-server                  | prom/prometheus:v2.21.0            |
...
| Kind       | Name                    | Container                                | Image                              |
| ---------- | ----------------------- | ---------------------------------------- | ---------------------------------- |
| Deployment | prometheus-alertmanager | prometheus-alertmanager                  | prom/alertmanager:v0.21.0          |
...
| Kind      | Name                     | Container                | Image                     |
| --------- | ------------------------ | ------------------------ | ------------------------- |
| DaemonSet | prometheus-node-exporter | prometheus-node-exporter | prom/node-exporter:v1.0.1 |
...
| Kind       | Name                   | Container              | Image                   |
| ---------- | ---------------------- | ---------------------- | ----------------------- |
| Deployment | prometheus-pushgateway | prometheus-pushgateway | prom/pushgateway:v1.2.0 |
