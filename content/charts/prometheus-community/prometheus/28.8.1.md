...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|prometheus-server|prometheus-server|quay.io/prometheus/prometheus:v3.9.1|
|Deployment|prometheus-server|prometheus-server-configmap-reload|quay.io/prometheus-operator/prometheus-config-reloader:v0.88.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|prometheus-alertmanager|alertmanager|quay.io/prometheus/alertmanager:v0.31.0|
