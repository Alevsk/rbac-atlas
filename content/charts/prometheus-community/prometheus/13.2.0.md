...
| ClusterRole `prometheus-kube-state-metrics-psp` | extensions/podsecuritypolicies **(restricted to: prometheus-kube-state-metrics)** | use          | {{< risk Low >}}      | {{< tag "DeprecatedFeature" >}} {{< tag "NodeAccess" >}} {{< tag "PodSecurityPolicy" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "ResourceNameRestricted" >}} |
...
| ---------- | ----------------------------- | ------------------ | --------------------------------------------------------- |
| Deployment | prometheus-kube-state-metrics | kube-state-metrics | docker.io/bitnami/kube-state-metrics:1.9.7-debian-10-r172 |
...
| Kind       | Name              | Container                          | Image                                 |
| ---------- | ----------------- | ---------------------------------- | ------------------------------------- |
| Deployment | prometheus-server | prometheus-server                  | quay.io/prometheus/prometheus:v2.24.0 |
...
| Kind       | Name                    | Container                                | Image                                   |
| ---------- | ----------------------- | ---------------------------------------- | --------------------------------------- |
| Deployment | prometheus-alertmanager | prometheus-alertmanager                  | quay.io/prometheus/alertmanager:v0.21.0 |
| Deployment | prometheus-alertmanager | prometheus-alertmanager-configmap-reload | jimmidyson/configmap-reload:v0.4.0      |
...
| Kind      | Name                     | Container                | Image                                   |
| --------- | ------------------------ | ------------------------ | --------------------------------------- |
| DaemonSet | prometheus-node-exporter | prometheus-node-exporter | quay.io/prometheus/node-exporter:v1.0.1 |
...
| Kind       | Name                   | Container              | Image                   |
| ---------- | ---------------------- | ---------------------- | ----------------------- |
| Deployment | prometheus-pushgateway | prometheus-pushgateway | prom/pushgateway:v1.3.1 |
