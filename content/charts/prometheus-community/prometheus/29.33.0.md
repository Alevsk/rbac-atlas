...
tags: [ClusterStructure, ClusterWideSecretAccess, ConfigMapAccess, CredentialAccess, DataExposure, InformationDisclosure, QuotaTampering, Reconnaissance, ResourceConfiguration, SecretAccess, WebhookReconnaissance, letter-P]
---
## Description
...
|[`prometheus-server`](#sa-prometheus-server)|default|❌|—|10|2|{{< risk "High" >}}|
...
|ClusterRole `prometheus-kube-state-metrics`|discovery.k8s.io/endpointslices|list · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|prometheus-kube-state-metrics|kube-state-metrics|registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.20.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|prometheus-server|prometheus-server|quay.io/prometheus/prometheus:v3.14.0|
|Deployment|prometheus-server|prometheus-server-configmap-reload|quay.io/prometheus-operator/prometheus-config-reloader:v0.94.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|prometheus-alertmanager|alertmanager|quay.io/prometheus/alertmanager:v0.34.1|
|StatefulSet|prometheus-alertmanager|alertmanager-configmap-reload|quay.io/prometheus-operator/prometheus-config-reloader:v0.94.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|DaemonSet|prometheus-prometheus-node-exporter|node-exporter|quay.io/prometheus/node-exporter:v1.12.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|prometheus-prometheus-pushgateway|pushgateway|quay.io/prometheus/pushgateway:v1.11.3|
