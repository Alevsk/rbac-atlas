...
|---|---|---|---|
|Deployment|prometheus-kube-state-metrics|kube-state-metrics|registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.19.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|prometheus-server|prometheus-server|quay.io/prometheus/prometheus:v3.12.0|
|Deployment|prometheus-server|prometheus-server-configmap-reload|quay.io/prometheus-operator/prometheus-config-reloader:v0.92.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|StatefulSet|prometheus-alertmanager|alertmanager|quay.io/prometheus/alertmanager:v0.33.0|
