...
| ClusterRole `kube-state-metrics` | autoscaling.k8s.io/verticalpodautoscalers                    | list · watch | {{< risk Low >}}      |                                                                                                                                                                |
...
| ---------- | ------------------ | ------------------ | ------------------------------------------------------- |
| Deployment | kube-state-metrics | kube-state-metrics | k8s.gcr.io/kube-state-metrics/kube-state-metrics:v2.0.0 |
