...
|---|---|---|---|
|Job|prometheus-operator-admission-webhook-create|create|ghcr.io/jkroepke/kube-webhook-certgen:1.8.7|
|Job|prometheus-operator-admission-webhook-patch|patch|ghcr.io/jkroepke/kube-webhook-certgen:1.8.7|
