...
|---|---|---|---|
|Job|prometheus-operator-admission-webhook-create|create|ghcr.io/jkroepke/kube-webhook-certgen:1.8.4|
|Job|prometheus-operator-admission-webhook-patch|patch|ghcr.io/jkroepke/kube-webhook-certgen:1.8.4|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|prometheus-operator-admission-webhook|prometheus-operator-admission-webhook|quay.io/prometheus-operator/admission-webhook:v0.92.1|
