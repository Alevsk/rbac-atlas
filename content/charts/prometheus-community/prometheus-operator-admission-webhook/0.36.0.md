...
|---|---|---|---|---|
|ClusterRole `prometheus-operator-admission-webhook-aux`|admissionregistration.k8s.io/mutatingwebhookconfigurations|get · patch · update|{{< risk Low >}}||
|Role `prometheus-operator-admission-webhook-aux`|core/secrets|create · get|{{< risk Low >}}||
|ClusterRole `prometheus-operator-admission-webhook-aux`|admissionregistration.k8s.io/validatingwebhookconfigurations|get · patch · update|{{< risk Low >}}||
...
|---|---|---|---|
|Job|prometheus-operator-admission-webhook-create|create|ghcr.io/jkroepke/kube-webhook-certgen:1.7.4|
|Job|prometheus-operator-admission-webhook-patch|patch|ghcr.io/jkroepke/kube-webhook-certgen:1.7.4|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|prometheus-operator-admission-webhook|prometheus-operator-admission-webhook|quay.io/prometheus-operator/admission-webhook:v0.89.0|
