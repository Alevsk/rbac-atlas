...
|---|---|---|---|
|Deployment|kube-prometheus-stack-operator|kube-prometheus-stack|quay.io/prometheus-operator/prometheus-operator:v0.88.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kube-prometheus-stack-grafana|grafana|docker.io/grafana/grafana:12.3.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|kube-prometheus-stack-admission-create|create|ghcr.io/jkroepke/kube-webhook-certgen:1.7.4|
|Job|kube-prometheus-stack-admission-patch|patch|ghcr.io/jkroepke/kube-webhook-certgen:1.7.4|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Pod|kube-prometheus-stack-grafana-test|kube-prometheus-stack-test|docker.io/bats/bats:1.13.0|
