...
tags: [ClusterStructure, ClusterWideSecretAccess, ConfigMapAccess, CredentialAccess, DataExposure, InformationDisclosure, Persistence, PotentialPrivilegeEscalation, PrivilegeEscalation, QuotaTampering, Reconnaissance, ResourceConfiguration, SecretAccess, Tampering, WebhookReconnaissance, WorkloadLifecycle, letter-K]
---
## Description
...
|[`kube-prometheus-stack-operator`](#sa-kube-prometheus-stack-operator)|default|✅|—|37|1|{{< risk "Critical" >}}|
...
|---|---|---|---|---|
|ClusterRole `kube-prometheus-stack-operator`|core/secrets|create · delete · get · list · update · watch|{{< risk Critical >}}|{{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "SecretAccess" >}}|
|ClusterRole `kube-prometheus-stack-operator`|apps/statefulsets|create · delete · get · list · patch · update · watch|{{< risk Critical >}}|{{< tag "Persistence" >}} {{< tag "PotentialPrivilegeEscalation" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "Tampering" >}} {{< tag "WorkloadLifecycle" >}}|
|ClusterRole `kube-prometheus-stack-operator`|core/configmaps|create · delete · get · list · update · watch|{{< risk High >}}|{{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}|
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/alertmanagerconfigs|get · list · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/alertmanagers|get · list · patch · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/alertmanagers/finalizers|update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/alertmanagers/status|create · delete · patch · update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|core/endpoints|create · delete · get · update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|discovery.k8s.io/endpointslices|create · delete · get · list · update · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|core/events|create · patch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|events.k8s.io/events|create · patch|{{< risk Low >}}||
...
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/podmonitors|get · list · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/podmonitors/status|create · delete · patch · update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|core/pods|delete · list|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/probes|get · list · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/probes/status|create · delete · patch · update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/prometheusagents|get · list · patch · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/prometheusagents/finalizers|update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/prometheusagents/status|create · delete · patch · update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/prometheuses|get · list · patch · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/prometheuses/finalizers|update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/prometheuses/status|create · delete · patch · update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/prometheusrules|get · list · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/prometheusrules/status|create · delete · patch · update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/scrapeconfigs|get · list · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/scrapeconfigs/status|create · delete · patch · update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/servicemonitors|get · list · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/servicemonitors/status|create · delete · patch · update|{{< risk Low >}}||
...
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/thanosrulers|get · list · patch · watch|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/thanosrulers/finalizers|update|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-operator`|monitoring.coreos.com/thanosrulers/status|create · delete · patch · update|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|kube-prometheus-stack-operator|kube-prometheus-stack|quay.io/prometheus-operator/prometheus-operator:v0.94.1|
...
|ClusterRole `kube-prometheus-stack-kube-state-metrics`|discovery.k8s.io/endpointslices|list · watch|{{< risk Low >}}||
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kube-prometheus-stack-kube-state-metrics|kube-state-metrics|registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.20.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kube-prometheus-stack-grafana|grafana|docker.io/grafana/grafana:13.2.2-distroless|
|Deployment|kube-prometheus-stack-grafana|grafana-sc-dashboard|quay.io/kiwigrid/k8s-sidecar:2.11.2|
|Deployment|kube-prometheus-stack-grafana|grafana-sc-datasources|quay.io/kiwigrid/k8s-sidecar:2.11.2|
...
|Role|Resource|Verbs|Risk|Tags|
|---|---|---|---|---|
|ClusterRole `kube-prometheus-stack-admission`|admissionregistration.k8s.io/mutatingwebhookconfigurations|get · patch · update|{{< risk Low >}}||
|Role `kube-prometheus-stack-admission`|core/secrets|create · get|{{< risk Low >}}||
|ClusterRole `kube-prometheus-stack-admission`|admissionregistration.k8s.io/validatingwebhookconfigurations|get · patch · update|{{< risk Low >}}||
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|kube-prometheus-stack-admission-create|create|ghcr.io/jkroepke/kube-webhook-certgen:1.8.9|
|Job|kube-prometheus-stack-admission-patch|patch|ghcr.io/jkroepke/kube-webhook-certgen:1.8.9|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|DaemonSet|kube-prometheus-stack-prometheus-node-exporter|node-exporter|quay.io/prometheus/node-exporter:v1.12.1-distroless|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|DaemonSet|kube-prometheus-stack-prometheus-windows-exporter|windows-exporter|ghcr.io/prometheus-community/windows-exporter:0.31.8|
