...
| [`kube-prometheus-stack-operator`](#sa-kube-prometheus-stack-operator)                                 | default   | ❌        | —       | 20          | 2         | {{< risk "Critical" >}} |
...
| Kind       | Name                           | Container             | Image                                      |
| ---------- | ------------------------------ | --------------------- | ------------------------------------------ |
| Deployment | kube-prometheus-stack-operator | kube-prometheus-stack | quay.io/coreos/prometheus-operator:v0.38.1 |
...
| Kind       | Name                          | Container            | Image                        |
| ---------- | ----------------------------- | -------------------- | ---------------------------- |
| Deployment | kube-prometheus-stack-grafana | grafana              | grafana/grafana:7.1.5        |
