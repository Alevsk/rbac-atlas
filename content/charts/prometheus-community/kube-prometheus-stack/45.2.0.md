...
| [`kube-prometheus-stack-operator`](#sa-kube-prometheus-stack-operator)                                 | default   | ❌        | —       | 23          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ---------------------------------------- | ------------------ | ------------------------------------------------------------ |
| Deployment | kube-prometheus-stack-kube-state-metrics | kube-state-metrics | registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.8.0 |
