...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kube-prometheus-stack-grafana|grafana|docker.io/grafana/grafana:12.3.3|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|kube-prometheus-stack-admission-create|create|ghcr.io/jkroepke/kube-webhook-certgen:1.7.6|
|Job|kube-prometheus-stack-admission-patch|patch|ghcr.io/jkroepke/kube-webhook-certgen:1.7.6|
