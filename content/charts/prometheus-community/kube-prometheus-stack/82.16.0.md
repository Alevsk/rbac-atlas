...
|---|---|---|---|
|Deployment|kube-prometheus-stack-operator|kube-prometheus-stack|quay.io/prometheus-operator/prometheus-operator:v0.89.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|kube-prometheus-stack-grafana|grafana|docker.io/grafana/grafana:12.4.2|
|Deployment|kube-prometheus-stack-grafana|grafana-sc-dashboard|quay.io/kiwigrid/k8s-sidecar:2.5.0|
|Deployment|kube-prometheus-stack-grafana|grafana-sc-datasources|quay.io/kiwigrid/k8s-sidecar:2.5.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Job|kube-prometheus-stack-admission-create|create|ghcr.io/jkroepke/kube-webhook-certgen:1.8.0|
|Job|kube-prometheus-stack-admission-patch|patch|ghcr.io/jkroepke/kube-webhook-certgen:1.8.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|DaemonSet|kube-prometheus-stack-prometheus-node-exporter|node-exporter|quay.io/prometheus/node-exporter:v1.10.2|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|DaemonSet|kube-prometheus-stack-prometheus-windows-exporter|windows-exporter|ghcr.io/prometheus-community/windows-exporter:0.31.5|
