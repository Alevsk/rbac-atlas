...
| ClusterRole `hive-operator` | apps/deployments                            | create · delete · get · list · patch · update · watch | {{< risk Critical >}} | {{< tag "Persistence" >}} {{< tag "PotentialPrivilegeEscalation" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "Tampering" >}} {{< tag "WorkloadLifecycle" >}}  |
...
| ---------- | ------------- | ------------- | -------------------------------------- |
| Deployment | hive-operator | hive-operator | quay.io/zncdatadev/hive-operator:0.1.0 |
