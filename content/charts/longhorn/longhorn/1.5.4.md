...
| ---------- | ------------------------ | ------------------------ | ---------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager         | longhornio/longhorn-manager:v1.5.4 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer | longhornio/longhorn-manager:v1.5.4 |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade    | longhornio/longhorn-manager:v1.5.4 |
| Job        | longhorn-pre-upgrade     | longhorn-pre-upgrade     | longhornio/longhorn-manager:v1.5.4 |
| Job        | longhorn-uninstall       | longhorn-uninstall       | longhornio/longhorn-manager:v1.5.4 |
