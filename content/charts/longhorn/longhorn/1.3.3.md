...
| ---------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`longhorn-service-account`](#sa-longhorn-service-account) | default   | ❌        | —       | 70          | 6         | {{< risk "Critical" >}} |
...
| ---------- | --------------------------- | --------------------------- | ---------------------------------- |
| DaemonSet  | longhorn-manager            | longhorn-manager            | longhornio/longhorn-manager:v1.3.3 |
| Deployment | longhorn-admission-webhook  | longhorn-admission-webhook  | longhornio/longhorn-manager:v1.3.3 |
| Deployment | longhorn-conversion-webhook | longhorn-conversion-webhook | longhornio/longhorn-manager:v1.3.3 |
| Deployment | longhorn-driver-deployer    | longhorn-driver-deployer    | longhornio/longhorn-manager:v1.3.3 |
| Job        | longhorn-post-upgrade       | longhorn-post-upgrade       | longhornio/longhorn-manager:v1.3.3 |
| Job        | longhorn-uninstall          | longhorn-uninstall          | longhornio/longhorn-manager:v1.3.3 |
