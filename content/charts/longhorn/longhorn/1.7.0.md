...
| ---------- | ------------------------ | ---------------------------- | ---------------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager             | longhornio/longhorn-manager:v1.7.0       |
| DaemonSet  | longhorn-manager         | pre-pull-share-manager-image | longhornio/longhorn-share-manager:v1.7.0 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer     | longhornio/longhorn-manager:v1.7.0       |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade        | longhornio/longhorn-manager:v1.7.0       |
| Job        | longhorn-pre-upgrade     | longhorn-pre-upgrade         | longhornio/longhorn-manager:v1.7.0       |
| Job        | longhorn-uninstall       | longhorn-uninstall           | longhornio/longhorn-manager:v1.7.0       |
...
| Kind       | Name        | Container   | Image                         |
| ---------- | ----------- | ----------- | ----------------------------- |
| Deployment | longhorn-ui | longhorn-ui | longhornio/longhorn-ui:v1.7.0 |
