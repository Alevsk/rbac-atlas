...
| ---------- | ------------------------ | ------------------------ | ---------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager         | longhornio/longhorn-manager:v1.2.3 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer | longhornio/longhorn-manager:v1.2.3 |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade    | longhornio/longhorn-manager:v1.2.3 |
| Job        | longhorn-uninstall       | longhorn-uninstall       | longhornio/longhorn-manager:v1.2.3 |
