...
|---|---|---|---|---|---|---|
|[`longhorn-service-account`](#sa-longhorn-service-account)|default|❌|—|111|6|{{< risk "Critical" >}}|
...
|---|---|---|---|
|DaemonSet|longhorn-manager|longhorn-manager|docker.io/longhornio/longhorn-manager:v1.12.0|
|DaemonSet|longhorn-manager|pre-pull-share-manager-image|docker.io/longhornio/longhorn-share-manager:v1.12.0|
|Deployment|longhorn-driver-deployer|longhorn-driver-deployer|docker.io/longhornio/longhorn-manager:v1.12.0|
|Job|longhorn-post-upgrade|longhorn-post-upgrade|docker.io/longhornio/longhorn-manager:v1.12.0|
|Job|longhorn-pre-upgrade|longhorn-pre-upgrade|docker.io/longhornio/longhorn-manager:v1.12.0|
|Job|longhorn-uninstall|longhorn-uninstall|docker.io/longhornio/longhorn-manager:v1.12.0|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|longhorn-ui|longhorn-ui|docker.io/longhornio/longhorn-ui:v1.12.0|
