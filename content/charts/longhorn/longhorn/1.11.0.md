...
| ---------- | ------------------------ | ---------------------------- | --------------------------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager             | docker.io/longhornio/longhorn-manager:v1.11.0       |
| DaemonSet  | longhorn-manager         | pre-pull-share-manager-image | docker.io/longhornio/longhorn-share-manager:v1.11.0 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer     | docker.io/longhornio/longhorn-manager:v1.11.0       |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade        | docker.io/longhornio/longhorn-manager:v1.11.0       |
| Job        | longhorn-pre-upgrade     | longhorn-pre-upgrade         | docker.io/longhornio/longhorn-manager:v1.11.0       |
| Job        | longhorn-uninstall       | longhorn-uninstall           | docker.io/longhornio/longhorn-manager:v1.11.0       |
...
| Kind       | Name        | Container   | Image                                    |
| ---------- | ----------- | ----------- | ---------------------------------------- |
| Deployment | longhorn-ui | longhorn-ui | docker.io/longhornio/longhorn-ui:v1.11.0 |
