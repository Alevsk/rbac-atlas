...
tags: [BindingToPrivilegedRole, CRDManipulation, ClusterAdminAccess, ClusterWideAccess, ClusterWideLogAccess, ClusterWideSecretAccess, ConfigMapAccess, ControlPlaneDisruption, CredentialAccess, CriticalNamespace, DataExposure, DataLoss, DenialOfService, IdentityManagement, InformationDisclosure, LateralMovement, LogAccess, NamespaceAdmin, NamespaceWideAccess, NetworkManipulation, NodeAccess, OperationalData, Persistence, PotentialPrivilegeEscalation, PrivilegeEscalation, RBACManipulation, RBACQuery, Reconnaissance, ResourceDeletion, SecretAccess, ServiceExposure, StorageDetailsDisclosure, StorageManipulation, Tampering, TrafficRedirection, WildcardPermission, WorkloadExecution, WorkloadLifecycle, letter-L]
---
## Description
...
|---|---|---|---|---|---|---|
|[`longhorn-service-account`](#sa-longhorn-service-account)|default|❌|—|115|6|{{< risk "Critical" >}}|
...
|Role `longhorn`|core/configmaps|*|{{< risk High >}}|{{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} (+3 more)|
...
|ClusterRole `longhorn-role`|longhorn.io/enginefrontends|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `longhorn-role`|longhorn.io/enginefrontends/status|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `longhorn-role`|longhorn.io/shardgroups|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `longhorn-role`|longhorn.io/shardgroups/status|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `longhorn-role`|longhorn.io/shards|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
|ClusterRole `longhorn-role`|longhorn.io/shards/status|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `longhorn-role`|storage.k8s.io/volumeattributesclasses|*|{{< risk High >}}|{{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}|
...
|ClusterRole `longhorn-role`|apps/daemonsets|get · list · watch|{{< risk Low >}}||
...
|ClusterRole `longhorn-role`|apps/statefulsets|get · list · watch|{{< risk Low >}}||
...
|---|---|---|---|
|DaemonSet|longhorn-manager|longhorn-manager|docker.io/longhornio/longhorn-manager:v1.12.1|
|DaemonSet|longhorn-manager|pre-pull-share-manager-image|docker.io/longhornio/longhorn-share-manager:v1.12.1|
|Deployment|longhorn-driver-deployer|longhorn-driver-deployer|docker.io/longhornio/longhorn-manager:v1.12.1|
|Job|longhorn-post-upgrade|longhorn-post-upgrade|docker.io/longhornio/longhorn-manager:v1.12.1|
|Job|longhorn-pre-upgrade|longhorn-pre-upgrade|docker.io/longhornio/longhorn-manager:v1.12.1|
|Job|longhorn-uninstall|longhorn-uninstall|docker.io/longhornio/longhorn-manager:v1.12.1|
...
|Kind|Name|Container|Image|
|---|---|---|---|
|Deployment|longhorn-ui|longhorn-ui|docker.io/longhornio/longhorn-ui:v1.12.1|
