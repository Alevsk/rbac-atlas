...
| ---------- | ------------------------ | ---------------------------- | --------------------------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager             | docker.io/longhornio/longhorn-manager:v1.10.2       |
| DaemonSet  | longhorn-manager         | pre-pull-share-manager-image | docker.io/longhornio/longhorn-share-manager:v1.10.2 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer     | docker.io/longhornio/longhorn-manager:v1.10.2       |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade        | docker.io/longhornio/longhorn-manager:v1.10.2       |
| Job        | longhorn-pre-upgrade     | longhorn-pre-upgrade         | docker.io/longhornio/longhorn-manager:v1.10.2       |
| Job        | longhorn-uninstall       | longhorn-uninstall           | docker.io/longhornio/longhorn-manager:v1.10.2       |
...
| Kind       | Name        | Container   | Image                                    |
| ---------- | ----------- | ----------- | ---------------------------------------- |
| Deployment | longhorn-ui | longhorn-ui | docker.io/longhornio/longhorn-ui:v1.10.2 |
