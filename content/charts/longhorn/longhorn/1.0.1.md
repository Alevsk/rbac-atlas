...
| ---------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`longhorn-service-account`](#sa-longhorn-service-account) | default   | ❌        | —       | 38          | 4         | {{< risk "Critical" >}} |
...
| ---------- | ------------------------ | ------------------------ | ---------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager         | longhornio/longhorn-manager:v1.0.1 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer | longhornio/longhorn-manager:v1.0.1 |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade    | longhornio/longhorn-manager:v1.0.1 |
| Job        | longhorn-uninstall       | longhorn-uninstall       | longhornio/longhorn-manager:v1.0.1 |
