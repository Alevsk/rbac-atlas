...
| ---------- | --------------------------- | --------------------------- | ---------------------------------- |
| DaemonSet  | longhorn-manager            | longhorn-manager            | longhornio/longhorn-manager:v1.3.0 |
| Deployment | longhorn-admission-webhook  | longhorn-admission-webhook  | longhornio/longhorn-manager:v1.3.0 |
| Deployment | longhorn-conversion-webhook | longhorn-conversion-webhook | longhornio/longhorn-manager:v1.3.0 |
| Deployment | longhorn-driver-deployer    | longhorn-driver-deployer    | longhornio/longhorn-manager:v1.3.0 |
| Job        | longhorn-post-upgrade       | longhorn-post-upgrade       | longhornio/longhorn-manager:v1.3.0 |
| Job        | longhorn-uninstall          | longhorn-uninstall          | longhornio/longhorn-manager:v1.3.0 |
