...
medium_findings: 2
low_findings: 4
categories: [longhorn, storage, distributed, block, device, iscsi]
tags:
  [
    CRDManipulation,
    ClusterWideAccess,
...
| ---------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`longhorn-service-account`](#sa-longhorn-service-account) | default   | ❌        | —       | 39          | 4         | {{< risk "Critical" >}} |
...
| ClusterRole `longhorn-role` | coordination.k8s.io/leases                                   | \* · create · delete · get · list · update · watch | {{< risk Critical >}} | {{< tag "ClusterWideAccess" >}} {{< tag "ControlPlaneDisruption" >}} {{< tag "CriticalNamespace" >}} {{< tag "DenialOfService" >}} {{< tag "LeaderElectionAbuse" >}} (+2 more)    |
...
| ---------- | ------------------------ | ------------------------ | ---------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager         | longhornio/longhorn-manager:v1.0.2 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer | longhornio/longhorn-manager:v1.0.2 |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade    | longhornio/longhorn-manager:v1.0.2 |
| Job        | longhorn-uninstall       | longhorn-uninstall       | longhornio/longhorn-manager:v1.0.2 |
