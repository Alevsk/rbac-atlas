...
| ---------- | ------------------------ | ---------------------------- | ----------------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager             | longhornio/longhorn-manager:v1.10.1       |
| DaemonSet  | longhorn-manager         | pre-pull-share-manager-image | longhornio/longhorn-share-manager:v1.10.1 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer     | longhornio/longhorn-manager:v1.10.1       |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade        | longhornio/longhorn-manager:v1.10.1       |
| Job        | longhorn-pre-upgrade     | longhorn-pre-upgrade         | longhornio/longhorn-manager:v1.10.1       |
| Job        | longhorn-uninstall       | longhorn-uninstall           | longhornio/longhorn-manager:v1.10.1       |
...
| Kind       | Name        | Container   | Image                          |
| ---------- | ----------- | ----------- | ------------------------------ |
| Deployment | longhorn-ui | longhorn-ui | longhornio/longhorn-ui:v1.10.1 |
