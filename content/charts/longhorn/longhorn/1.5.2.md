...
| ---------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`longhorn-service-account`](#sa-longhorn-service-account) | default   | ❌        | —       | 83          | 5         | {{< risk "Critical" >}} |
...
| ---------- | ------------------------ | ------------------------ | ---------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager         | longhornio/longhorn-manager:v1.5.2 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer | longhornio/longhorn-manager:v1.5.2 |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade    | longhornio/longhorn-manager:v1.5.2 |
| Job        | longhorn-pre-upgrade     | longhorn-pre-upgrade     | longhornio/longhorn-manager:v1.5.2 |
| Job        | longhorn-uninstall       | longhorn-uninstall       | longhornio/longhorn-manager:v1.5.2 |
