...
| ---------- | --------------------------- | --------------------------- | ---------------------------------- |
| DaemonSet  | longhorn-manager            | longhorn-manager            | longhornio/longhorn-manager:v1.4.3 |
| Deployment | longhorn-admission-webhook  | longhorn-admission-webhook  | longhornio/longhorn-manager:v1.4.3 |
| Deployment | longhorn-conversion-webhook | longhorn-conversion-webhook | longhornio/longhorn-manager:v1.4.3 |
| Deployment | longhorn-driver-deployer    | longhorn-driver-deployer    | longhornio/longhorn-manager:v1.4.3 |
| Deployment | longhorn-recovery-backend   | longhorn-recovery-backend   | longhornio/longhorn-manager:v1.4.3 |
| Job        | longhorn-post-upgrade       | longhorn-post-upgrade       | longhornio/longhorn-manager:v1.4.3 |
| Job        | longhorn-uninstall          | longhorn-uninstall          | longhornio/longhorn-manager:v1.4.3 |
