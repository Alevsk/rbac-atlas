...
| ---------------------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`longhorn-service-account`](#sa-longhorn-service-account)       | default   | ❌        | —       | 85          | 5         | {{< risk "Critical" >}} |
...
| ---------- | ------------------------ | ------------------------ | ---------------------------------- |
| DaemonSet  | longhorn-manager         | longhorn-manager         | longhornio/longhorn-manager:v1.6.4 |
| Deployment | longhorn-driver-deployer | longhorn-driver-deployer | longhornio/longhorn-manager:v1.6.4 |
| Job        | longhorn-post-upgrade    | longhorn-post-upgrade    | longhornio/longhorn-manager:v1.6.4 |
| Job        | longhorn-pre-upgrade     | longhorn-pre-upgrade     | longhornio/longhorn-manager:v1.6.4 |
| Job        | longhorn-uninstall       | longhorn-uninstall       | longhornio/longhorn-manager:v1.6.4 |
...
| Kind       | Name        | Container   | Image                         |
| ---------- | ----------- | ----------- | ----------------------------- |
| Deployment | longhorn-ui | longhorn-ui | longhornio/longhorn-ui:v1.6.4 |
