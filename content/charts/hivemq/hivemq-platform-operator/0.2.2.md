...
| ------------------------------------------------------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`hivemq-platform-operator-hivemq-platform-operator`](#sa-hivemq-platform-operator-hivemq-platform-operator) | default   | ❌        | —       | 13          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ------------------------------- | ------------------------ | ----------------------------------------------- |
| Deployment | hivemq-hivemq-platform-operator | hivemq-platform-operator | docker.io/hivemq/hivemq-platform-operator:1.1.0 |
