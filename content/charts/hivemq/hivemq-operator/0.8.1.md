...
| Kind       | Name                     | Container | Image                        |
| ---------- | ------------------------ | --------- | ---------------------------- |
| Deployment | hivemq-operator-operator | operator  | hivemq/hivemq-operator:4.5.0 |
...
| Kind | Name                             | Container | Image                               |
| ---- | -------------------------------- | --------- | ----------------------------------- |
| Job  | hivemq-operator-admission-create | create    | jettech/kube-webhook-certgen:v1.5.1 |
| Job  | hivemq-operator-admission-patch  | patch     | jettech/kube-webhook-certgen:v1.5.1 |
