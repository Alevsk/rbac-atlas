...
medium_findings: 3
low_findings: 61
categories: [MQTT, IoT, Java, distributed]
tags:
  [
    AuthorizationBypass,
    CRDManipulation,
...
| [`hivemq-operator-operator`](#sa-hivemq-operator-operator)                                 | default   | ❌        | —       | 21          | 1         | {{< risk "Critical" >}} |
| [`hivemq-operator-prometheus-operator`](#sa-hivemq-operator-prometheus-operator)           | default   | ❌        | —       | 20          | 2         | {{< risk "Critical" >}} |
| [`hivemq-operator-prometheus-prometheus`](#sa-hivemq-operator-prometheus-prometheus)       | default   | ❌        | —       | 9           | 0         | {{< risk "Critical" >}} |
| [`hivemq-operator-grafana-test`](#sa-hivemq-operator-grafana-test)                         | default   | ❌        | —       | 1           | 1         | {{< risk "Low" >}}      |
| [`hivemq-operator-prometheus-admission`](#sa-hivemq-operator-prometheus-admission)         | default   | ❌        | —       | 4           | 2         | {{< risk "Low" >}}      |
| [`hivemq-operator-prometheus-alertmanager`](#sa-hivemq-operator-prometheus-alertmanager)   | default   | ❌        | —       | 1           | 0         | {{< risk "Low" >}}      |
...
| Kind       | Name                     | Container | Image                        |
| ---------- | ------------------------ | --------- | ---------------------------- |
| Deployment | hivemq-operator-operator | operator  | hivemq/hivemq-operator:0.3.1 |

---

### 🤖 `hivemq-operator-prometheus-operator` {#sa-hivemq-operator-prometheus-operator}
...
| Role                                                  | Resource                                                                            | Verbs                          | Risk                  | Tags                                                                                                                                                                              |
| ----------------------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------ | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `hivemq-operator-prometheus-operator`     | core/configmaps                                                                     | \*                             | {{< risk Critical >}} | {{< tag "ClusterWideAccess" >}} {{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} {{< tag "PotentialPrivilegeEscalation" >}} (+2 more) |
| ClusterRole `hivemq-operator-prometheus-operator`     | apiextensions.k8s.io/customresourcedefinitions                                      | \*                             | {{< risk Critical >}} | {{< tag "CRDManipulation" >}} {{< tag "ClusterWideAccess" >}} {{< tag "PotentialPrivilegeEscalation" >}} {{< tag "Tampering" >}} {{< tag "WildcardPermission" >}}                 |
| ClusterRole `hivemq-operator-prometheus-operator`     | core/secrets                                                                        | \*                             | {{< risk Critical >}} | {{< tag "ClusterWideAccess" >}} {{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} (+6 more)     |
| ClusterRole `hivemq-operator-prometheus-operator`     | apps/statefulsets                                                                   | \*                             | {{< risk Critical >}} | {{< tag "ClusterWideAccess" >}} {{< tag "Persistence" >}} {{< tag "PotentialPrivilegeEscalation" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "Tampering" >}} (+2 more)          |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/alertmanagers                                                 | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/alertmanagers/finalizers                                      | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/podmonitors                                                   | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/prometheuses                                                  | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/prometheuses/finalizers                                       | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/prometheusrules                                               | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/servicemonitors                                               | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/thanosrulers                                                  | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | monitoring.coreos.com/thanosrulers/finalizers                                       | \*                             | {{< risk High >}}     | {{< tag "ClusterWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                                                                  |
| ClusterRole `hivemq-operator-prometheus-operator`     | core/endpoints                                                                      | create · delete · get · update | {{< risk Low >}}      |                                                                                                                                                                                   |
| ClusterRole `hivemq-operator-prometheus-operator`     | core/namespaces                                                                     | get · list · watch             | {{< risk Low >}}      | {{< tag "ClusterStructure" >}} {{< tag "InformationDisclosure" >}} {{< tag "Reconnaissance" >}}                                                                                   |
| ClusterRole `hivemq-operator-prometheus-operator`     | core/nodes                                                                          | list · watch                   | {{< risk Low >}}      |                                                                                                                                                                                   |
| ClusterRole `hivemq-operator-prometheus-operator`     | core/pods                                                                           | delete · list                  | {{< risk Low >}}      |                                                                                                                                                                                   |
| ClusterRole `hivemq-operator-prometheus-operator`     | core/services                                                                       | create · delete · get · update | {{< risk Low >}}      |                                                                                                                                                                                   |
| ClusterRole `hivemq-operator-prometheus-operator`     | core/services/finalizers                                                            | create · delete · get · update | {{< risk Low >}}      |                                                                                                                                                                                   |
| ClusterRole `hivemq-operator-prometheus-operator-psp` | policy/podsecuritypolicies **(restricted to: hivemq-operator-prometheus-operator)** | use                            | {{< risk Low >}}      | {{< tag "DeprecatedFeature" >}} {{< tag "NodeAccess" >}} {{< tag "PodSecurityPolicy" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "ResourceNameRestricted" >}}                   |
...
| Kind       | Name                                | Container           | Image                                      |
| ---------- | ----------------------------------- | ------------------- | ------------------------------------------ |
| Deployment | hivemq-operator-prometheus-operator | prometheus-operator | quay.io/coreos/prometheus-operator:v0.38.1 |
| Deployment | hivemq-operator-prometheus-operator | tls-proxy           | squareup/ghostunnel:v1.5.2                 |

---

### 🤖 `hivemq-operator-prometheus-prometheus` {#sa-hivemq-operator-prometheus-prometheus}
...
| Role                                                    | Resource                                                                              | Verbs              | Risk                  | Tags                                                                                                                                                                      |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------ | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `hivemq-operator-prometheus-prometheus`     | core/nodes/proxy                                                                      | get · list · watch | {{< risk Critical >}} | {{< tag "AuthorizationBypass" >}} {{< tag "ClusterAdminAccess" >}} {{< tag "CodeExecution" >}} {{< tag "ElevationOfPrivilege" >}} {{< tag "LateralMovement" >}} (+1 more) |
| ClusterRole `hivemq-operator-prometheus-prometheus`     | core/endpoints                                                                        | get · list · watch | {{< risk Low >}}      |                                                                                                                                                                           |
| ClusterRole `hivemq-operator-prometheus-prometheus`     | extensions/ingresses                                                                  | get · list · watch | {{< risk Low >}}      |                                                                                                                                                                           |
| ClusterRole `hivemq-operator-prometheus-prometheus`     | networking.k8s.io/ingresses                                                           | get · list · watch | {{< risk Low >}}      |                                                                                                                                                                           |
| ClusterRole `hivemq-operator-prometheus-prometheus`     | core/nodes                                                                            | get · list · watch | {{< risk Low >}}      |                                                                                                                                                                           |
| ClusterRole `hivemq-operator-prometheus-prometheus`     | core/nodes/metrics                                                                    | get · list · watch | {{< risk Low >}}      |                                                                                                                                                                           |
| ClusterRole `hivemq-operator-prometheus-prometheus`     | core/pods                                                                             | get · list · watch | {{< risk Low >}}      |                                                                                                                                                                           |
| ClusterRole `hivemq-operator-prometheus-prometheus`     | core/services                                                                         | get · list · watch | {{< risk Low >}}      |                                                                                                                                                                           |
| ClusterRole `hivemq-operator-prometheus-prometheus-psp` | policy/podsecuritypolicies **(restricted to: hivemq-operator-prometheus-prometheus)** | use                | {{< risk Low >}}      | {{< tag "DeprecatedFeature" >}} {{< tag "NodeAccess" >}} {{< tag "PodSecurityPolicy" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "ResourceNameRestricted" >}}           |
...
| Kind       | Name                    | Container            | Image                        |
| ---------- | ----------------------- | -------------------- | ---------------------------- |
| Deployment | hivemq-operator-grafana | grafana              | grafana/grafana:7.0.3        |
| Deployment | hivemq-operator-grafana | grafana-sc-dashboard | kiwigrid/k8s-sidecar:0.1.151 |

---

### 🤖 `hivemq-operator-prometheus-admission` {#sa-hivemq-operator-prometheus-admission}
...
| Role                                               | Resource                                                                             | Verbs        | Risk             | Tags                                                                                                                                                            |
| -------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------ | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `hivemq-operator-prometheus-admission` | admissionregistration.k8s.io/mutatingwebhookconfigurations                           | get · update | {{< risk Low >}} |                                                                                                                                                                 |
| Role `hivemq-operator-prometheus-admission`        | core/secrets                                                                         | create · get | {{< risk Low >}} |                                                                                                                                                                 |
| ClusterRole `hivemq-operator-prometheus-admission` | admissionregistration.k8s.io/validatingwebhookconfigurations                         | get · update | {{< risk Low >}} |                                                                                                                                                                 |
| ClusterRole `hivemq-operator-prometheus-admission` | policy/podsecuritypolicies **(restricted to: hivemq-operator-prometheus-admission)** | use          | {{< risk Low >}} | {{< tag "DeprecatedFeature" >}} {{< tag "NodeAccess" >}} {{< tag "PodSecurityPolicy" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "ResourceNameRestricted" >}} |
...
| Kind | Name                                        | Container | Image                               |
| ---- | ------------------------------------------- | --------- | ----------------------------------- |
| Job  | hivemq-operator-prometheus-admission-create | create    | jettech/kube-webhook-certgen:v1.2.1 |
| Job  | hivemq-operator-prometheus-admission-patch  | patch     | jettech/kube-webhook-certgen:v1.2.1 |
...
### 🤖 `hivemq-operator-prometheus-alertmanager` {#sa-hivemq-operator-prometheus-alertmanager}
...
| Role                                           | Resource                                                                                | Verbs | Risk             | Tags                                 |
| ---------------------------------------------- | --------------------------------------------------------------------------------------- | ----- | ---------------- | ------------------------------------ |
| Role `hivemq-operator-prometheus-alertmanager` | policy/podsecuritypolicies **(restricted to: hivemq-operator-prometheus-alertmanager)** | use   | {{< risk Low >}} | {{< tag "ResourceNameRestricted" >}} |
...
| Kind      | Name                                     | Container     | Image                                   |
| --------- | ---------------------------------------- | ------------- | --------------------------------------- |
| DaemonSet | hivemq-operator-prometheus-node-exporter | node-exporter | quay.io/prometheus/node-exporter:v1.0.0 |
