...
| ---------- | ---------------------- | --------------- | -------------------------------------- |
| Deployment | hcp-terraform-operator | kube-rbac-proxy | quay.io/brancz/kube-rbac-proxy:v0.18.2 |
| Deployment | hcp-terraform-operator | manager         | hashicorp/hcp-terraform-operator:2.7.1 |
