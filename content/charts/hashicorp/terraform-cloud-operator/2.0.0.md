...
Official Helm chart for HashiCorp Terraform Cloud Kubernetes Operator.

## Overview

| Identity                                                                                         | Namespace | Automount | Secrets | Permissions | Workloads | Risk                    |
| ------------------------------------------------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`terraform-cloud-operator-controller-manager`](#sa-terraform-cloud-operator-controller-manager) | default   | ❌        | —       | 18          | 2         | {{< risk "Critical" >}} |
...
| ---------- | ------------------------ | --------------- | ---------------------------------------- |
| Deployment | terraform-cloud-operator | kube-rbac-proxy | quay.io/brancz/kube-rbac-proxy:v0.14.4   |
| Deployment | terraform-cloud-operator | manager         | hashicorp/terraform-cloud-operator:2.0.0 |
