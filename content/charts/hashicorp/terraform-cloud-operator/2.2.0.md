...
| ---------- | ------------------------ | --------------- | ---------------------------------------- |
| Deployment | terraform-cloud-operator | kube-rbac-proxy | quay.io/brancz/kube-rbac-proxy:v0.15.0   |
| Deployment | terraform-cloud-operator | manager         | hashicorp/terraform-cloud-operator:2.2.0 |
