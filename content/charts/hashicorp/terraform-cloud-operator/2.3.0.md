...
| ---------- | ------------------------ | --------------- | ---------------------------------------- |
| Deployment | terraform-cloud-operator | kube-rbac-proxy | quay.io/brancz/kube-rbac-proxy:v0.16.0   |
| Deployment | terraform-cloud-operator | manager         | hashicorp/terraform-cloud-operator:2.3.0 |
