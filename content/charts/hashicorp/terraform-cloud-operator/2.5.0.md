...
| ClusterRole `terraform-cloud-operator-manager-role`  | core/configmaps                           | create · list · update · watch                        | {{< risk Low >}}      |                                                                                                                                                                 |
...
| ClusterRole `terraform-cloud-operator-manager-role`  | core/secrets                              | create · list · update · watch                        | {{< risk Low >}}      |                                                                                                                                                                 |
