...
| Deployment | vault-secrets-operator-controller-manager            | manager                       | hashicorp/vault-secrets-operator:0.4.0     |
| Job        | vault-secrets-operator-pre-delete-controller-cleanup | pre-delete-controller-cleanup | hashicorp/vault-secrets-operator:0.4.0     |
