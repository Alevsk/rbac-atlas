...
| Deployment | vault-secrets-operator-controller-manager | manager                       | hashicorp/vault-secrets-operator:0.6.0     |
| Job        | pdcc-vault-secrets-operator               | pre-delete-controller-cleanup | hashicorp/vault-secrets-operator:0.6.0     |
