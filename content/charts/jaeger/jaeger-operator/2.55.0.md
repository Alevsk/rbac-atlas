...
| Role `jaeger-operator` | extensions/ingressclasses                     | create · delete · get · list · patch · update · watch | {{< risk Low >}}      |                                                                                                                                                                              |
...
| ---------- | --------------- | --------------- | ------------------------------------ |
| Deployment | jaeger-operator | jaeger-operator | jaegertracing/jaeger-operator:1.57.0 |
