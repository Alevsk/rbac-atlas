...
| ---------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`jaeger-operator`](#sa-jaeger-operator) | default   | ❌        | —       | 26          | 1         | {{< risk "Critical" >}} |
...
| Role `jaeger-operator` | jaegertracing.io/\*                                              | create · delete · get · list · patch · update · watch | {{< risk Medium >}}   | {{< tag "NamespaceAdmin" >}} {{< tag "NamespaceWideAccess" >}} {{< tag "WildcardPermission" >}}                                                                              |
...
| Role `jaeger-operator` | core/namespaces                                                  | get · list · watch                                    | {{< risk Low >}}      |                                                                                                                                                                              |
...
| ---------- | --------------- | --------------- | ------------------------------------ |
| Deployment | jaeger-operator | jaeger-operator | jaegertracing/jaeger-operator:1.24.0 |
