...
| -------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`cloudnative-pg`](#sa-cloudnative-pg) | default   | ❌        | —       | 34          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `cloudnative-pg` | admissionregistration.k8s.io/mutatingwebhookconfigurations   | get · list · patch · update                           | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ClusterRole `cloudnative-pg` | admissionregistration.k8s.io/validatingwebhookconfigurations | get · list · patch · update                           | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ---------- | -------------- | --------- | -------------------------------------------- |
| Deployment | cloudnative-pg | manager   | ghcr.io/cloudnative-pg/cloudnative-pg:1.21.1 |
