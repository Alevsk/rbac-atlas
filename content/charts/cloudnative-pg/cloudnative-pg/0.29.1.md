...
tags: [AvailabilityImpact, ClusterWidePodExec, ClusterWideSecretAccess, CodeExecution, ConfigMapAccess, CredentialAccess, DataExposure, DenialOfService, ElevationOfPrivilege, InformationDisclosure, LateralMovement, NetworkManipulation, Persistence, PodExec, PotentialPrivilegeEscalation, PrivilegeEscalation, RBACQuery, Reconnaissance, SecretAccess, ServiceExposure, Tampering, WorkloadExecution, WorkloadLifecycle, letter-C]
---
## Description
...
|---|---|---|---|---|---|---|
|[`cloudnative-pg`](#sa-cloudnative-pg)|default|❌|—|46|1|{{< risk "Critical" >}}|
...
|ClusterRole `cloudnative-pg`|postgresql.cnpg.io/databaseroles|create · delete · get · list · patch · update · watch|{{< risk Low >}}||
|ClusterRole `cloudnative-pg`|postgresql.cnpg.io/databaseroles/finalizers|update|{{< risk Low >}}||
|ClusterRole `cloudnative-pg`|postgresql.cnpg.io/databaseroles/status|get · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `cloudnative-pg`|discovery.k8s.io/endpointslices|get · list · watch|{{< risk Low >}}||
|ClusterRole `cloudnative-pg`|core/events|create · patch|{{< risk Low >}}||
|ClusterRole `cloudnative-pg`|postgresql.cnpg.io/failoverquorums|create · delete · get · list · watch|{{< risk Low >}}||
|ClusterRole `cloudnative-pg`|postgresql.cnpg.io/failoverquorums/status|get · patch · update · watch|{{< risk Low >}}||
...
|ClusterRole `cloudnative-pg`|coordination.k8s.io/leases|create · get · list · update · watch|{{< risk Low >}}||
...
|---|---|---|---|
|Deployment|cloudnative-pg|manager|ghcr.io/cloudnative-pg/cloudnative-pg:1.30.1|
