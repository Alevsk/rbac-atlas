...
| ------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`bitwarden-crd-operator`](#sa-bitwarden-crd-operator) | default   | ❌        | —       | 9           | 1         | {{< risk "Critical" >}} |
...
| ---------- | ---------------------- | ---------------------- | ------------------------------------- |
| Deployment | bitwarden-crd-operator | bitwarden-crd-operator | lerentis/bitwarden-crd-operator:0.1.2 |
