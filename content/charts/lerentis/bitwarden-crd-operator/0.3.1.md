...
| ------------------------------------------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`bitwarden-crd-operator`](#sa-bitwarden-crd-operator) | default   | ❌        | —       | 10          | 1         | {{< risk "Critical" >}} |
...
| ---------- | ---------------------- | ---------------------- | ------------------------------------- |
| Deployment | bitwarden-crd-operator | bitwarden-crd-operator | lerentis/bitwarden-crd-operator:0.2.1 |
