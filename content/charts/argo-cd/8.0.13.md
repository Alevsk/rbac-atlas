...
| ----------------------------------- | --------------------------- | ----------------------------------------------------- | --------------------- |
| Role `argo-cd-argocd-server`        | core/secrets                | create · delete · get · list · patch · update · watch | {{< risk Critical >}} |
| ClusterRole `argo-cd-argocd-server` | _/_                         | delete · get · patch                                  | {{< risk High >}}     |
| ClusterRole `argo-cd-argocd-server` | core/pods/log               | get                                                   | {{< risk High >}}     |
| Role `argo-cd-argocd-server`        | core/configmaps             | create · delete · get · list · patch · update · watch | {{< risk High >}}     |
...
| Role                                            | Resource                               | Verbs                                                 | Risk                  |
| ----------------------------------------------- | -------------------------------------- | ----------------------------------------------------- | --------------------- |
| Role `argo-cd-argocd-applicationset-controller` | core/secrets                           | get · list · watch                                    | {{< risk Critical >}} |
| Role `argo-cd-argocd-applicationset-controller` | coordination.k8s.io/leases             | create · delete · get · list · patch · update · watch | {{< risk Critical >}} |
| Role `argo-cd-argocd-applicationset-controller` | core/configmaps                        | create · delete · get · list · patch · update · watch | {{< risk High >}}     |
...
| Role                                                | Resource                    | Verbs                                                 | Risk                  |
| --------------------------------------------------- | --------------------------- | ----------------------------------------------------- | --------------------- |
| ClusterRole `argo-cd-argocd-application-controller` | _/_                         | \*                                                    | {{< risk Critical >}} |
| Role `argo-cd-argocd-application-controller`        | core/secrets                | get · list · watch                                    | {{< risk Critical >}} |
| Role `argo-cd-argocd-application-controller`        | core/configmaps             | get · list · watch                                    | {{< risk Medium >}}   |
...
| Role                                                  | Resource                 | Verbs                               | Risk                  |
| ----------------------------------------------------- | ------------------------ | ----------------------------------- | --------------------- |
| ClusterRole `argo-cd-argocd-notifications-controller` | core/secrets             | get · list · watch                  | {{< risk Critical >}} |
| Role `argo-cd-argocd-notifications-controller`        | core/secrets             | get · list · watch                  | {{< risk Critical >}} |
| ClusterRole `argo-cd-argocd-notifications-controller` | core/configmaps          | get · list · watch                  | {{< risk High >}}     |
| Role `argo-cd-argocd-notifications-controller`        | core/configmaps          | get · list · watch                  | {{< risk Medium >}}   |
...
| Role                             | Resource        | Verbs              | Risk                  |
| -------------------------------- | --------------- | ------------------ | --------------------- |
| Role `argo-cd-argocd-dex-server` | core/secrets    | get · list · watch | {{< risk Critical >}} |
| Role `argo-cd-argocd-dex-server` | core/configmaps | get · list · watch | {{< risk Medium >}}   |
