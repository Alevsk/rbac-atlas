...
| ----------------------------------- | --------------------------- | ----------------------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Role `argo-cd-argocd-server`        | core/secrets                | create · delete · get · list · patch · update · watch | {{< risk Critical >}} | {{< tag "SecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} |
| ClusterRole `argo-cd-argocd-server` | _/_                         | delete · get · patch                                  | {{< risk High >}}     | {{< tag "ClusterWideLogAccess" >}} {{< tag "InformationDisclosure" >}} {{< tag "DataExposure" >}}                        |
| ClusterRole `argo-cd-argocd-server` | core/pods/log               | get                                                   | {{< risk High >}}     | {{< tag "ClusterWideLogAccess" >}} {{< tag "InformationDisclosure" >}} {{< tag "DataExposure" >}}                        |
| Role `argo-cd-argocd-server`        | core/configmaps             | create · delete · get · list · patch · update · watch | {{< risk High >}}     | {{< tag "Tampering" >}} {{< tag "ConfigMapAccess" >}} {{< tag "PotentialPrivilegeEscalation" >}}                         |
...
| Role                                            | Resource                               | Verbs                                                 | Risk                  | Tags                                                                                                                       |
| ----------------------------------------------- | -------------------------------------- | ----------------------------------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Role `argo-cd-argocd-applicationset-controller` | coordination.k8s.io/leases             | create · delete · get · list · patch · update · watch | {{< risk Critical >}} | {{< tag "Tampering" >}} {{< tag "DenialOfService" >}} {{< tag "ControlPlaneDisruption" >}} {{< tag "CriticalNamespace" >}} |
| Role `argo-cd-argocd-applicationset-controller` | core/secrets                           | get · list · watch                                    | {{< risk Critical >}} | {{< tag "SecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}   |
| Role `argo-cd-argocd-applicationset-controller` | core/configmaps                        | create · delete · get · list · patch · update · watch | {{< risk High >}}     | {{< tag "Tampering" >}} {{< tag "ConfigMapAccess" >}} {{< tag "PotentialPrivilegeEscalation" >}}                           |
...
| Role                                                | Resource                    | Verbs                                                 | Risk                  | Tags                                                                                                                                                                                                                 |
| --------------------------------------------------- | --------------------------- | ----------------------------------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `argo-cd-argocd-application-controller` | _/_                         | \*                                                    | {{< risk Critical >}} | {{< tag "ClusterAdminAccess" >}} {{< tag "PrivilegeEscalation" >}} {{< tag "WildcardPermission" >}} {{< tag "Tampering" >}} {{< tag "InformationDisclosure" >}} {{< tag "DenialOfService" >}} {{< tag "Spoofing" >}} |
| Role `argo-cd-argocd-application-controller`        | core/secrets                | get · list · watch                                    | {{< risk Critical >}} | {{< tag "SecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}                                                                                             |
| Role `argo-cd-argocd-application-controller`        | core/configmaps             | get · list · watch                                    | {{< risk Medium >}}   | {{< tag "InformationDisclosure" >}} {{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}}                                                                                                                         |
...
| Role                                                  | Resource                 | Verbs                               | Risk                  | Tags                                                                                                                                |
| ----------------------------------------------------- | ------------------------ | ----------------------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| ClusterRole `argo-cd-argocd-notifications-controller` | core/secrets             | get · list · watch                  | {{< risk Critical >}} | {{< tag "ClusterWideSecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} |
| Role `argo-cd-argocd-notifications-controller`        | core/secrets             | get · list · watch                  | {{< risk Critical >}} | {{< tag "SecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}}            |
| ClusterRole `argo-cd-argocd-notifications-controller` | core/configmaps          | get · list · watch                  | {{< risk High >}}     | {{< tag "InformationDisclosure" >}} {{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}}                                        |
| Role `argo-cd-argocd-notifications-controller`        | core/configmaps          | get · list · watch                  | {{< risk Medium >}}   | {{< tag "InformationDisclosure" >}} {{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}}                                        |
...
| Role                             | Resource        | Verbs              | Risk                  | Tags                                                                                                                     |
| -------------------------------- | --------------- | ------------------ | --------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Role `argo-cd-argocd-dex-server` | core/secrets    | get · list · watch | {{< risk Critical >}} | {{< tag "SecretAccess" >}} {{< tag "CredentialAccess" >}} {{< tag "DataExposure" >}} {{< tag "InformationDisclosure" >}} |
| Role `argo-cd-argocd-dex-server` | core/configmaps | get · list · watch | {{< risk Medium >}}   | {{< tag "InformationDisclosure" >}} {{< tag "ConfigMapAccess" >}} {{< tag "DataExposure" >}}                             |
