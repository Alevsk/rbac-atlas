...
| ClusterRole `k8up-manager` | rbac.authorization.k8s.io/rolebindings | create · delete · get · list                          | {{< risk Low >}}      |                                                                                                                                                                                |
| ClusterRole `k8up-manager` | rbac.authorization.k8s.io/roles        | create · delete · get · list                          | {{< risk Low >}}      |                                                                                                                                                                                |
...
| ClusterRole `k8up-manager` | core/serviceaccounts                   | create · delete · get · list                          | {{< risk Low >}}      |                                                                                                                                                                                |
...
| ---------- | ---- | ------------- | ----------------------- |
| Deployment | k8up | k8up-operator | ghcr.io/k8up-io/k8up:v2 |
