...
| ------------------ | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`k8up`](#sa-k8up) | default   | ❌        | —       | 35          | 1         | {{< risk "Critical" >}} |
...
| ClusterRole `k8up-manager` | batch/jobs/finalizers                  | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                                |
| ClusterRole `k8up-manager` | batch/jobs/status                      | get · patch · update                                  | {{< risk Low >}}      |                                                                                                                                                                                |
