...
| ---------- | --------------- | --------- | -------------------------------------- |
| Deployment | helm-controller | manager   | ghcr.io/fluxcd/helm-controller:v0.22.2 |
...
| Kind       | Name                        | Container | Image                                              |
| ---------- | --------------------------- | --------- | -------------------------------------------------- |
| Deployment | image-automation-controller | manager   | ghcr.io/fluxcd/image-automation-controller:v0.24.1 |
...
| Kind       | Name                       | Container | Image                                             |
| ---------- | -------------------------- | --------- | ------------------------------------------------- |
| Deployment | image-reflector-controller | manager   | ghcr.io/fluxcd/image-reflector-controller:v0.20.0 |
...
| Kind       | Name                 | Container | Image                                       |
| ---------- | -------------------- | --------- | ------------------------------------------- |
| Deployment | kustomize-controller | manager   | ghcr.io/fluxcd/kustomize-controller:v0.27.0 |
...
| Kind       | Name                    | Container | Image                                          |
| ---------- | ----------------------- | --------- | ---------------------------------------------- |
| Deployment | notification-controller | manager   | ghcr.io/fluxcd/notification-controller:v0.25.1 |
...
| Kind       | Name              | Container | Image                                    |
| ---------- | ----------------- | --------- | ---------------------------------------- |
| Deployment | source-controller | manager   | ghcr.io/fluxcd/source-controller:v0.26.1 |
...
| Kind | Name             | Container | Image                           |
| ---- | ---------------- | --------- | ------------------------------- |
| Job  | flux2-flux-check | flux-cli  | ghcr.io/fluxcd/flux-cli:v0.32.0 |
