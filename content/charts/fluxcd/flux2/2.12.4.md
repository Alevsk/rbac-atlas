...
| ---------- | --------------- | --------- | -------------------------------------- |
| Deployment | helm-controller | manager   | ghcr.io/fluxcd/helm-controller:v0.37.4 |
...
| Kind       | Name                        | Container | Image                                              |
| ---------- | --------------------------- | --------- | -------------------------------------------------- |
| Deployment | image-automation-controller | manager   | ghcr.io/fluxcd/image-automation-controller:v0.37.1 |
...
| Kind       | Name                       | Container | Image                                             |
| ---------- | -------------------------- | --------- | ------------------------------------------------- |
| Deployment | image-reflector-controller | manager   | ghcr.io/fluxcd/image-reflector-controller:v0.31.2 |
...
| Kind       | Name                 | Container | Image                                      |
| ---------- | -------------------- | --------- | ------------------------------------------ |
| Deployment | kustomize-controller | manager   | ghcr.io/fluxcd/kustomize-controller:v1.2.2 |
...
| Kind       | Name                    | Container | Image                                         |
| ---------- | ----------------------- | --------- | --------------------------------------------- |
| Deployment | notification-controller | manager   | ghcr.io/fluxcd/notification-controller:v1.2.4 |
...
| Kind       | Name              | Container | Image                                   |
| ---------- | ----------------- | --------- | --------------------------------------- |
| Deployment | source-controller | manager   | ghcr.io/fluxcd/source-controller:v1.2.4 |
...
| Kind | Name             | Container | Image                          |
| ---- | ---------------- | --------- | ------------------------------ |
| Job  | flux2-flux-check | flux-cli  | ghcr.io/fluxcd/flux-cli:v2.2.3 |
