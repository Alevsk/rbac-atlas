...
| ---------- | --------------- | --------- | ------------------------------ |
| Deployment | helm-controller | manager   | fluxcd/helm-controller:v0.12.1 |
...
| Kind       | Name                        | Container | Image                                      |
| ---------- | --------------------------- | --------- | ------------------------------------------ |
| Deployment | image-automation-controller | manager   | fluxcd/image-automation-controller:v0.16.0 |
...
| Kind       | Name                       | Container | Image                                     |
| ---------- | -------------------------- | --------- | ----------------------------------------- |
| Deployment | image-reflector-controller | manager   | fluxcd/image-reflector-controller:v0.13.0 |
...
| Kind       | Name                 | Container | Image                               |
| ---------- | -------------------- | --------- | ----------------------------------- |
| Deployment | kustomize-controller | manager   | fluxcd/kustomize-controller:v0.16.0 |
...
| Kind       | Name                    | Container | Image                                  |
| ---------- | ----------------------- | --------- | -------------------------------------- |
| Deployment | notification-controller | manager   | fluxcd/notification-controller:v0.18.1 |
...
| Kind       | Name              | Container | Image                            |
| ---------- | ----------------- | --------- | -------------------------------- |
| Deployment | source-controller | manager   | fluxcd/source-controller:v0.17.1 |
