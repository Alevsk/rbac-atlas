...
| -------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`cilium`](#sa-cilium)                             | default   | ❌        | —       | 40          | 3         | {{< risk "Critical" >}} |
...
| ClusterRole `cilium`            | extensions/ingresses                              | create · get · list · watch          | {{< risk Low >}}      |                                                                                                                                                                         |
| ClusterRole `cilium-pre-flight` | extensions/ingresses                              | create · get · list · watch          | {{< risk Low >}}      |                                                                                                                                                                         |
...
| ---------- | ----------------------- | ----------------------- | ----------------------------- |
| DaemonSet  | cilium                  | cilium-agent            | quay.io/cilium/cilium:v1.7.13 |
| DaemonSet  | cilium-pre-flight-check | cilium-pre-flight-check | quay.io/cilium/cilium:v1.7.13 |
| Deployment | cilium-pre-flight-check | cnp-validator           | quay.io/cilium/cilium:v1.7.13 |
...
| ClusterRole `cilium-operator` | core/nodes                                        | get · list · watch          | {{< risk Low >}}      |                                                                                                                                                                         |
...
| Kind       | Name            | Container       | Image                           |
| ---------- | --------------- | --------------- | ------------------------------- |
| Deployment | cilium-operator | cilium-operator | quay.io/cilium/operator:v1.7.13 |
