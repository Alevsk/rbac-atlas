...
| --------- | ----------------------- | ----------------------- | ------------------------------ |
| DaemonSet | cilium                  | cilium-agent            | docker.io/cilium/cilium:v1.7.1 |
| DaemonSet | cilium-pre-flight-check | cilium-pre-flight-check | docker.io/cilium/cilium:v1.7.1 |
...
| Kind       | Name            | Container       | Image                            |
| ---------- | --------------- | --------------- | -------------------------------- |
| Deployment | cilium-operator | cilium-operator | docker.io/cilium/operator:v1.7.1 |
