...
| ---------- | ----------------------- | ----------------------- | ----------------------------- |
| DaemonSet  | cilium                  | cilium-agent            | quay.io/cilium/cilium:v1.7.14 |
| DaemonSet  | cilium-pre-flight-check | cilium-pre-flight-check | quay.io/cilium/cilium:v1.7.14 |
| Deployment | cilium-pre-flight-check | cnp-validator           | quay.io/cilium/cilium:v1.7.14 |
...
| Kind       | Name            | Container       | Image                           |
| ---------- | --------------- | --------------- | ------------------------------- |
| Deployment | cilium-operator | cilium-operator | quay.io/cilium/operator:v1.7.14 |
