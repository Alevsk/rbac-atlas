...
| -------------------------------------------------- | --------- | --------- | ------- | ----------- | --------- | ----------------------- |
| [`cilium`](#sa-cilium)                             | default   | ❌        | —       | 17          | 3         | {{< risk "Critical" >}} |
| [`cilium-etcd-sa`](#sa-cilium-etcd-sa)             | default   | ❌        | —       | 13          | 0         | {{< risk "Critical" >}} |
| [`cilium-operator`](#sa-cilium-operator)           | default   | ❌        | —       | 13          | 1         | {{< risk "High" >}}     |
...
| ---------- | ----------------------- | ----------------------- | ------------------------------- |
| DaemonSet  | cilium                  | cilium-agent            | docker.io/cilium/cilium:v1.6.12 |
| DaemonSet  | cilium-pre-flight-check | cilium-pre-flight-check | docker.io/cilium/cilium:v1.6.12 |
| Deployment | cilium-pre-flight-check | cnp-validator           | docker.io/cilium/cilium:v1.6.12 |
...
| Kind       | Name            | Container       | Image                             |
| ---------- | --------------- | --------------- | --------------------------------- |
| Deployment | cilium-operator | cilium-operator | docker.io/cilium/operator:v1.6.12 |
