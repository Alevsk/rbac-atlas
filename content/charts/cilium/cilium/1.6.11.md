...
| ---------- | ----------------------- | ----------------------- | ------------------------------- |
| DaemonSet  | cilium                  | cilium-agent            | docker.io/cilium/cilium:v1.6.11 |
| DaemonSet  | cilium-pre-flight-check | cilium-pre-flight-check | docker.io/cilium/cilium:v1.6.11 |
| Deployment | cilium-pre-flight-check | cnp-validator           | docker.io/cilium/cilium:v1.6.11 |
...
| Kind       | Name            | Container       | Image                             |
| ---------- | --------------- | --------------- | --------------------------------- |
| Deployment | cilium-operator | cilium-operator | docker.io/cilium/operator:v1.6.11 |
