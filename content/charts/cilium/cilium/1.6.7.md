...
| --------- | ----------------------- | ----------------------- | ------------------------------ |
| DaemonSet | cilium                  | cilium-agent            | docker.io/cilium/cilium:v1.6.7 |
| DaemonSet | cilium-pre-flight-check | cilium-pre-flight-check | docker.io/cilium/cilium:v1.6.7 |
...
| Kind       | Name            | Container       | Image                            |
| ---------- | --------------- | --------------- | -------------------------------- |
| Deployment | cilium-operator | cilium-operator | docker.io/cilium/operator:v1.6.7 |
