...
| ----------- | ------- | ------------- | --------------------------------------- |
| StatefulSet | jenkins | config-reload | docker.io/kiwigrid/k8s-sidecar:1.28.4   |
| StatefulSet | jenkins | jenkins       | docker.io/jenkins/jenkins:2.479.2-jdk17 |
