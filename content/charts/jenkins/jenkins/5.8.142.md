...
|---|---|---|---|
|StatefulSet|jenkins|config-reload|docker.io/kiwigrid/k8s-sidecar:2.5.0|
|StatefulSet|jenkins|jenkins|docker.io/jenkins/jenkins:2.541.2-jdk21|
