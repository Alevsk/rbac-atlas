...
|---|---|---|---|
|StatefulSet|jenkins|config-reload|docker.io/kiwigrid/k8s-sidecar:2.10.0|
|StatefulSet|jenkins|jenkins|docker.io/jenkins/jenkins:2.568.1-jdk21|
