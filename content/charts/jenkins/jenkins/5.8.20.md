...
| ----------- | ------- | ------------- | --------------------------------------- |
| StatefulSet | jenkins | config-reload | docker.io/kiwigrid/k8s-sidecar:1.30.2   |
| StatefulSet | jenkins | jenkins       | docker.io/jenkins/jenkins:2.492.2-jdk17 |
