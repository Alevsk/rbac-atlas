...
| ----------- | ------- | ------------- | --------------------------------------- |
| StatefulSet | jenkins | config-reload | docker.io/kiwigrid/k8s-sidecar:2.3.0    |
| StatefulSet | jenkins | jenkins       | docker.io/jenkins/jenkins:2.528.3-jdk21 |
