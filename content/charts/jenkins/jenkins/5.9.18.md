...
|---|---|---|---|
|StatefulSet|jenkins|config-reload|docker.io/kiwigrid/k8s-sidecar:2.6.0|
|StatefulSet|jenkins|jenkins|docker.io/jenkins/jenkins:2.555.1-jdk21|
