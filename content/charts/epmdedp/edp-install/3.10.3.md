...
| ---------- | ----------------- | ----------------- | -------------------------------- |
| Deployment | codebase-operator | codebase-operator | epamedp/codebase-operator:2.25.0 |
...
| Kind       | Name                 | Container            | Image                               |
| ---------- | -------------------- | -------------------- | ----------------------------------- |
| Deployment | cd-pipeline-operator | cd-pipeline-operator | epamedp/cd-pipeline-operator:2.22.0 |
...
| Kind       | Name               | Container                       | Image                     |
| ---------- | ------------------ | ------------------------------- | ------------------------- |
| Deployment | tekton-interceptor | tekton-triggers-edp-interceptor | epamedp/edp-tekton:0.14.0 |
...
| Kind       | Name   | Container | Image                       |
| ---------- | ------ | --------- | --------------------------- |
| Deployment | portal | portal    | epamedp/edp-headlamp:0.18.0 |
