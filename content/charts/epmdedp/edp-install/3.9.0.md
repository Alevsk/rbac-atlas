...
| Role `edp-codebase-operator`                | tekton.dev/pipelineruns                                      | create · list                                         | {{< risk Low >}}      |                                                                                                                                                                       |
...
| ---------- | ----------------- | ----------------- | -------------------------------- |
| Deployment | codebase-operator | codebase-operator | epamedp/codebase-operator:2.23.0 |
...
| Kind       | Name                 | Container            | Image                               |
| ---------- | -------------------- | -------------------- | ----------------------------------- |
| Deployment | cd-pipeline-operator | cd-pipeline-operator | epamedp/cd-pipeline-operator:2.20.0 |
...
| Kind       | Name            | Container       | Image                          |
| ---------- | --------------- | --------------- | ------------------------------ |
| Deployment | gerrit-operator | gerrit-operator | epamedp/gerrit-operator:2.21.0 |
...
| Kind       | Name             | Container        | Image                                                                      |
| ---------- | ---------------- | ---------------- | -------------------------------------------------------------------------- |
| Deployment | tekton-dashboard | tekton-dashboard | gcr.io/tekton-releases/github.com/tektoncd/dashboard/cmd/dashboard:v0.46.0 |
...
| Kind       | Name               | Container                       | Image                     |
| ---------- | ------------------ | ------------------------------- | ------------------------- |
| Deployment | tekton-interceptor | tekton-triggers-edp-interceptor | epamedp/edp-tekton:0.12.0 |
...
| Kind       | Name   | Container | Image                       |
| ---------- | ------ | --------- | --------------------------- |
| Deployment | portal | portal    | epamedp/edp-headlamp:0.15.0 |
