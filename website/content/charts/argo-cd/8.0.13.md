...
|---|---|---|---|
|ClusterRole `argo-cd-argocd-server`|*/*|delete · get · patch|Critical|
|ClusterRole `argo-cd-argocd-server`|core/events|create · list|Medium|
|ClusterRole `argo-cd-argocd-server`|core/pods|get|Medium|
|ClusterRole `argo-cd-argocd-server`|core/pods/log|get|Medium|
|ClusterRole `argo-cd-argocd-server`|argoproj.io/applications|get · list · update · watch|Medium|
|ClusterRole `argo-cd-argocd-server`|argoproj.io/applicationsets|get · list · update · watch|Medium|
|ClusterRole `argo-cd-argocd-server`|argoproj.io/workflows|create|Medium|
|ClusterRole `argo-cd-argocd-server`|batch/jobs|create|Medium|
|Role `argo-cd-argocd-server`|core/secrets|create · delete · get · list · patch · update · watch|Low|
|Role `argo-cd-argocd-server`|core/configmaps|create · delete · get · list · patch · update · watch|Low|
...
|Role `argo-cd-argocd-application-controller`|core/configmaps|get · list · watch|Low|
|Role `argo-cd-argocd-application-controller`|core/events|create · list|Low|
|Role `argo-cd-argocd-application-controller`|core/secrets|get · list · watch|Low|
...
|Role|Resource|Verbs|Risk|
|---|---|---|---|
|ClusterRole `argo-cd-argocd-notifications-controller`|argoproj.io/applications|get · list · patch · update · watch|Medium|
|ClusterRole `argo-cd-argocd-notifications-controller`|argoproj.io/appprojects|get · list · patch · update · watch|Medium|
|ClusterRole `argo-cd-argocd-notifications-controller`|core/configmaps|get · list · watch|Medium|
|ClusterRole `argo-cd-argocd-notifications-controller`|core/secrets|get · list · watch|Medium|
...
|Role `argo-cd-argocd-notifications-controller`|core/configmaps|get · list · watch|Low|
|Role `argo-cd-argocd-notifications-controller`|core/secrets|get · list · watch|Low|
...
|Role `argo-cd-argocd-applicationset-controller`|coordination.k8s.io/leases|create · delete · get · list · patch · update · watch|Low|
...
|Role `argo-cd-argocd-applicationset-controller`|core/configmaps|create · delete · get · list · patch · update · watch|Low|
|Role `argo-cd-argocd-applicationset-controller`|core/secrets|get · list · watch|Low|
...
|Role|Resource|Verbs|Risk|
|---|---|---|---|
|Role `argo-cd-argocd-dex-server`|core/configmaps|get · list · watch|Low|
|Role `argo-cd-argocd-dex-server`|core/secrets|get · list · watch|Low|
